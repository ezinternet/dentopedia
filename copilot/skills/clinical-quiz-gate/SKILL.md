...
description: After writing a wiki overview page, generate 3 clinical case
  questions and verify the synthesis is clinically sound before committing. Use
  for wiki/overviews/ pages only.
