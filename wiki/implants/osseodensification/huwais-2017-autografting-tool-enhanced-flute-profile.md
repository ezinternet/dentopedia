...
tags: [patent, osseodensification, densah, versah, huwais, negative-rake-angle, flute-profile, autografting, bidirectional-bur, pct-patent]
relations:
  - type: reinforces
...
- **Continuously negative rake angle flute** — the claimed improvement and the core of OD geometry.
- **Dual-face flute (cutting face + densifying face) with land working edge** — makes one bur bidirectional (cut vs condense).
- **Hydraulic autografting** — stopper-section piston effect + impeller-like negative rake build pressure that autografts a bone slurry into the osteotomy walls.
- **Conically tapered body with stopper section** (claim 9) enabling the depth-limited piston effect.
- Documents the design lineage of the entire Densah/Versah bur family.

## Methodology

PCT patent (WO 2017/124079 A1), published 2017-07-20; PCT/US2017/013697 filed 2017-01-11; priority US 62/278,579 (2016-01-14). IPC A61B 17/16 / A61C 8/00 / A61C 3/02. Independent claim 1 (rotary osteotome with the negative-rake improvement), dependent claims 2–10 (rake/heel-side angle variants, conically tapered body, working-edge widening), and method claim 11 (cutting-direction rotation >~200 RPM with irrigation → hydraulic autografting). No patients, bench tests, or quantitative outcomes in the patent — all effects are inventor assertions.

## Results

No clinical or bench measurements (patent document). Asserted design parameters/effects only: continuously negative rake angle; >~200 RPM cutting-direction rotation; copious irrigation; hydraulic autografting and densified-crust formation; conically tapered body with stopper. None quantified or independently validated here — see the companion bench paper for measured torque/BIC/BMD/temperature.
