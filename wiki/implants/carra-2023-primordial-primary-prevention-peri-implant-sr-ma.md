...
- **Primordial prevention**: controlling risk factors *before* implant placement in patients awaiting implants (e.g., smoking cessation, periodontal disease treatment, glycemic control).
- **Primary prevention**: maintaining healthy peri-implant tissues *after* placement (e.g., supportive peri-implant care, oral hygiene).

Both intervention layers reduce peri-implant mucositis and peri-implantitis incidence per pooled data of observational and interventional studies with ≥6 month follow-up.

## Key Contributions
- Anchors EFP S3 prevention recommendations.
- Articulates the primordial-vs-primary distinction (often blurred in practice).
- Quantifies the protective effect of modifiable risk factor control.
...
- Mostly observational; few RCTs of risk factor modification
- Follow-up generally shorter than peri-implantitis natural history
