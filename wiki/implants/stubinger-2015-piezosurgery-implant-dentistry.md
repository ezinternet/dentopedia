...
## Key Contributions
The reference clinical narrative for piezo in implant dentistry. Its claims of "avoidance of thermal damage" later become the empirical question that Aquilanti 2023 and Jain 2024 challenge.

## Methodology
- Narrative literature review.
- Coverage by indication: implant site prep, bone grafting, sinus elevation, ridge splitting, IAN lateralization.

## Indications Summarized
| Indication | Piezo claimed advantage |
|---|---|
| Implant site prep | Selective cutting, less mechanical stress |
| Bone grafting (block, particulate) | Precise harvesting |
| Sinus floor elevation | Schneiderian membrane preservation |
| Ridge splitting | Controlled split without flap retraction |
| IAN lateralization | Nerve preservation |
