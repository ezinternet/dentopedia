...
| 인자 | 내용 |
|---|---|
| 골의 기계적 특성 | 골질 type I-IV, 피질골 두께, 해면골 밀도 |
| 임플란트-골 접촉 강도 | 임플란트 직경·형태·표면처리, 수술 기법 |
| 유효 노출 길이(EL) | 임플란트 상단~변환기 길이; EL↑ → ISQ↓ |
...
|---|---|
| < 55-60 | 지연 부하 |
| 60-65 | 신중한 조기 부하 + 모니터링 |
| > 65-70 | 즉시/조기 부하 고려 가능 |

- 단일 측정보다 **경시적 추적(serial ISQ)** 이 더 유용
- ISQ 하락 추세 → 실패 조기 경보
