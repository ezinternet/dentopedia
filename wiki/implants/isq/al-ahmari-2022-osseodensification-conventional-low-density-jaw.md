---
title: "Osseo-densification versus conventional surgical technique in low density jaw bone: A split mouth in vivo study"
authors: Nasser M. Al Ahmari
year: 2022
date: 2022-01-01
...
## Key Contributions
Provides a human controlled counterpoint to the OD-favorable pooled literature: when stability is measured directly in a split-mouth design, OD's advantage largely fails to reach significance (only density). Important for bounding OD claims.

## Methodology
20 patients, 40 split-mouth implants (age 40–59). OD side: Densah kit; conventional side: standard burs. Outcomes: primary stability, plaque index, BOP, pocket depth, CBCT bone density, marginal bone loss.

## Results
- Bone density: significantly higher with OD immediately post-op.
- Primary/secondary stability, PI, BOP, PD, MBL: no significant difference.
- Note: the authors' conclusion ("better primary stability") reads more favorably than the null stability results — interpret with caution.
