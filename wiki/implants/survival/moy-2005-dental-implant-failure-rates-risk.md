---
title: "Dental Implant Failure Rates and Associated Risk Factors (Moy 2005)"
authors: Moy PK, Medina D, Shetty V, Aghaloo TL
year: 2005
doi: ""
date: 2005-01-01
...
|---|---|---|
| 당뇨 | **2.75** | 가장 강력한 위험인자 |
| 두경부 방사선 | **2.73** | 동등하게 위험 |
| PMHRT | **2.55** | 폐경 후 HRT 사용자 |
| 연령 60–79세 | **2.24** | 고령 |
| 상악 위치 | **1.79** | 하악 대비 |
| 흡연 | **1.56** | 중등도 위험 |
| 고혈압·심질환·스테로이드 | ~1.0 | **유의하지 않음** |
...
- **고혈압·심질환·스테로이드 복용** → 임플란트 금기 아님
- **당뇨 환자** → 혈당 조절 확인 후 시술; 장기 모니터링 필수
- **흡연 환자** → 금연 프로토콜 + 특히 초기 1년 집중 관리
- **두경부 방사선 병력** → 고압산소 치료(HBO) 사전 고려
- **상악 구치부** → 가장 실패율 높음 → 보강 식립, 연장 치유 고려
...
- [[implants/isq/di-stefano-2021-stability-dental-implants-cortical-bone]] — 피질골과 초기안정성
