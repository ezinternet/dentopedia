...
## Key Contributions
Rare in vivo (canine) validation of the irrigation + sharp-drill benefit, with histology rather than just temperature as endpoint. Provides a higher evidence-level anchor for what dental implant literature mostly shows in vitro.

## Methodology
- Anesthetized research dogs, bicortical drilling of each tibial diaphysis.
- 5 devices (drills, K-wires) × ± saline irrigation.
- Outcomes: temperature rise; acute histologic osteonecrosis.

## Results
| Variable | Effect on temperature | Effect on osteonecrosis |
|---|---|---|
| Saline irrigation | ↓ | ↓ |
| Sharp drill bits | ↓ | ↓ |
| Trocar-tip K-wire | ↑↑ (largest) | ↑↑ (most) |
| Dull drill bit | ↑ | ↑ |

## Clinical Implications
- **Saline irrigation은 비협상 standard** — 임플란트·정형외과 공통.
- **Sharp drill bit 유지** = drill 교체 주기 준수와 같은 결론 (sorgato 2025, bernabeu-mira 2020와 일치).
- 정형외과 K-wire 결과는 dental에선 직접 적용 안 됨 — 그러나 "blunt instrument는 발열·osteonecrosis 양면에서 손해"라는 원칙은 동일.
