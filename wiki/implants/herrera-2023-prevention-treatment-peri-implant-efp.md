...
- Structured care pathway covering pre-placement, post-loading, and disease treatment phases
- Identifies modifiable risk factors and provides actionable prevention recommendations
- Aligns with the EFP periodontitis guidelines (Sanz 2020, Herrera 2022)

## Treatment Framework
| Phase | Interventions |
|-------|--------------|
| Pre-placement | Treat periodontitis; smoking cessation; optimise glycaemia; augment keratinized mucosa if needed |
| Post-loading | Regular BOP/PD monitoring; SPIC programme; annual radiographs; tailored OHI |
| Mucositis | Professional + patient mechanical debridement; CHX adjunct short-term |
| Peri-implantitis (non-surgical) | Mechanical debridement ± antiseptics/antibiotics |
| Peri-implantitis (surgical) | Access surgery + implant surface decontamination; resective or regenerative approach |

## Risk Factors for Peri-Implant Diseases
- **Confirmed risk indicators**: history of periodontitis (strongest), poor plaque control, no SPIC
- **Probable risk indicators**: smoking, diabetes mellitus
