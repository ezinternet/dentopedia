---
title: "Thread Depth and Implant Shape on Stress Distribution in the Mandible: A Finite Element Analysis"
authors: "Hussein FA, Salloomi KN, Abdulrahman BY, Al-Zahawi AR, Sabri LA"
year: 2019
date: 2019-01-01
...
tags: [FEA, thread-depth, implant-shape, tapered, cylindrical, stress-distribution, mandible, crestal-bone]
relations:
  - type: reinforces
...
## Key Contributions
- Localizes peak stress to crestal cortical bone at the neck.
- Documents a tapered-body peak-stress penalty vs cylindrical.
- Frames macrogeometry as a stability-vs-stress trade-off.

## Methodology
3D FEA; mandible anterior + posterior; variables implant body shape (tapered vs cylinder) and thread depth; outcome stress distribution and maximum equivalent von Mises stress.

## Results
- Highest stress at crestal cortical bone around the neck (all models).
- Tapered > cylindrical in peak von Mises stress, all bone types.
- Thread depth modulates the pattern.
