...
## Methodology
SNU IRB-approved. Digital surgical guide. ISQ at placement, 4-6 wk, prosthetic phase. Volumetric analysis via STL overlay. PROMs (pain VAS, satisfaction).

## Results
(본문 부족 — abstract 기준: 두 군 모두 안정성 양호; HA 나노코팅이 ISQ 회복·early loading window·volumetric stability에서 우위 경향 보고.)
