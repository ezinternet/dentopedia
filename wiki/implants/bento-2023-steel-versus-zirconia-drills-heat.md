...
authors: Victor Augusto Alves Bento, Jessica Marcela de Luna Gomes, Cleber Davi Del Rei Daltro Rosa, João Pedro Justino de Oliveira Limirio, Daniela Micheline Dos Santos, Marcelo Coelho Goiato, Eduardo Piza Pellizzer
year: 2024
date: 2023-09-07
...
## Key Contributions
Quantitative pooled estimate for a specific drill-material question (Zr vs SS) — provides the meta-analytic anchor missing from the broader chakraborty SR.

## Methodology
- PRISMA-compliant SR + meta-analysis.
- PubMed/MEDLINE, Embase, Cochrane through January 2023.
- 10 in vitro studies included.
- JBI critical appraisal for quasi-experimental studies.
- Inverse-variance pooling of bone temperature variation.

## Results
- Pooled effect: Zr drill < SS drill bone ΔT, statistically significant.
- All evidence in vitro; clinical translation limited.

## Clinical Implications
- 동일 디자인·동일 marrow조건에서 재질만 비교했을 때 zirconia가 thermal 면에서 우수 가능성. 단, 임상 적용 시 zirconia drill의 fracture toughness, 비용, 마모 거동, 재사용성 별도 검토 필요.
- chakraborty-2024와 충돌이 아니라 — chakraborty는 일반 "material" 불가, 본 연구는 specific pair에서 유의. 두 결론 양립 가능.
