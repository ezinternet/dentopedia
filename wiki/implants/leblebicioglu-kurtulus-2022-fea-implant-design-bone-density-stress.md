---
title: "Finite Element Analysis of Stress Distribution for Different Implant Designs and Bone Densities"
authors: "Leblebicioğlu Kurtuluş I, Kilic K, Bal B, Kilavuz A"
year: 2022
date: 2022-05-23
...
tags: [FEA, stress-distribution, bone-density, cortical-thickness, thread-design, abutment-angulation, low-density-bone]
relations:
  - type: reinforces
    target: heimes-2023-macrogeometry-primary-stability-implants-narrative-review
  - type: reinforces
...
## Key Contributions
- Quantifies bone-density (D1–D4) and cortical-thickness effects on peri-implant stress.
- Isolates thread design and abutment angulation as stress modifiers.
- Connects bone-quality determinants of stability to loading-phase biomechanics.

## Methodology
3D finite element analysis; two implant designs (different threads, same length/brand); four bone types; two abutment angulations; 30° oblique 200 N load; outcomes max/min principal stress (bone) and Von Mises stress (implant).

## Results
- Stress concentrated coronally in bone and implant.
- D4 low-density bone: highest stress.
- Lower trabecular density + thinner cortex → higher stress.
