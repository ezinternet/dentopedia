...
## Evidence Summary
| Outcome | OD finding | Evidence quality |
|---------|-----------|-----------------|
| Primary stability (IT) | Consistently higher | Moderate |
| ISQ | Higher in some studies; inconsistent | Low–moderate |
| BIC (human) | Insufficient data | Very low |
| D3/D4 benefit | Most pronounced | Moderate |
| CSFE benefit | Consistent improvement | Moderate |
