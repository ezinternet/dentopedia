...
<svg viewBox="0 0 1200 300" xmlns="http://www.w3.org/2000/svg" role="img" style="width:100%; height:auto; display:block; max-width:1100px; margin:0 auto;">
  ...
  <text x="340" y="206" font-family="Georgia, 'Times New Roman', serif" font-size="34" fill="#AD2150" font-weight="700">Clinical Dentopedia:</text>
...
<iframe src="https://ezinternet.github.io/llm-wiki/interactives/overviews-map.html" title="Overviews 도메인 지도" loading="lazy" style="width:100%; height:640px; border:1px solid var(--lightgray); border-radius:12px; background:transparent;"></iframe>
