...
authors: "Vélez J, Peláez J, López-Suárez C, Agustín-Panadero R, Tobar C, Suárez MJ"
year: 2020
date: 2020-07-24
...
tags: [morse-taper, conical-connection, abutment-screw, tightening-torque, insertion-torque, implant-abutment-misfit, platform-switching]
relations:
  - type: reinforces
...
- Directly quantifies **insertion-torque magnitude (10/20/30 Ncm)** as a determinant of implant-abutment marginal misfit, holding the implant system constant.
- Shows the **internal Morse-taper (11°) connection fits tighter than external hexagon** (~0.6 vs higher µm) across abutments and torque levels.
- Demonstrates a **plateau**: misfit improves from 10→20 Ncm but not significantly from 20→30 Ncm — evidence against "torque higher for a better seal."
- For the Morse-taper joint, **abutment angulation (15°) did not significantly worsen fit** (it did for external hex).

## Methodology

In-vitro, n=120 implants (Mozo-Grau). Factors: connection (external hex EC vs internal 11° Morse-taper + double internal hex + platform-switch IC), abutment (straight SA vs 15° angulated AA, Ti-6Al-4V, 2 mm cuff), insertion torque (10/20/30 Ncm; n=10/cell, ≥7 needed for 80% power). Abutment screws tightened with a calibrated dynamometric wrench and retightened after 10 min. Implants seated at 35–45 Ncm. Aging: 1200 thermocycles (5–55 °C) + 250,000 mechanical cycles (200 N vertical, 2.5 mm vertical / 0.7 mm lateral, 2 Hz) in Fusayama-Meyer artificial saliva; 3 mm simulated resorption per ISO 14801:2007. Outcome: marginal misfit by SEM (1000×, sectioned, gold-coated), 60 measurements/specimen, two examiners. Stats: ANOVA, Tamhane T2, t-test, Kruskal-Wallis + Bonferroni (α=0.05).

## Results

- **Connection:** Morse-taper (IC) < external (EC), p=0.001, regardless of abutment/torque; IC-SA lowest; IC SA and AA ≈ 0.6 µm. All groups < 3 µm.
- **Abutment:** straight < angulated overall, 1.3 vs 2.1 µm (p=0.004); for IC, no SA-vs-AA difference (taper masks angulation effect).
- **Torque (pooled):** 30 Ncm best fit; significant 10 vs 20 (p=0.001) and 10 vs 30 (p=0.001); **20 vs 30 Ncm NOT significant (p=0.10)**.
- **Per group:** external-hex straight (ECSA) torque-insensitive; both Morse-taper groups (ICSA, ICAA) improved from 10→20 and 10→30 Ncm; lowest misfit at 30 Ncm (≈0 µm for Morse taper).
- **Trade-off (from discussion):** under-torque → screw loosening, fracture, microleakage; over-torque past yield → preload loss, screw fracture.
