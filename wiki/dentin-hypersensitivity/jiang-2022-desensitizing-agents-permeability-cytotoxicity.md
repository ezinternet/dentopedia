...
authors: "Jiang R, Xu Y, Wang F, Lin H"
year: 2022
date: 2022-09-01
...
tags: [dentin-hypersensitivity, gluma, glutaraldehyde, permeability, cytotoxicity, tubule-occlusion]
relations:
  - type: reinforces
...
## Key Contributions
- Integrates hydraulic permeability + transdentinal cytotoxicity in one model.
- Shows GLUMA tubule occlusion is dentinal-fluid (protein)-dependent.
- Decouples efficacy (both agents occlude) from safety (GLUMA cytotoxic, RD not).

## Methodology
Human dentin specimens, 3 groups (n=6): GLUMA (±2% BSA perfusate) and RD gel + 24 h artificial saliva. Permeability by hydraulic conductance at 20 cm H2O; SEM imaging; MTT cytotoxicity on 3D scaffolds under dentin discs (24 h).

## Results
GLUMA cut permeability/occluded tubules only with 2% BSA; RD gel occluded tubules but permeability rebounded after artificial saliva; GLUMA significantly decreased cell viability while RD was non-cytotoxic.

## Related Papers
- [[dentin-hypersensitivity/joshi-2013-novamin-gluma-dentinal-tubule-occlusion-sem]] — reinforces tubule-occlusion comparison (NovaMin vs Gluma).
- [[dentin-hypersensitivity/scheffel-2015-transdentinal-cytotoxicity-glutaraldehyde-odontoblast]] — reinforces glutaraldehyde pulpal cytotoxicity concern.
