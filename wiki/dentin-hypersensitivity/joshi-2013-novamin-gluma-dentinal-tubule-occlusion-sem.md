...
authors: "Joshi S, Gowda AS, Joshi C"
year: 2013
date: 2013-12-01
...
## Key Contributions
- SEM-based occlusion ratios (complete/partial/open) per agent.
- Side-by-side of bioactive-glass vs glutaraldehyde mechanisms.

## Methodology
Sound human premolar dentin discs, 6% citric acid etch (2 min), 3 groups (n=20: control, Gluma, NovaMin), longitudinal fractures for sub-surface view, SEM occlusion quantification, non-parametric statistics.

## Results
Both desensitizers increased tubule occlusion versus control; occlusion ratios computed per group, with distinct surface (NovaMin) vs intratubular (Gluma) deposition patterns.

## Related Papers
- [[dentin-hypersensitivity/jiang-2022-desensitizing-agents-permeability-cytotoxicity]] — extends to permeability + cytotoxicity.
- [[dentin-hypersensitivity/defreitas-2021-bioactive-toothpastes-dentin-hypersensitivity-sr]] — clinical evidence for bioactive-glass dentifrices.
