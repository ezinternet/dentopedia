---
title: "Proximal contact alterations between implant-supported restorations and adjacent teeth in the posterior region: A 3-month prospective study"
authors: "Mehanna S, Habre-Hallage P"
year: 2021
date: 2021-05-01
...
## Key Contributions
- Quantifies early (≤3-month) contact-tightness decline with a calibrated strip protocol.
- Isolates restoration type (notably free-end) and implant system as factors.
- Shows ICL is measurable short-term, supporting early surveillance.

## Methodology
Prospective study (April–September 2019). 43 patients (23 F, 20 M; 31–70 years), 43 posterior IFPs, 64 proximal contacts. PCT measured at T0 (insertion), T1 (1 month), T2 (3 months) by removal of a 0.05 mm metal strip plus floss assessment. Covariates: age, gender, smoking, implant system, contact position, jaw position, restoration type. Significance P≤0.05.

## Results
- Significant PCT decrease from T0 to T2.
- Restoration type → mesial loss in free-end restorations (P=0.008) and distal loss (P<0.001).
- Implant system → distal contacts only (P=0.002).

## Related Papers
- [[food-impaction/pang-2017-prevalence-proximal-contact-loss-prospective]] — reinforces (long-term prospective counterpart)
- [[food-impaction/liang-2020-prevalence-associated-factors-retrospective]] — reinforces (factor analysis incl. restoration/splinting)
- [[food-impaction/abduo-2022-proximal-contact-loss-qualitative-systematic]] — applies-to (short-term band <2y, 11–30%)
