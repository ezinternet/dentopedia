...
## Key Contributions
- Directly contrasts CGIC vs RMGIC biological response with a structured bias appraisal.
- Provides a cytotoxicity rationale favoring CGIC for pulp-adjacent (VPT) use.

## Methodology
SR (PROSPERO-registered). Databases: MEDLINE/PubMed, EBSCO, Cochrane CENTRAL, Google Scholar. 9 studies (from 552). Bias: MINORS, modified ARRIVE/CONSORT.

## Results
Conventional GIC < RMGIC in cytotoxicity (CGIC more biocompatible), especially in VPT contexts. Evidence base small; in-vivo/long-term confirmation required.

## Related Papers
- [[glass-ionomer/tuygunov-2024-modified-gic-calcium-phosphate-remineralization-sr]] — bioactivity counterpart
- [[glass-ionomer/ge-2024-gic-clinical-application-restorative-preventive]] — liner/base-use debate context
