...
authors: "Toby Andrew Mummery, Riddhi Popat"
year: 2022
date: 2022-01-01
...
## Key Contributions
- Real-world (pandemic-driven) service-evaluation data on GIC-FS retention in a hard-to-treat cohort.
- Reinforces GIC-FS as a moisture-tolerant, non-aerosol option for partially erupted molars.

## Methodology
Retrospective clinical review / case series (single NHS community dental service). Outcome: clinical retention at GA appointment and follow-up.

## Results
Average GIC-FS retention ~77%, consistent with literature. Main limitation: GIC-FS retention lower than resin-based sealants; small, single-service, non-comparative design.

## Related Papers
- [[glass-ionomer/ge-2024-gic-clinical-application-restorative-preventive]] — sealant indication is among GIC's supported uses
- [[glass-ionomer/krishnakumar-2024-hvgic-composite-primary-teeth-sr]] — paediatric GIC restorative context
