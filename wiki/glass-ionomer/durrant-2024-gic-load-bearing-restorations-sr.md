---
title: "Clinical Performance of Glass Ionomer Cement in Load-Bearing Restorations: A Systematic Review"
authors: "Laura Durrant, Mahdi Mutahar, Mohammed M. Al Moaleem, et al."
year: 2024
date: 2024-02-14
...
## Key Contributions
- RCT-only synthesis specifically scoped to load-bearing restorations (a long-standing concern for GIC).
- Concludes overall clinical performance comparable to traditional materials for the analyzed parameters.

## Methodology
PRISMA-style SR. Databases: EBSCO, PubMed, Embase, Cochrane. Inclusion: RCTs only. 12 RCTs reviewed. Outcomes: USPHS-type clinical parameters.

## Results
GIC comparable/suitable for surface margin, esthetic anatomical form, retention, fracture, marginal adaptation, occlusal contour, wear, approximal form. Reduced concern for postoperative sensitivity, recurrent caries, tooth integrity (no significant difference).

## Related Papers
- [[glass-ionomer/ge-2024-gic-clinical-application-restorative-preventive]] — reinforces restorative-use evidence
- [[glass-ionomer/krishnakumar-2024-hvgic-composite-primary-teeth-sr]] — complements with primary-teeth HVGIC vs CR
