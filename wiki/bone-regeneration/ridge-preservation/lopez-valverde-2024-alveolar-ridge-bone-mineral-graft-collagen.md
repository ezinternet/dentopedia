---
title: "Changes of the Alveolar Bone Ridge Using Bone Mineral Grafts and Collagen Membranes after Tooth Extraction: A Systematic Review and Meta-Analysis"
...
## Key Contributions
- PubMed, WoS, Embase, Cochrane; up to January 2024; 561 screened → 12 included
- Outcome: clinical and radiological alveolar bone crest dimensions
- Meta-analysis result: **trend for preservation but p>0.05** (not statistically significant)
- Heterogeneity: **I²>75%** across studies → random-effects model required
- Risk of bias: Cochrane RoB Tool; methodological quality: Joanna Briggs Institute (JBI)
- Collagen membrane advantages: biocompatible, low immunogenicity, resorbable (no 2nd surgery)

## Context vs Other SR+MAs
| Study | Year | n studies | Result |
|-------|------|-----------|--------|
| Avila-Ortiz | 2014 | RCTs only | +1.89mm width, +2.07mm height (significant) |
| López-Valverde | 2024 | 12 studies | Trend only; NS; high heterogeneity |

**Interpretation**: discrepancy likely due to broader inclusion criteria (not RCT-only), different material combinations, and higher heterogeneity in this 2024 review.

## Related Papers
- [[bone-regeneration/ridge-preservation/avila-ortiz-2014-alveolar-ridge-preservation-systematic-review]] — RCT-only SR+MA; significant ARP benefit; xenograft + membrane optimal
- [[bone-regeneration/ridge-preservation/lopez-pacheco-2021-socket-seal-surgery-esthetic-zone-sr]] — socket seal SSS techniques SR+MA
- [[bone-regeneration/ridge-preservation/tomlin-2014-ridge-preservation-implant-therapy-review]] — all techniques beat blood clot alone
