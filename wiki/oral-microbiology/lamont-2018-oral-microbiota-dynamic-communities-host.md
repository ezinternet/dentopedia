...
## Key Contributions
- First Nature Reviews-level integration of PSD (periodontitis) and ecological plaque hypothesis (caries) into a single framework.
- Establishes ~1,000 oral species / ~50 per site / ~200 per individual as ecological baseline.
- Documents C. albicans–S. mutans inter-kingdom EPS synergy causing severe caries in vivo.
- Identifies P. gingivalis PPAD as a putative rheumatoid arthritis trigger via host protein citrullination.
- Links oral microbiome to OSCC, coronary artery disease, and preterm/low-birthweight delivery.
- Proposes "specialist vs. generalist" microbiota as a unifying disease-vs-health marker.

## Methodology
- Narrative review; non-systematic. Scope covers both supragingival (caries) and subgingival (periodontitis) niches, mucosal epithelial communities, and systemic links.
- Oral ecology: ~1,000 species recognized; any site ~50 species; individual ~200 species; primary colonizers = facultative anaerobes (Streptococcus, Actinomyces); subgingival strict anaerobes increase with O2 reduction.
- Inter-individual variation in periodontitis microbiomes is large; functional gene sets better discriminators than species lists.

## Results
- Periodontitis: PSD feedforward loop — dysbiosis → inflammatory nutrients → more dysbiosis; keystone P. gingivalis, accessory S. gordonii, pathobionts (Filifactor alocis, Peptostreptococcus stomatis, etc.).
- Caries: sucrose → EPS (glucan/fructan) + lactic acid → aciduric selection → demineralization → feedforward.
- S. gordonii + P. gingivalis: more bone loss than P. gingivalis alone; S. cristatus negatively correlated with P. gingivalis in subgingival biofilms and reduces its pathogenicity in animals.
- C. albicans + S. mutans: inter-kingdom EPS synergy; elevated caries severity in vivo.
- P. gingivalis PPAD: citrullinates host proteins; may trigger RA autoantibodies.
- Oral microbiome–OSCC: alters inflammatory milieu, disrupts cell viability/proliferation/differentiation signaling.
- P. gingivalis Notch1 → PLA2-IIA → promotes dysbiosis.

## Related Papers
- [[oral-microbiology/hajishengallis-2012-psd-model-periodontal-disease]] — PSD model this review synthesizes (reinforces)
- [[oral-microbiology/lamont-2014-polymicrobial-synergy-dysbiosis-inflammatory]] — PSD molecular elaboration (reinforces)
- [[oral-microbiology/mcilvanna-2021-fusobacterium-nucleatum-oral-cancer]] — F. nucleatum role in OSCC, mechanistically linked to the oral–cancer axis described here (extends)
