...
## Key Contributions
- EPS matrix — not acid production alone — is the primary cariogenic virulence determinant.
- First 3D spatio-temporal EPS mapping in intact mixed-species oral biofilm using fluorescent probe.
- Compartmentalised pH 4.5–5.5 microenvironments resist >2 hours of neutral-buffer neutralisation.
- gtfB/gtfC deletion: eliminates acidic microenvironments and reduces in vivo caries virulence.
- gtfB/gtfC highly induced in mixed-species biofilm via autoinducer-mediated interspecies signalling.

## Methodology
Review with original experimental data. In vitro: mixed-species biofilm (S. mutans, S. oralis, A. naeslundii) on sHA, 1% sucrose, 43–115 hours. Techniques: confocal fluorescence EPS imaging, 3D rendering, fluorescent pH indicator mapping, two-photon excitation microscopy, MudPIT quantitative proteomics. In vivo: rodent caries model with gtfB/gtfC deletion mutants.

## Results
pH 4.5–5.5 at EPS-microcolony interior and microcolony/sHA interface; >2 h needed for neutral-buffer neutralisation. GtfB/GtfC proteins enriched at early biofilm phase (MudPIT). gtfB/gtfC expression: highly upregulated in mixed-species vs. monospecies biofilm. gtfB+gtfC deletion: abolishes EPS-microcolony complexes and acidic microenvironments; reduces virulence in rodent model. Glucanohydrolase treatment dismantles 3D matrix and eliminates pH gradients.

## Related Papers
- [[oral-microbiology/bowen-2011-streptococcus-mutans-glucosyltransferases]] — foundational Gtf review on which this mechanistic work directly builds (reinforces)
- [[oral-microbiology/karygianni-2020-biofilm-matrixome-extracellular-components]] — incorporates EPS-microcolony complex and assembly model into broader matrixome framework (extends)
- [[oral-microbiology/jakubovics-2021-dental-plaque-biofilm-matrix]] — broader matrix composition review contextualising this EPS virulence work (reinforces)
