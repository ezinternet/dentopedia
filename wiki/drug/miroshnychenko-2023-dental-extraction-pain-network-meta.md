...
authors: Miroshnychenko A, Ibrahim S, Azab M, et al.
year: 2023
date: 2023-04-01
...
## Key Contributions
- Most comprehensive NMA on dental extraction pain pharmacotherapy; directly informs ADA 2022 CPG
- Establishes ibuprofen+APAP as unambiguous first-line with moderate–high evidence
- Oxycodone 5mg, codeine, tramadol+APAP: no better than placebo — major finding supporting opioid de-escalation
- APAP 650mg+oxycodone 10mg (not 5mg) = only opioid regimen with meaningful effect
- GRADE applied; most interventions similar to placebo for adverse effects

## Methodology
Systematic review + frequentist NMA. Search: Medline, EMBASE, CENTRAL, US ClinicalTrials.gov (through Nov 21, 2020). 10 interventions, outcomes at 6h: PR (0–4 scale), TOTPAR6, SPID, global efficacy, rescue analgesia, AEs. RoB: modified Cochrane RoB 2.0. Certainty: GRADE. Analysis: RStudio v3.5.3.

## Results
| Intervention | MDp vs placebo | 95% CI | Certainty |
|---|---|---|---|
