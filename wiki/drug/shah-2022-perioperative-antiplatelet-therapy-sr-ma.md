...
authors: Shah S, Urtecho M, Firwana M, Nayfeh T, Hasan B, et al.
year: 2022
date: 2022-01-01
doi: ""
...
The key finding for clinicians: continuing aspirin perioperatively increases major bleeding by ~31% (RR 1.31, 95% CI 1.15-1.50, high COE) while reducing major thromboembolism by ~26% (RR 0.74). The trade-off is patient-specific and depends on which side of the balance dominates for the individual — secondary prevention indication, surgical bleeding risk, time since stent placement, etc.
...
- Pins down the aspirin continuation trade-off with high COE.
- Identifies the optimal-interruption-window question as still open (low COE).

## Methodology
SR+MA per ACCP guideline development protocol; databases MEDLINE/EMBASE/Scopus/Cochrane; data through July 16, 2020.
...
| Aspirin continued vs placebo | Major thromboembolism | RR 0.74 | high (favors continuation) |

## Limitations
- Heavily weighted to general surgery / non-cardiac surgery; dental extraction specifically not well represented
- DOAC interactions with APT not the focus
