...
## Key Contributions
- Most current SR on DM and dental implant outcomes
- Successor evidence to the 2022 Al-Ansari MA
- Multidisciplinary authorship (endodontics, periodontics, oral medicine)

## Methodology
- Systematic review (Tabriz University of Medical Sciences group)
- Article-in-press, unedited version — full methodology to be confirmed against final PDF

## Results
- Pooled estimates and outcome metrics: refer to the PDF directly
- BMC Oral Health Transparent Peer Review model — peer review reports will be published with the final article

## Limitations
- Unedited version: content, results, and conclusions may change before final publication
