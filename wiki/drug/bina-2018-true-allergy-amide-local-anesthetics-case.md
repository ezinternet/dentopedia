...
tags: [local-anesthesia, allergy, amide, diphenhydramine, lidocaine, metabisulfite, methylparaben, epinephrine, case-report]
relations:
  - type: refines
...
1. Frames most "LA allergy" as additive- or non-immune reactions, not true amide allergy.
2. Names the real allergen culprits: metabisulfite (all epi solutions) and methylparaben (now removed from single-use cartridges).
3. Provides a concrete diphenhydramine fallback protocol with dosing, complications, and volume limits for the amide-allergic, ester-untestable patient.
4. Reinforces that DPH is less effective than lidocaine for pulpal anesthesia — best for maxillary infiltration / soft-tissue, with intrapulpal top-up for endodontics.

## Methodology

- **Design**: single-patient case report + narrative literature review.
- **Patient**: 43F, allergist-documented lidocaine anaphylaxis; ester testing declined.
- **Anesthetic**: 1% DPH + 1:100,000 epinephrine, buccal-vestibule infiltration via 25-G needle on tuberculin/10-mL BD syringe.
- **13 visits** of comprehensive maxillary treatment; anesthesia judged by patient report (no EPT).
...
| Aspect | Finding |
|---|---|
| Maxillary infiltration efficacy | Adequate for extractions, composites, crown prep |
| Endodontic anesthesia | Required supplemental intrapulpal DPH (0.5–1.0 mL) |
| Duration | Short (literature: 15–75 min) |
| Postop swelling | Diffuse facial swelling after 8-mL visit; ER workup negative; resolved 24 h |
| Drowsiness | ~15 min post-injection, resolved by procedure end |
