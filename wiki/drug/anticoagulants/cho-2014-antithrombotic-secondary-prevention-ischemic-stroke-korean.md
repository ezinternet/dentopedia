...
- Clean separation of antiplatelet vs anticoagulant indications by stroke etiology.
- Cite-back resource when discussing dental procedure timing relative to recent stroke or TIA.

## Methodology
Narrative review of stroke secondary prevention RCT and guideline literature through 2014.

## Results
| Stroke etiology | First-line therapy |
|---|---|
| Non-cardioembolic (atherothrombotic, lacunar) | Antiplatelet: aspirin or clopidogrel or aspirin+dipyridamole |
| Cardioembolic (atrial fibrillation, valve) | Anticoagulant: warfarin or DOAC |

## Limitations
- 2014 — DOAC stroke literature has matured substantially since
