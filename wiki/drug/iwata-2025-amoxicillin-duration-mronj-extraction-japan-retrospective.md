...
authors: Iwata E, Ohori H, Susukida Y, et al.; Akashi M (senior)
year: 2025
date: 2025-07-02
...
The headline: **MRONJ development rates were equivalent between the two groups**. Combined with strict atraumatic surgical technique and regular follow-up, a single preoperative 500mg AMPC dose appears sufficient for low-dose BP patients undergoing extraction.

## Key Contributions
- First Japanese multi-center comparative evidence that AMPC duration can be shortened in low-dose BP patient extractions without raising MRONJ rate.
- Supports the global AMR stewardship push specifically in the MRONJ prevention context.
- Anchors a defensible single-dose protocol vs prior 3-7 day default.
...
| 2022-2024 (n=80) | 500mg pre only | equivalent |

## Limitations
- Retrospective, not randomized
- Low-dose oral BP only — does **NOT** extrapolate to high-dose IV antiresorptives (zoledronic acid IV oncology dose) or denosumab
- 4 Japanese centers; Korean practice should consider tailoring before adopting wholesale
- Surgical technique (tension-free closure) is a confounding co-intervention — the result is for the bundled package, not amoxicillin alone
