...
## Key Contributions
- Quantifies overprescription specifically in the endodontic AP indication.
- Confirms the gap between ESE/AAE guidelines and field practice.
- Directly relevant to Korean dental practice — same pattern observed in private clinic prescribing.
...
- Self-report bias in prescribing data
- "Appropriate" indication varies slightly across guidelines
