---
title: "A 5-year retrospective cohort study of denosumab induced MRONJ in osteoporosis patients"
...
## Key Contributions
- MRONJ incidence with osteoporosis-dose denosumab (Prolia®): 4.1% in extraction patients
- No significant difference between denosumab-only and BP-then-denosumab groups
- Rheumatoid arthritis: only significant systemic risk factor (OR 35.4) — likely M1 macrophage shift hypothesis
- MRONJ can develop from chronic periodontal/periapical inflammation without invasive dental treatment
- Supports mandatory pre-denosumab dental screening and periodontal treatment

## Methodology
- **n**: 98 patients (189 teeth); originally screened 159
- **Drug**: Prolia® 60 mg SC q6mo exclusively (Xgeva® patients excluded)
- **Mean Dmab doses before extraction**: 2.45±1.63
- **Mean drug holiday before extraction**: 6.26±4.22 months
- **Groups**: Dmab-only (n=52) vs BP+Dmab (n=46)

## Results

### Case Summary (4 MRONJ cases)
| Case | Age | Prior BP | Doses | Local trigger | Location | Stage | Treatment |
|---|---|---|---|---|---|---|---|
| 1 | 74F | Zoledronate 1y | 3 | Periodontitis | Mn Rt | 2 | Surgical |
| 2 | 76F | 3 BPs 7mo | 1 | Periodontitis | Mx Lt | 1 | Surgical |
| 3 | 54F | None | 1 | Extraction 1mo post-Dmab | Mn Rt | 2 | Conservative |
| 4 | 79F | None | 2 | Extraction 1y BEFORE Dmab | Mn Ant | 2 | Conservative |

### Statistical Analysis
- RA: OR 35.4, 95% CI 1.34–932.5, p=0.033 (significant)
- HTN: OR 0.33, p=0.334 (NS)
- DM: OR 6.16, p=0.174 (NS)
- Cancer: OR 0, p=0.999 (NS; no cancer patients developed MRONJ)
