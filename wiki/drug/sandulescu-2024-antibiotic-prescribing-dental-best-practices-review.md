...
## Key Contributions
- Implementation-focused (not yet another literature recap).
- ID-dentistry collaboration model.
- Practical guardrails: indication-required prescribing, single-dose default where appropriate, durations strictly limited.
