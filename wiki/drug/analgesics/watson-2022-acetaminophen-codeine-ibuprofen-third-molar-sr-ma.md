---
title: "Pain Relief with Combination Acetaminophen/Codeine or Ibuprofen following Third-Molar Extraction: A Systematic Review and Meta-Analysis"
...
This evidence directly contradicts the long-standing US prescribing pattern of opioid combination products for routine third molar pain and supports the modern opioid-sparing dental prescribing position (ADA 2022 acute dental pain guidelines).

## Key Contributions
- Direct head-to-head ibuprofen vs opioid combination for the highest-volume dental pain indication.
- Demonstrates that opioid combination offers no incremental benefit for this indication.
- Provides justification to remove codeine combinations from routine post-third-molar prescriptions.
...
- Subgroup analyses (impaction class, age) limited
