...
## Key Contributions
- Decade-scale national data (rare granularity for dentistry).
- Trend lines for total prescription volume and broad-spectrum share.
- Provides Korean dental practice with EU comparison context.
...
- No linked resistance/outcome data
