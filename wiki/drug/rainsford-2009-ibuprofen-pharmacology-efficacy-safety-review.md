...
The drug's anti-inflammatory + analgesic + antipyretic effects are linked to dose-dependent inhibition of COX-1- and COX-2-derived prostanoid production in blood.

## Key Contributions
- Single most-comprehensive ibuprofen reference (cited >570 times).
- Establishes the OTC vs prescription dose-safety dichotomy.
- Foundational mechanism (COX-1/COX-2 → prostanoids) clearly articulated.
...
| 1,800-2,400mg/day (Rx) | Chronic rheumatic disease | Higher GI/CV monitoring needed |

Mechanism: COX-1 + COX-2 inhibition → ↓ prostanoid → anti-inflammatory + analgesic + antipyretic.

## Limitations
- 2009 review; post-2009 CV/renal safety updates not included (refer to Gomes 2025 for current renal toxicity data, modern cardiovascular safety analyses for CV)
