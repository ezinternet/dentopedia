...
tags: [local-anesthesia, needle-free, mucoadhesive-patch, lidocaine, prilocaine, needle-phobia, atraumatic, transbuccal, prospective, brazil]
relations:
  - type: extends
...
1. Clinical evidence a needle-free patch can serve as **primary** anesthesia (not just pre-injection topical) in medium-complexity procedures — 90% injection-free.
2. Tri-layer design solves the prior monolayer's problems (salivary washout, throat-isthmus numbness) via unidirectional release and a defined adhesive footprint.
3. Demonstrates value specifically for the needle-phobic population.
4. Confirms lidocaine + prilocaine synergy (lidocaine → fast onset; prilocaine → peak and longer duration).

## Methodology

- **Design**: prospective one-arm open clinical cohort (ReBEC RBR-2jnmv8), n=58 healthy adults, pulp-vital teeth, medium-complexity procedures.
- **Patch**: drug-release (9 mm Ø) + mucoadhesive (12 mm Ø) + backing (12 mm Ø); ~42.5 mg, ~510 µm; PCl+LCl 1:1, 30 mg/patch.
- **Application**: 2 patches (vestibular + palatal/lingual), 86% maxillary / 14% mandibular sites.
- **Supplementation**: 2% mepivacaine + norepinephrine 1:100,000 if pain.
- **Outcomes**: onset (patient-reported, palpation-confirmed), need for supplementation, supplemental volume, 2-h and 6-month safety.
- **Stats**: descriptive frequencies + Mann-Whitney U (gender), SPSS v20.
...
|---|---|
| n | 58 (65% women) |
| Mean age | 50.7 ± 14.4 y (18–78) |
| Needle-phobic/anxious | 59% (82% of them women) |
| Mean onset | 13.2 ± 6.3 min (5–40; gender NS, p=0.615) |
| Completed with patch alone | 90% |
| Needed supplemental injection | 10% (6 cases, all maxillary, all anxious) |
| Mean supplemental volume | 0.63 ± 0.23 mL (~12 mg) |
| Useful duration | 50–90 min |
