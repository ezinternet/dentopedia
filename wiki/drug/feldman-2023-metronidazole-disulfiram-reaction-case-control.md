...
tags: [metronidazole, disulfiram-reaction, alcohol, ethanol, antibiotic, drug-interaction, case-control, emergency-department]
relations:
  - type: reinforces
...
1. Controlled clinical evidence in the acute-care setting, matching on ethanol concentration to isolate metronidazole's contribution.
2. Demonstrates zero documented reactions in confirmed ethanol + metronidazole exposure.
3. Reframes nonspecific "disulfiram-like" symptoms as likely ethanol/illness baseline rather than a drug interaction.

## Methodology

- Single academic ED (~72,000 visits/yr), Dec 1, 2010 – Dec 31, 2020; IRB-approved, consent waived.
- Included ≥18 y with detectable ethanol who received metronidazole while ethanol predicted still present; matched comparator without metronidazole.
- Outcome: documented disulfiram-like effects + records searched for "disulfiram"; admission, continued-antibiotic, and mortality data also collected.

## Results

| Variable | Metronidazole (n=18) | Ethanol-matched control (n=18) | P |
|---|---|---|---|
| Mean age | 46 y | 46 y | — |
| Male | 50% | 44.4% | — |
| Mean ethanol | 0.21 g/dL | (matched) | — |
| Hypertension | 16.7% | 61.1% | <0.0001 |
| Documented disulfiram-like reaction | 0 | — | — |

**Bottom line**: no signal of an alcohol–metronidazole disulfiram-like reaction; metronidazole use should not be avoided over this concern when it is the preferred agent.
