...
## Key Contributions
- Independent replication of PDRN sinus benefit in a different species (rabbit) and approach (endosinus) than the prior lateral/beagle study.
- Localizes the effect to a 4-week time window; not yet significant at 2 weeks, gap narrows by 8 weeks.
- Uses the same 2.0 mg/mL concentration as the soft-tissue line of work — dose consistency across indications.

## Methodology
- 18 rabbits, bilateral SFE, split-sinus randomization.
- Test: collagenated bone substitute + PDRN 2.0 mg/mL, 0.5 mL; Control: graft only.
- Sacrifice 2/4/8 wk (n=6 each); micro-CT + histomorphometry.

## Results
- micro-CT mineralized tissue volume significant increase between 4–8 wk (p<0.05).
- New bone area (median): 2w 1.4 vs 1.2 mm; 4w 3.4 vs 1.9 mm (significant); 8w 5.7 vs 4.5 mm.
- No intergroup difference in histologic bone-formation pattern.

## Related Papers
- [[pdrn/lee-2023-impact-polydeoxyribonucleotide-lateral-sinus-elevation]] — lateral approach, beagle, apical-zone-limited effect
- [[pdrn/lee-2023-effect-polydeoxyribonucleotide-early-bone-formation]] — same early-acceleration pattern at immediate implant
