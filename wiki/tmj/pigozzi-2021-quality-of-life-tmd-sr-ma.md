...
## Key Contributions
- Quantifies QoL deficit by TMD subgroup for the first time (MA level)
- Muscle disorders and arthralgia/arthrosis: larger QoL burden than disc displacement
- Large effect sizes across all groups (SMD 0.59–1.06) — clinically significant
- Validates DC/TMD Axis II (psychosocial) assessment as essential in TMD management
- Informs treatment prioritization: more aggressive QoL-targeted care for Group I and III

## Results Table

| Group | N | SMD (95% CI) | Effect Size |
|---|---|---|---|
| Global TMD (all) | 3,829 | 1.06 (0.65–1.51) | Large |
| Group I: muscle disorders | 3,056 | 0.82 (0.45–1.18) | Large |
| Group II: disc displacements | 3,184 | 0.59 (0.26–0.91) | Medium-large |
| Group III: arthralgia/arthritis/arthrosis | 2,781 | 0.98 (0.59–1.36) | Large |
...
- 근육형(Group I)·관절통형(Group III): QoL 저하 심각 → 조기 다학제 개입 우선
- 디스크변위(Group II): 상대적으로 QoL 영향 적음 → 보존적 모니터링 가능
- TMD 치료 성공 지표: 통증(VAS) + QoL 도구(OHIP, SF-36) 병행 평가 권장
- DC/TMD Axis II (심리사회) 평가 → 우울·불안·기능 장애 선별 필수

## Related Papers
- [[tmj/kapos-2020-temporomandibular-disorders-aetiology-diagnosis-review]] — 역학·생물심리사회 모델
- [[tmj/yao-2023-chronic-tmd-pain-sr-nma-bmj]] — 만성 통증 치료 NMA (233 RCT)
- [[tmj/haggman-henrikson-2017-pharmacological-orofacial-pain-sr-ma]] — 약물치료 NMA
- [[tmj/bmj-2023-tmd-chronic-pain-management-guideline]] — 임상 가이드라인
