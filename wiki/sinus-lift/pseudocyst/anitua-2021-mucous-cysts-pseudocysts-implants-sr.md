...
authors: Eduardo Anitua, Mohammad Hamdan Alkhraisat, Aintzane Torre, Asier Eguia
year: 2021
date: 2021-05-01
...
## Methodology
- PubMed·Embase 등 검색
- 포함: max sinus 내 MRC/pseudocyst 환자에서 implant/sinus lift outcome 보고 연구
- Study type: cohort·case series·case report (RCT 부족)
- Outcome: implant survival, sinusitis, membrane perforation, MBL 등

## Key Findings
- Implant survival rate는 일반적으로 높게 유지
- Cyst 존재 자체가 strong risk signal 만들지 못함
- Membrane perforation·sinusitis는 case-specific 차이
- 결정 트리: 절대 금기 아님 → 처치 방법 선택 단계로 진입

## Decision Tree Position

이 SR은 결정 트리의 **1단계 (위험 자체가 큰가?)**에 답함:

```
1) 위험 자체 큰가? → 본 SR: NO (절대 금기 아님)
   ↓
2) 처치 옵션 선택 → Yu 2023 (timing), Fu 2025 (3-arm), Testori 2024 (aspiration)
   ↓
3) 결과 추적 → Grün 2023 (15yr case), Silva 2025 (6yr case)
```
...
## Related Papers
- [[sinus-lift/pseudocyst/yu-2023-immediate-delayed-sinus-pseudocyst-rct]] — RCT timing
- [[sinus-lift/pseudocyst/fu-2025-antral-pseudocyst-management-lsfe]] — 3-arm 후속
- [[sinus-lift/pseudocyst/fu-2022-pseudocyst-removal-retainment-msfa-cohort]] — 2-arm precursor
- [[sinus-lift/pseudocyst/testori-2024-mucosal-cyst-aspiration-sinus-cohort]] — aspiration cohort
- [[sinus-lift/pseudocyst/jkaoms-48-2-101]] — Korean case series (3 subtype)
- [[sinus-lift/pseudocyst/yeung-2022-cbct-maxillary-sinus-pathology-review]] — diagnostic CBCT review
