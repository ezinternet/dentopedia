---
title: "Anatomical considerations for implant placements in first maxillary molar extracted sites in East Asian patients"
authors: G. K. Ananda, P. Nambiar, S. Mutalik, P. Shanmuhasuntharam
year: 2015
date: 2015-04-08
...
## Key Contributions
- 동아시아인 표본에서 **상악 제1대구치 발치와 치수** (폭 11.4 mm, 길이 7.7 mm, 높이 ~7 mm)를 정량화.
- 상악동 함기화 (Pneumatization) 패턴 3가지 (전방 확장, 치근 사이 함몰, 치근첨 돌출) 의 유병률 제시.
- **즉시 식립 (Immediate Implant, II)** 또는 단기 지연 식립 시 7 mm 이상의 임플란트는 상악동 천공 가능성이 높음을 수치로 입증.
- 발치 자체에서도 50%에서 상악동저로 치근첨이 노출 — 발치 시 oroantral communication (OAC) 위험.

## Methodology
- 60 CBCT 스캔 (30 말레이 + 30 중국계), >300 아카이브에서 무작위 선정.
- 측정 항목: 발치와 폭 (mesiodistal), 길이 (buccolingual), 높이 (coronal/sagittal), 치근간 골 (Inter-radicular bone) 유무, 상악동저-치근 관계.
- 2명의 검사자, 검사자 간 일치도 평가.
- 기술 통계 + 인종 그룹 간 비교.

## Results
| 지표 | 값 |
|---|---|
| 발치와 폭 (mean ± SD) | 11.42 ± 0.86 mm |
| 발치와 길이 | 7.70 ± 0.56 mm |
| 발치와 높이 (coronal) | 6.48 ± 3.77 mm |
| 발치와 높이 (sagittal) | 6.85 ± 3.67 mm |
| 상악동저 anterior 확장 | 95% |
| 치근 사이 함몰 (dipping) | 72% |
| 치근첨이 상악동 내 돌출 | ~50% |
| 치근간 골 존재 | 75% |
