...
| 전신 상태 | 위험 | 대응 |
|---|---|---|
| 흡연 (heavy) | 합병증↑, MBL↑ | 주의, 환자 고지 |
| 당뇨 | 감염·골대사 이상 | 혈당 조절 후 시행 |
| 항흡수제 | MRONJ 위험 | 전문의 협진 |
| 방사선 병력 | 골괴사 | HBO 고려 |
| 만성 상악동염 | **금기** | 이비인후과 선처치 |

## DSP 프로토콜
CBCT → 구강 스캔 → 가상 왁스업 → 가이드 임플란트 식립

## Clinical Relevance
- Piezo: 연조직 손상↓, 천공 위험↓ → 선호 기구
- 더 작은 창 트렌드 → 이환율↓, 골재생 공간 확보
- 술후: 항생제 + 스테로이드 + 비충혈제거제 표준

## Related Papers
- [[sinus-lift/transcrestal/sirinirund-2025-minimally-invasive-sinus-augmentation-review]] — 최소 침습 기법 분류
- [[sinus-lift/lateral/diaz-olivares-2021-schneiderian-membrane-perforation-sinus-lift]] — 천공 합병증 수복
- [[sinus-lift/lateral/del-fabbro-2025-sinus-augmentation-materials-lateral-approach]] — 이식재 선택 근거
