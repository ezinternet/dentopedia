---
title: "Maxillary Sinus Floor Augmentation With or Without Barrier Membrane Coverage of the Lateral Window"
...
→ 차폐막은 **선택사항** — routine 피개 불필요

## Clinical Relevance
- 막 천공 발생 시: 차폐막 추가 피개 권장 (이식재 안정화)
- 일반 증례: 이식재 선택이 차폐막 유무보다 더 중요
- 근거 한계: 6개 RCT, 이질성 높음 → 추가 연구 필요
