...
## Key Contributions
- Reframes the statistical-vs-clinical-significance distinction for clinicians appraising dental literature.
- Provides concrete restorative/endodontic examples of clinically useful but statistically non-significant effects.
- Offers a six-point interpretive checklist beyond the p-value.

## Methodology
Editorial/commentary; no original data or systematic synthesis.

## Results
Statistical significance ≠ clinical significance (both directions). Small n, low power, and variability mask real effects. Read results with effect size and confidence intervals, anchored to clinical relevance. Statistics complements clinical expertise.

## Clinical Application
- When appraising a paper, do not stop at "significant/not significant" — ask the magnitude (effect size), the precision (CI), and whether it changes a patient decision.
