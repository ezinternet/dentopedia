...
authors: Farzad Aghdashi, Nasrin Roohandeh, Majid Nemati, Reza Tabrizi
year: 2020
date: 2020-08-25
doi: not reported
...
## Key Contributions
- First head-to-head comparison of sling vs single interrupted suturing in impacted third molar surgery with periodontal endpoints.
- Shifts the wound-closure debate from "suture vs no suture" to "which suture geometry," showing knot position relative to the second molar's distal surface matters for periodontal healing.

## Methodology
- Split-mouth RCT, n=25, same surgeon, full-thickness triangular flap + osteotomy under IANB.
- Population: 18–25 y, non-smokers, systemically healthy, good oral hygiene (OHI-S 0–1.2), plaque index 0–1.
- Outcomes: dehiscence at days 7 and 14 (Michigan O probe, Williams markings); PPD and CAL at the distobuccal point of the adjacent second molar at baseline and median 17 weeks (mean ~22 weeks). Blinded assessor.
- Analysis: Wilcoxon signed-rank test and GEE regression. Sample size 18–20 (from Cetinkaya et al).

## Results
- PPD: sling significantly better (P=0.041).
- CAL: sling significantly better (P=0.016).
- Dehiscence day 7: smaller in single interrupted group (P=0.059, borderline).
- Dehiscence day 14: no significant difference (P=0.852).
- Conclusion: sling suture superior for periodontal parameters; suture technique has no significant long-term effect on dehiscence.

## Related Papers
- [[suture-wound-closure/kumar-2022-suture-versus-sutureless-third-molar-impactions]] — complements: Kumar reports no periodontal/alveolar-osteitis difference by suture vs sutureless; this paper finds the periodontal difference emerges between two *suture geometries* rather than between suture/no-suture.
- [[suture-wound-closure/pachipulusu-2018-primary-secondary-closure-third-molar]] — reinforces the recurring finding that periodontal healing of the adjacent second molar does not differ by closure approach, while isolating suture geometry as a separate lever.
