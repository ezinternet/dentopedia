...
## Key Contributions
- Clean primary-vs-secondary closure RCT with paired inflammatory and periodontal endpoints.
- Adds 6-month periodontal data showing closure type does not affect healing of the adjacent second molar.

## Methodology
- RCT, n=60 (30 primary / 30 secondary closure).
- Outcomes: pain (VAS), swelling, trismus at days 1, 3, 7; periodontal healing near adjacent second molar at 6 months.
- Between-group comparison, p<0.05.
- (Springer article-view PDF; full numeric tables paywalled.)

## Results
- Pain and swelling: greater in primary-closure group (p<0.05).
- Mouth opening: greater in secondary-closure group (less trismus).
- Periodontal healing: no significant difference at 6 months.
- Alveolar osteitis: 1 patient (3.3%) in the secondary-closure group.
- Conclusion: secondary closure is better for postoperative pain, swelling, and trismus; periodontal healing is unaffected by closure technique.

## Related Papers
- [[suture-wound-closure/kumar-2022-suture-versus-sutureless-third-molar-impactions]] — reinforces: both find that leaving the socket open (secondary/sutureless) reduces early morbidity without harming periodontal outcomes.
- [[suture-wound-closure/takadoum-2022-sutureless-socket-technique-third-molars]] — contrasts: Takadoum's larger multicentric RCT found no pain/swelling difference, whereas this trial does favor the open (secondary) approach.
- [[suture-wound-closure/aghdashi-2020-sling-single-interrupted-sutures-third-molar]] — reinforces the recurring null result on periodontal healing of the adjacent second molar by closure approach.
