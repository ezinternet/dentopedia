...
| `implants/survival` | 임플란트·생존율 | Implant survival/success rate framed by **patient/host condition** — long-term general cohorts, SR/MA of cumulative survival, habit- or disease-specific survival (smoker, irradiated, medically compromised). (survival framed by implant **dimension** — short/narrow — → `implants/short-narrow`) |
