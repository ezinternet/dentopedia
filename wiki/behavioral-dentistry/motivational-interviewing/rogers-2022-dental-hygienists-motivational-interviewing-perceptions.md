...
## Key Contributions
- Shifts MI evidence from efficacy to **uptake/implementation** among hygienists.
- Demonstrates TPB constructs as predictors of real-world MI use → levers for curriculum and workplace design.
- Names the clinician-skepticism barrier despite strong self-rated competence.

## Methodology
- Electronic Qualtrics survey; instrument mapped to TPB (attitudes, subjective norms, perceived behavioral control) + demographics + current MI use.
- Invited n=208; 73 responses (35%); 58 analyzed (28%). Descriptive stats, cross-tabulations, one-way ANOVA.

## Results
- 95% use MI; 98% perceive MI effective; respondents confident and feeling supported.
- All three TPB constructs predicted MI use; age associated with perceived behavioral control (p=0.02).
- Persistent concern about patients' ability to change behaviors.

## Related Papers
- [[behavioral-dentistry/motivational-interviewing/kay-2016-motivational-interviewing-general-dental-practice]] — efficacy SR cited as rationale.
- [[behavioral-dentistry/motivational-interviewing/anderson-2025-motivational-interviewing-nutritional-counseling-dentistry]] — same group (Arnett); MI for nutrition.
- [[behavioral-dentistry/communication-relationship/khalifah-2019-teaching-assessment-dentist-patient-communication]] — communication-skills teaching/assessment.
