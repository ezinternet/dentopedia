---
title: "Prevalence of and Factors Associated with Unmet Dental Need Among the US Adult Population in 2016"
authors: "Taylor H, Holmes AM, Blackburn J"
year: 2022
date: 2022-01-01
doi: "10.1111/cdoe.12607"
source: taylor-2022-unmet-dental-need-prevalence-us-adults.md
...
relations:
  - type: reinforces
    target: okyere-boadu-2025-patient-challenges-dental-care-ghana
  - type: extends
...
## Key Contributions
- National benchmark: 6.0% unmet dental need among US adults in 2016 (higher than unmet medical, pharmacy, or mental health)
- Quantifies insurance effect: 1.7 pp protective (modest, indicating cost barriers persist even for the insured)
- Full income gradient: poor/near-poor +4.2 pp vs high-income (dose-response confirms cost as primary driver)
- Racial paradox documented and critically discussed: lower reported need in Hispanic/Black adults likely reflects differential perception threshold, not better access
- Andersen Model application to dental care provides replicable framework for future studies

## Methodology
Cross-sectional. Data: MEPS 2016 Household Component (nationally representative US survey). n=25,444 adults ≥18 years; excluded under-18 (n=9,211 excluded). Primary outcome: binary self-report ("unable to get" or "delayed in getting" dental care believed necessary in prior 12 months). Independent variables per Andersen's Behavioral Model: predisposing (sex, age, race/ethnicity, marital status, smoking, education), enabling (income as % FPL, private dental insurance), need (chronic conditions, self-rated health). Analysis: chi-square + multivariate logit regression with marginal effects (absolute risk differences). MEPS sampling weights applied for national representativeness.

## Results
- Overall unmet dental need: **6.0%** (95% CI 5.5–6.5)
- Dental insurance: **−1.7 pp** (95% CI −2.8 to −0.6) vs no insurance
- Income gradient vs high income (≥400% FPL):
  - Middle income (200–400%): +2.3 pp (CI 1.2–3.4)
  - Low income (125–200%): +3.3 pp (CI 1.7–5.0)
  - Poor/near-poor (<125%): +4.2 pp (CI 2.7–5.7)
- Racial/ethnic: Hispanic −1.7 pp (CI −2.8 to −0.6); Non-Hispanic Black −1.1 pp (CI −2.1 to −0.1) vs White
- Other significant predictors: current smoker, lower education, fair/poor health, chronic conditions, unmarried

## Related Papers
- [[behavioral-dentistry/communication-relationship/okyere-boadu-2025-patient-challenges-dental-care-ghana]] — reinforces: Ghana cross-sectional confirms cost as universal top barrier; this paper provides US national scale
- [[behavioral-dentistry/communication-relationship/currie-2021-promoting-regular-dental-attendance-problem]] — extends: Currie names cost as a future research axis; this paper quantifies the magnitude at national level
