...
tags: [zirconia-implant, PROM, patient-satisfaction, OHRQoL]
relations:
  - type: reinforces
...
## Key Contributions
- First SR dedicated to PROs in zirconia implant therapy.
- Consistent PRO improvement at prosthetic delivery.
- Identifies PROM heterogeneity as the key evidence weakness.

## Methodology
PRISMA SR, 6 databases; 596 → 189 screened → 12 controlled trials. PROMs, survival, follow-up, evidence level, and MINORS bias extracted. No meta-analysis (heterogeneity).

## Results
- Significant improvement in aesthetics, speaking, comfort, chewing, satisfaction at delivery vs baseline.
