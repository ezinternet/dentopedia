...
tags: [local-anesthesia, pharmacology, lidocaine, articaine, mepivacaine, prilocaine, bupivacaine, maximum-dose, toxicity, pKa, methemoglobinemia, paresthesia]
relations:
  - type: reinforces
...
1. The **maximum-dose table** (mg/kg + absolute mg) — the single most clinically reused content (reproduced below).
2. pKa→onset, protein-binding→duration, lipid-solubility→potency mechanistic chain.
3. Articaine clearance/paresthesia profile (4% concentration neurotoxicity).
4. Toxicity map: CNS seizure thresholds, bupivacaine cardiotoxicity, prilocaine methemoglobinemia.
5. Allergy demystification (most "allergy" = syncope/epinephrine; true culprits usually preservatives — methylparaben, sulfites).

## Methodology

Narrative (non-systematic) CE review synthesizing landmark pharmacokinetic studies (Scott et al. 1972; Hersh et al.) and paresthesia epidemiology (Haas & Lennon; Garisto et al.; Hillerup et al.). Dosage simplification: treat each cartridge as 2 mL (overestimates → safe); % → mg/mL by moving the decimal one place right.
...
| 3% mepivacaine (plain) | 6.6 (400) | 114 | 20–30 / 45–65 min | 2–3 h |
| 2% mepivacaine + 1:20,000 levonordefrin | 7 (550) | — | 40–60 / 60–90 min | 3–5 h |
| 4% prilocaine (plain) | 6 (400)* | 96 | 10–15 / 45–65 min | 3–4 h |
| 4% prilocaine + 1:200,000 epi | 6 (400)* | — | 35–45 / 50–70 min | 3–6 h |
| 4% articaine + 1:200,000 or 1:100,000 epi | 5–7 (500)† | 20 | 60–75 / 90–120 min | 3–5 h |
| 0.5% bupivacaine + 1:200,000 epi | (90)‡ | 210 | 30–45 min / 4–7 h | 8–12 h |

\* Prilocaine conservative; some references allow 8 mg/kg / 600 mg.
...
- **Methemoglobinemia** (prilocaine o-toluidine): symptomatic >15%, life-threatening 50–60%; IV methylene blue; hereditary form contraindicates prilocaine.
- **Bupivacaine** greatest direct cardiotoxicity (slow Na⁺-channel dissociation) — relevant only at very high non-dental doses.
- **Combinations are additive** — used half the lidocaine max, halve the added bupivacaine max.
- **Epinephrine**: >1:200,000 gives no IANB onset/duration benefit and no serum-level reduction; 1:50,000 only improves infiltration hemostasis.

[wiki-living-document] 2012 vintage; package-insert max doses and articaine pediatric guidance differ by jurisdiction (US 7 vs Canadian 5 mg/kg children). Verify against current local product inserts before clinical use.
