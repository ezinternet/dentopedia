...
tags: [local-anesthesia, articaine, lidocaine, pediatric-dentistry, adverse-effects, meta-analysis, infiltration, IANB]
relations:
  - type: reinforces
...
1. First SR/MA dedicated to articaine-vs-lidocaine **adverse events** (not efficacy) in pediatric dentistry.
2. Pooled pediatric adverse-event RR 1.08 (0.54–2.15) — a usable safety base rate.
3. Outcome-specific subgroups (pain, soft-tissue injury, edema) all NS.
4. Sensitivity analysis (excluding Ma 2019): heterogeneity drops I²=57%→30%, conclusion unchanged.

## Methodology

- 6 databases (Cochrane, PubMed, CBM, Embase, Web of Science, CNKI) to Nov 2021.
- RCTs only, healthy children <14 y, raw adverse-event data, BI and IANB.
- 333 records → 8 RCTs; RevMan 5.3 random-effects; Cochrane RoB (2 low, 3 high, 3 moderate); GRADE; funnel plot (no publication bias).
- Articaine usually 4% + 1:100,000 epi (5 mg/kg); lidocaine 2% + 1:80,000–1:100,000 epi (4.4 mg/kg).
...
| Overall AE (Ma excluded) | 7 | 1.39 (0.78–2.50) | — | 30% |
