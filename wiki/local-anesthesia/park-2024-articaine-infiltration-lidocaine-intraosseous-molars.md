...
tags: [local-anesthesia, articaine, lidocaine, intraosseous, buccal-infiltration, mandibular-molar, QuickSleeper5, ICDAS, korea, retrospective]
relations:
  - type: extends
...
1. First head-to-head ABI vs LIO comparison for single mandibular molar caries (prior work only compared ABI vs lidocaine IANB).
2. Quantifies a large success-rate gap favoring intraosseous lidocaine (100% vs 70.8%).
3. Demonstrates that the **delivery technique** (direct intraosseous deposition) — not the anesthetic molecule — drives the fast 1-minute onset.
4. Documents that LIO still produces lower-lip numbness in 83.3% (anesthetic reaches the inferior alveolar/mental nerve even from bone), countering the assumption that intraosseous = no lip numbness.

## Methodology

- **Design**: retrospective comparative chart review, n=48 (24 ABI, 24 LIO), IRB B-2403-891-103, May 2021–Feb 2024.
- **Inclusion**: mandibular 1st/2nd molar, ICDAS 5–6, EPT-positive ×2, age >19, single tooth, no block anesthesia.
- **ABI**: 4% articaine + 1:100,000 epi, 1.8 mL, 30-G needle, buccal infiltration over 4 min.
- **LIO**: 2% lidocaine + 1:100,000 epi, 1.8 mL, QuickSleeper5 (30-G 16-mm Aiguilles needle) into interdental bone over 4 min.
- **Success** = no supplemental anesthesia needed (supplemental = periodontal 2% lidocaine if EPT-positive at 9 min).
- **Outcomes**: Heft-Parker VAS pain; EPT onset at 1/3/5/7/9 min; subjective duration; lower-lip numbness; subjective HR rise.
- **Stats**: SPSS v27, χ²/Fisher + t-tests, α=0.05. Groups homogeneous (age, sex, ICDAS, tooth all NS).
...
|---|---|---|---|
| No supplemental anesthesia (success) | 70.8% (17/24) | 100% (24/24) | <0.01 |
| Injection pain (Heft-Parker VAS) | 32.0 ± 18.6 | 17.3 ± 17.3 | <0.01 |
| Onset at 1 min | 12.5% | 91.7% | <0.001 |
| Onset failure | 25.0% | 0% | — |
| Duration (min) | 231.3 ± 79.7 | 118.6 ± 52.2 | <0.001 |
