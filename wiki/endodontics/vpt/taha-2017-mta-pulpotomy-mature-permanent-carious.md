...
## Key Contributions
- 성인 성숙 영구치에서 MTA full pulpotomy 적용 타당성 제시
- 적절한 적응증(가역성 치수염) 선택 시 수용 가능한 성공률
- 소아·미성숙치 편중 연구 흐름에 성인 데이터 추가

## Methodology
Prospective; 52 teeth, 43 pts (11–51yrs); complete root formation; reversible pulpitis; 5% NaOCl + full pulpotomy + MTA; vitality test + PA X-ray f/u

## Results
- 단기 성공률: ~80% (abstract 기반, 상세 수치 full text 필요)
- 적응증 선택(진단 정확도)이 성공의 핵심

## Related Papers
- [[endodontics/vpt/fasoulas-2023-pulpotomy-direct-pulp-capping-sr-ma]] — pulpotomy SR+MA
- [[endodontics/vpt/chailertvanitkul-2014-ch-mta-partial-pulpotomy-rct]] — partial pulpotomy RCT
