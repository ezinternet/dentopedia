...
tags: [pulpotomy, pulpectomy, primary-teeth, irreversible-pulpitis, vital-pulp-therapy, minimally-invasive, pediatric, abstract-only]
relations:
  - type: extends
...
> No PMC open-access full text exists (J Dent, Elsevier subscription); under wiki Rule #1 the full text was not retrieved. Content below is grounded in the PubMed abstract only ([DOI 10.1016/j.jdent.2026.106329](https://doi.org/10.1016/j.jdent.2026.106329)).

According to PubMed, this SR+MA tests a question at the frontier of pediatric pulp therapy: can **pulpotomy** (remove coronal pulp, keep vital radicular pulp) replace **pulpectomy** (full primary-tooth root canal) for primary teeth diagnosed with **irreversible pulpitis** — a diagnosis that traditionally mandated pulpectomy or extraction? The minimally invasive case rests on histologic/clinical evidence that radicular pulp is often less inflamed than the clinical diagnosis implies.
...
- First head-to-head pulpotomy-vs-pulpectomy SR+MA for irreversible pulpitis in primary teeth.
- No significant difference (clinical or radiographic) at ≤12 mo — but only 2 studies, very low certainty.

## Methodology

SR+MA; 6-database search to April 2025; primary teeth with irreversible pulpitis (excluding swelling/sinus tract/furcal/periapical radiolucency/resorption), ≥12-mo follow-up; 2 studies (1 RCT + 1 cohort); random-effects meta-analysis. Confidence `sr+ma`; abstract-only ingest (no PMC OA).

## Results

- Radiographic success: RR 1.35 (95% CI 0.67–2.73; p=0.40), I²=96% — NS.
- Clinical success: RR 1.06 (95% CI 0.95–1.18; p=0.28), I²=66% — NS.
- Certainty: very low for both.
