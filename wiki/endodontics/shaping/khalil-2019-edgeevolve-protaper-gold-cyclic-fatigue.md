---
title: "Cyclic fatigue, bending resistance, and surface roughness of ProTaper Gold and EdgeEvolve files in canals with single- and double-curvature"
authors: Wafaa A. Khalil, Zuhair S. Natto
year: 2019
date: 2019-05-01
...
## Key Contributions
- Single vs double curvature comparison (same files, different canals)
- Triangulates fatigue with bending resistance and surface roughness
- Evidence that ProTaper Gold is not the best in class for fatigue/flexibility

## Methodology
- Design: in vitro
- Sample: 15 files per group
- Canals: single (60°, 5-mm radius) and double (60°/5-mm coronal + 30°/2-mm apical) artificial canals
- Tests: cyclic fatigue (NCF), bending to 45° on universal testing machine, SEM/EDX, AFM Ra
- Statistics: Mann-Whitney/t-test, α=0.05

## Results
- Cyclic fatigue: EdgeEvolve > PTG in both canal geometries (p<0.05)
- Both systems: double curve < single curve fatigue resistance (p<0.05)
- Flexibility: EdgeEvolve > PTG (p<0.05)
- Surface Ra: EdgeEvolve < PTG (smoother, p<0.05)
- Ni/Ti content: equivalent (p>0.05)

## Limitations
- Single operator, single canal-block geometry
- No clinical fracture endpoint
- Other EdgeEndo systems not compared

## Related Papers
- [[endodontics/shaping/ozyurek-2017-protaper-cyclic-fatigue-sterilization]] — ProTaper Universal/Next/Gold within-brand
- [[endodontics/shaping/almohareb-2023-cyclic-fatigue-niti-autoclave]] — EdgeTaper Platinum / PTG / TruNatomy + autoclave
- [[endodontics/shaping/kim-2021-protaper-waveone-trunatomy-canal-transportation]] — PTG transportation side
