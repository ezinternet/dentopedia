...
## Key Contributions
- Revitalization: 높은 임상 증상 소실률
- 치근단 치유: 방사선학적 양호
- 성숙치 적용 가능성 제시 — 증거 수준 낮음
- RCT 극히 부족: 결론 제한적

## Methodology
IEJ SR+MA; PICO; immature + mature permanent teeth, pulp necrosis ± apical periodontitis; revitalization outcomes

## Results
- 임상 성공률(symptom-free): 높음
- 치근단 치유: 양호
- 성숙치 vs 미성숙치: 유사 경향 (소규모)

## Related Papers
- [[endodontics/regenerative/torabinejad-2017-ret-mta-apical-plug-sr-ma]] — RET vs MAP SR+MA
- [[endodontics/regenerative/panda-2022-regenerative-apexification-immature-teeth-sr-ma]] — 치근 발육 비교
