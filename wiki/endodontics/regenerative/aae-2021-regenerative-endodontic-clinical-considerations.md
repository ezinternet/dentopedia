---
title: "AAE Clinical Considerations for a Regenerative Endodontic Procedure (2021 Revision)"
...
## Key Contributions
- Visit 1: 1.5% NaOCl + 17% EDTA irrigation; Ca(OH)₂ or TAP (1mg/mL) placement
- Visit 2: scaffold induction (blood clot/PRP/PRF); MTA/Biodentine barrier; final restoration
- Expanded indication: consider REP even in mature teeth with symptomatic irreversible pulpitis (select cases)

## Methodology
AAE evidence-based guideline; 2021 revision.

## Results
Ca(OH)₂ preferred over TAP to minimize crown discoloration risk. No specific scaffold type mandated. Success without root maturation possible (periapical healing).

## Related Papers
- [[endodontics/regenerative/wei-2022-regenerative-endodontic-expert-consensus]] — related
- [[endodontics/regenerative/sellami-2023-regenerative-endodontic-microbiology-outcome]] — related
