...
## Key Contributions
- MDP + calcium silicate combination (TheraCem) superior to MDP-only formulations
- Primer mandatory even with MDP-containing SARCs for durable zirconia bonding
- Material-specific interactions dominate over primer/thermocycling interactions
- RelyX U200: mechanically strongest but weakest bond — trade-off between bulk mechanical properties and adhesion

## Results
| 시멘트 | SBS 순위 | 프라이머 효과 | 열순환 내구성 | 굴곡강도·경도 |
|--------|---------|------------|------------|------------|
| TheraCem (TC) | **1위** | ↑ 유의 | 감소 | 중간 |
| Clearfil SA Luting (SA) | 2위 | ↑ 유의 | 감소+조기파절 | 중간 |
| RelyX U200 (RU) | 3위 | ↑ 유의 | 감소+조기파절 | **최고** |

- 파절 양상: 혼합파절 (Mixed failure) 전 조건 우세
- MDP (10-Methacryloyloxydecyl Dihydrogen Phosphate): 지르코니아 수산기와 수소결합+이온결합

## Related Papers
- [[dental-materials/genc-2025-cleaning-protocols-zirconia-bond-strength]] — 세정 프로토콜 후 SARC 접착
