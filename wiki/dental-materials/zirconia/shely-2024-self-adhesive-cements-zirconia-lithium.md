---
title: "Three Self-Adhesive Resin Cements and Their Influence on the Marginal Adaptation of Zirconia-Reinforced Lithium Silicate Single Crowns"
...
## Key Contributions
- ZLS crowns: different from monolithic zirconia — contains glass phase, amenable to HF etching
- All three self-adhesive cements: acceptable marginal gaps (≤120 µm threshold)
- Cement selection for ZLS: marginal adaptation not the differentiating factor
- IOS-CAD/CAM workflow: Primescan accuracy confirmed for ZLS marginal fit

## Related Papers
- [[dental-materials/zirconia/kwon-2026-self-adhesive-resin-cement-zirconia]] — self-adhesive cements on pure zirconia
- [[dental-materials/zirconia/shokry-2022-zirconia-crown-primer-cement-retention]] — retention with different primer-cement systems
