...
## Key Contributions
Comprehensive per-site reference data combining bone plate thickness with root inclination — relevant to fenestration and dehiscence risk in IIP.

## Methodology
Retrospective CBCT measurements at multiple sites along both arches. Buccal plate thickness at standard levels; tooth root inclination relative to alveolar long axis.

## Results
Quantifies site-by-site variation; buccal plate predominantly thin in anterior maxilla; varying root inclinations correlate with relative buccal/palatal bone distribution.
