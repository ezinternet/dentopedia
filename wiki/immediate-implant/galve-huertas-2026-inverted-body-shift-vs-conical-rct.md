...
## 한줄요약
1년 RCT: inverted body-shift design vs 통상 conical implant in IIP — 디자인 차이가 esthetic outcome과 buccal bone 변화에 미치는 영향 비교, 통상 conical 대비 비열등성 입증을 목표.
...
## Methodology
Randomized clinical trial. Anterior IIP patients allocated to test (inverted body-shift) vs control (conical) arm. 1-year clinical, radiographic, esthetic outcomes.

## Results
Comparable survival between arms; design-specific differences in trajectory control and buccal bone preservation reported.
