...
## Key Contributions
- 순측 흡수가 **중앙부에서 근원심부의 약 2배** 심함을 정량화
- 치조정의 구개/설측 이동 패턴 확인 (치조정을 3등분 선 기준 더 설측으로)
- 임플란트 위치 결정 시 순측 중앙부 골소실 고려 필요성 임상 제시
...
## Clinical Relevance
- 순측 중앙부 집중 골소실 → 임플란트 식립 축 방향 및 위치 계획에 영향
- 발치와 보존술: **순측 중앙부**를 표적으로 이식재 충전 시 효과 극대화
