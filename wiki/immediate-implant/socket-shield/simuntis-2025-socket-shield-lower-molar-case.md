---
title: "Tissue Preservation Using Socket-Shield Technique in Lower Molar Site: A Proof of Principle Report"
...
## Methodology
- Case report (proof of principle, n=1)
- 하악 대구치 SST 적용
- 술식 + clinical 추적

## Results (요약)
- 임상 정착·tissue preservation 시사
- 후방 적용의 첫 datapoint

## Clinical Position
- **결정 트리**: SST를 후방 대구치에 적용 시 본 case가 reference
- **한계**: n=1 proof of principle, 일반화 안 됨
- **후방 적용 시 고려사항**:
  - 교합력 (anterior 대비 큰 occlusal load)
  - Root morphology (다근치 — shield 선택 복잡)
  - Esthetic 중요도 낮음 (후방 → SST 적응증 약화)
...
- [[immediate-implant/socket-shield/zhang-2026-socket-shield-orthodontic-premolar-rct]] — orthodontic premolar
