...
## 근거 한계 (공통)
- Park 그룹 연작은 모두 소규모(n=11~20) 단일기관·단일술자 RCT — 검정력 한계, 등가 결론은 소효과 배제 불가.
- PROM(통증·만족·기능) 데이터 거의 부재(Avila-Ortiz가 명시적 지적).
- 장기(>5년) 추적은 Ionescu(5년)·Adams 증례 외 빈약.
- 부위·골표현형(biotype)별 층화 분석 부족.
