---
title: "Versah Densah® 제조사 프로토콜 5종 — 술기 선택 의사결정 지도 (protocol-selection map)"
...
relations:
  ...
  - type: extends
    target: versah-densah-sinus-lift-i-protocol-rbh-6mm-minimum
  - type: extends
...
```mermaid
graph TD
    Q0["Versah Densah® OD<br/>CCW 800–1500 rpm"]
    Q0 --> SINUS{"상악동 거상<br/>동반?"}
    SINUS -->|"Yes — 잔존골 충분"| RBH{"잔존 골높이<br/>(RBH)"}
    RBH -->|"≥6 mm, ridge폭 ≥4 mm"| P1["① Crestal Sinus Lift I<br/>(pilot drill 사용)"]
    RBH -->|"4–5 mm, ridge폭 ≥5 mm"| P2["② Crestal Sinus Lift II<br/>(pilot drill 생략)"]
    SINUS -->|"Yes — 발치 동반 구치"| SEPTUM{"구치 septum<br/>폭 ≥4 mm?"}
    SEPTUM -->|"Yes"| P3["③ 구치 septum 확장<br/>+ 동시 상악동 거상"]
    SINUS -->|"No — 발치와 즉시식립"| SOCKET{"socket 벽<br/>상태"}
    SOCKET -->|"buccal wall 보존<br/>(Type 1)"| P5["⑤ 즉시식립<br/>(apical engagement)"]
