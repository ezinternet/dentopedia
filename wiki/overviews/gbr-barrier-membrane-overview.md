...
tags: [gbr, barrier-membrane, collagen, edc-crosslink, ptfe, titanium-mesh, programmable-membrane, overview]
---

## One-line Summary

Across 7 papers (3 narrative reviews, 4 animal studies), GBR barrier membranes divide cleanly by a single upstream variable — resorbability — with the crosslinking strategy determining whether a collagen membrane meets the 16–24-week GBR barrier-function threshold, while next-generation "programmable interface" designs targeting macrophage M1→M2 polarization represent a fundamental conceptual reframe of the membrane's biological role.

## 한줄요약

7편(서술적 고찰 3편·동물실험 4편) 종합 — GBR 차폐막은 흡수성/비흡수성이라는 단일 상류 변수로 분기하며, 가교화 전략이 콜라겐막의 16–24주 차단기능 충족 여부를 결정한다; 차세대 '프로그래머블 인터페이스' 설계는 대식세포 M1→M2 편극화 조절이라는 새로운 생물학적 목표로 패러다임을 재정의한다.
...
**Biodegradable synthetic polyesters** (PLA/PGA/PLGA/PCL): tunable degradation rate via copolymer ratio; acidic degradation byproducts can cause local inflammation — a recognized limitation not shared by collagen.
...
| EDC | 8+ weeks confirmed | Low | Animal (Park 2015) + in vitro | Current preferred crosslinking |
...
- Vertical ridge augmentation (high soft-tissue pressure, open) → non-resorbable membrane (Ti-reinforced PTFE, Ti-mesh, ePTFE) required for space maintenance against gravity and muscle pull
