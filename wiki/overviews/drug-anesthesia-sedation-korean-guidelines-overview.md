...
[미검증] 임상의 입장에서 실무 함의는: 진정은 따를 국가 표준이 생겼으니 provider 교육·장비·monitoring·퇴원 기준을 그 틀에 맞추면 되고, 국소마취는 아직 한국 표준이 없어 교과서·국제 가이드라인·개별 약물 근거(아래 §3 링크)에 의존해야 한다.

---

## 1. 진정 가이드라인 — Karm 2023 (2022 국가 지침 해설)

[확인] Karm 2023 (JKDA 61(4):293-306, 서울대 치과마취과학교실) — 2022년 한국 진정 가이드라인을 15개 PICO question 구조로 정리. Moderate sedation이 중심이나 deep sedation 전이 가능성을 고려한 monitoring·complication 항목 포함.
...
[확인] Hwang 2023 (JKDA 61(4):307-310, 한양대 구강악안면외과) — 국소마취가 dental school 교육 기본이자 임상 최빈 술기임에도 한국 표준 진료지침이 없다는 격차를 명문화한 position paper. 가이드라인 제정 시 검토할 영역(구강악안면 통증 관리, 신경분포에 따른 마취 선택 등)을 enumeration.

→ [확인] 이것은 **가이드라인이 아니라 가이드라인 제정 제안서**. 실제 권고 항목은 후속 작업 대상. 4페이지 분량으로 국제 비교·체계적 검색은 없음. 본 wiki에서는 "한국 LA 표준화 공백"을 표시하는 reference로만 기능.
...
- Vasoconstrictor 농도: 1:200,000 epinephrine이 1:80,000과 진통 동등 + 혈역학 안전 — [확인] Karm 2017 RCT. → [[drug-systemic-disease-dental-management-overview]] §5-1
...
[미검증] 즉 "국소마취 한국 가이드라인"은 없지만, 그 가이드라인이 담아야 할 핵심 약리 결정(어느 vasoconstrictor를 얼마 농도로, 어느 환자에 회피)은 이미 wiki에 분산 근거로 존재. 이 overview는 그 분산 근거를 한국 표준화 맥락에서 묶는 진입점.
