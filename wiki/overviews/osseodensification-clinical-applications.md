...
**같은 논문 안의 head-to-head 신호 (narrative — pooled 아님)**: Rizk 2024 RCT — OD 버 > 임플란트 확장기 (폭 증가; 즉시 p=0.018/0.022 · 6개월 p=0.025/0.040); Tofan 2024 — OD 버 vs 나사형 확장기 최종 폭 차이 없음(5.48±0.57 vs 5.53±0.71)이나 OD가 더 빠름; Ahmed 2022 — OD가 crestal split 대비 삽입토크↑·수술시간↓이나 **6개월 수평 골증가는 유의차 없음**(1.99±0.68 vs 2.63±0.74 mm).
