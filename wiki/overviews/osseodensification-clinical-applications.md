...
source_papers:
  ...
  - wiki/implants/osseodensification/mohammadi-2025-osseodensification-conventional-low-density-bone-sr-ma.md
  - wiki/implants/osseodensification/bergamo-2021-osseodensification-effect-implants-primary-secondary.md
  - wiki/implants/osseodensification/neiva-2018-effects-osseodensification-astra-tx-ev.md
  - wiki/implants/osseodensification/barbera-millan-2021-primary-stability-low-density-osseodensification.md
  ...
  - wiki/implants/osseodensification/torroni-2021-osseodensification-lumbar-fixation-ovine-pedicle-screw.md
  - wiki/implants/osseodensification/lopez-2017-osseodensification-spinal-surgical-hardware-fixation.md
  ...
  - wiki/implants/osseodensification/koutouzis-2025-osteotomy-preparation-short-implants-stability.md
  - wiki/implants/osseodensification/mercier-2022-osseodensification-primary-stability-cadavers.md
  - wiki/implants/osseodensification/moghaddas-2025-osseodensification-standard-drilling-isq-itv.md
  ...
  - wiki/implants/osseodensification/shilpi-2025-osseodensification-conventional-low-bone-sr-ma.md
  - wiki/bone-regeneration/lopez-valverde-2025-bone-expansion-compaction-densification-narrow-crests-sr-ma.md
  - wiki/implants/osteotomy-thermal/batz-2019-influence-broach-design-bone-friction.md
  - wiki/implants/coyac-2019-preclinical-model-links-osseo-densification-misfit.md
  - wiki/implants/osseodensification/de-agostinho-neto-2026-in-vitro-evaluation-different-implant-systems.md
...
> - **신규(Marzorati 2026 SR+MA, CCW 전용 인체 한정)**: CCW Densah bur만 포함한 최초 인체 SR+MA(555명/685개) — IT 45.75 vs 38.00 N·cm(P<0.001); **ISQ MD 3.24(95% CI 0.72–5.95, P=0.024) 통계적 유의** — 오스테오톰·Magnetic Mallet(MM) 제외 시 인체 SR+MA 최초 유의. 단 CI 하한 0.72(임상적으로 작음), 이전 SR+MA(mohammadi·shilpi) NS는 기법 혼입 때문일 가능성 시사. 생존율·변연골소실(MBL) 미보고. [확인]
> - **신규(Kalra 2025 SR+MA, 저밀도골 특이)**: 치조정 골수준(Crestal Bone Level, CBL)을 풀링한 최초 OD SR+MA(5편/109명/198개) — ISQ 기저치·추적관찰 OD 유의 우위(P<.05); **CBL 변화량은 어느 시점도 유의차 없음(P>.05)** — OD의 기계적 1차 안정성 이득이 변연골 보호로 이어지지 않음; n=198로 진짜 null vs 검정력 부족 미결. [확인]
> - **신규(Ali 2026 split-mouth RCT, 전방 심미 구역)**: Densah bur(DB) vs Magnetic Mallet(MM) 전방 상악 7명 14부위 최초 split-mouth RCT — DB 1차 ISQ 70.1 vs MM 49.0(p<0.001), 6개월 DB 74.7 vs MM 59.8; DB 순구개측 골판 두께 유의↑; **MM 1건 골판 골절 → 임플란트 실패**; 얇은 치조제에서 MM 위험 신호 — DB가 전방 상악 심미 구역에서 ISQ ≥70 임계값 달성. n=7 소규모. [확인]
...
> - **저밀도의 바닥**: de Agostinho Neto 2026(소 늑골 극저밀도, SIN/VERSAH/MAXIMUS 3군)이 미세구조·토크 **전부 NS**(35 / 43.2 / 59.6 Ncm). 경부·체부·근단부를 나눈 첫 micro-CT 계측이며 부위 차 없음 → HaeNaem 특허 전제(측벽↑·바닥↓, d2 ≪ d1) 미지지. 단 **n=5–8로 검정력 부족이 유력** → "차이 없음"이 아니라 "못 찾음"; 특허 전제는 미검증인 채로 남음.
> - **[2026-09-19 신규] OD vs 확장기 직접 RCT (Nabih 2025) — 6개월 ISQ OD 우위, 확장 유지 우세**: 이중맹검 RCT(n=22, 상악 D3/D4, 협설 ≥4mm) — 1차·3개월 임플란트 안정성 지수 (Implant Stability Quotient, ISQ) NS; **6개월 ISQ 79.60 vs 72.10(P=0.0268) OD 우위**; 치조정 폭경 6개월 2·4·8 mm 수준 전부 OD 유의↑(P<0.01); 확장기군 협측 피질골 골절 2건(제외)·3개월 실패 2건 vs OD 실패 1건; 생존율 87%. 단 술전 2mm 폭경 이미 OD군 유의↑(P=0.0193) — 폭경·안정성 우위가 기저 차이 반영 가능. OD vs 확장기 비교 최초 직접 RCT; HaeNaem 확장기(철회된 changrani-2024와 달리 유효한 비교군). 저자: 확장기는 중등도 골(D2–D3)·충분한 기저 폭에 적합 가능. [확인]
...
Frame OD gains as "mechanical fixation (IT) certain / ISQ uncertain" when counseling patients; the sub-antral TSFE and low-density bone D3–D4 scenarios remain the two clinically active spokes, the narrow-ridge spoke is now filled by a dedicated SR+MA (López-Valverde 2025, 10 studies/241 subjects — but it pools BE+BC+OD against comparators rather than testing OD against BE, and only its bone-density estimate is trustworthy: BD SMD −0.71 at I²=0% versus CE −1.12 at I²≥75% and ISQ −8.88 at I²=96%, both with marked publication bias, leading its authors to place these techniques behind GBR/blocks/crestal split), and only the immediate-placement spoke still lacks a dedicated SR.

Two axes are new and both cut against the benefit-heavy reading: Coyac 2019 supplies the first ceiling — assigned high misfit osseo-densified bone and then destroyed it (micro-fractures, extensive osteocyte death, TRAP/cathepsin-K resorption, absent ALP/collagen I, early failure), formalized as "excessive osseo-densification → osseo-destruction", though abstract-only reporting means it establishes that a ceiling exists without locating it; and Bätz 2019 separates geometry from working direction (blunt extraction densified +117%, P=.005, statistically alongside compaction at +121%), supporting the reading that rotation selects which face engages rather than direction being causal — while de Agostinho Neto 2026 finds every outcome null in extremely porous bone (a likely-underpowered "threshold of utility" at n=5–8) and, in the first regional cervical/body/apical micro-CT the wiki holds, fails to support the HaeNaem patent's premise of side-wall-dominant densification.
...
환자 설명 시 "삽입 토크는 확실·ISQ는 혼재"로 분리; 상악동저 보강·저밀도골이 가장 활성화된 두 스포크; **좁은 ridge spoke는 López-Valverde 2025 SR+MA(10편/241명)로 개통** — 단 BE·BC·OD 합산 vs 대조이지 OD vs BE 비교가 아니며, 골밀도(SMD −0.71, I²=0%)만 견고하고 확장·ISQ는 출판편향 고위험이라 저자들도 GBR·crestal split 뒤에 배치; **즉시식립만 단독 SR 부재로 대기**.

신규 두 축은 모두 이득 편중을 깎는 방향이다: Coyac 2019이 **과잉 밀도화의 천장**(고미스핏 배정 → 골밀도화 → 미세골절·골세포 사멸 → 흡수 우세 → 조기 실패; "excessive osseo-densification → osseo-destruction")을 처음 제시하나 초록 전용이라 **천장의 존재만 말하고 위치는 말하지 않는다**; Bätz 2019은 방향을 고정한 채 형상만 바꿔 무딘 추출형 +117%(P=.005)로 **형상이 밀도화를 정함**을 계측해 Rittipakorn CW-OD를 지지; de Agostinho Neto 2026은 극저밀도에서 전 지표 NS(검정력 부족 유력)이자 부위별 micro-CT 첫 계측으로 **HaeNaem 특허의 측벽 편중 밀도화 전제를 지지하지 않음**.

---

## Summary

이 overview는 [[implants/osseodensification/fontes-pereira-2023-osseodensification-osteotomy-alternative-sr|Fontes Pereira et al. 2023 (JCM, SR, search 2016–2023)]]를 spine으로 OD의 전체 그림을 잡는다. 그 SR이 명시적으로 분류한 4개 적용 시나리오를 축으로, llm-wiki에 들어와 있는 OD 관련 페이지들을 spoke로 묶는다.
...
[[implants/osseodensification/huwais-2017-novel-osseous-densification-osteotomy-primary-stability|Huwais & Meyer 2017 (in vitro, 돼지경골 n=72)]]가 OD를 정의한 원위논문이다. 핵심 4가지:

- **회전 방향**: Densahbur는 다날 (multi-flute) bur로 시계방향 (Clockwise, CW)에서는 cutting, 반시계방향 (CCW)에서는 burnishing/compacting [확인, Huwais 2016]. **단 CCW가 OD의 절대조건은 아닐 수 있다** — [[implants/osseodensification/rittipakorn-2025-clockwise-osseodensification-primary-stability-cadaveric|Rittipakorn et al. 2025 (사람 경골 사체, D3/D4, n=20/group)]] [in-vitro]은 densifying bur를 *절삭방향인 CW·더 낮은 800 rpm*으로 돌리는 단순화 프로토콜(**CW-OD**)을 처음 검증했다. 가설: bur의 음의 rake angle과 비예리 flute가 CW에서도 측방 압축을 만든다. 결과는 SD 대비 ISQ(67.5 vs 62.9, p=0.077)·IT(34.0 vs 29.5 Ncm, p=0.052) 모두 수치상 높으나 NS였고, 대신 OD가 **IQR이 더 좁고 저토크 outlier가 없어 일관**됐으며 IT–ISQ 상관이 OD에서만 유의(ρ=0.577, p=0.0077). 즉 표준 CCW가 reverse-cutting flute로 실제 골을 깎아 술기민감도가 높다는 한계의 대안으로 CW-OD가 제시되나, 작은 표본·사체·정성영상·CCW arm 부재로 in-vivo 검증 필요 [미검증: CCW 컨벤션을 흔드는 첫 직접 데이터].
...
이 메커니즘이 4개 적용 시나리오의 공통 분모다. ISQ가 항상 오르는 건 아니라는 점은 Huwais 2016에서도 이미 명시 — OD의 차별점은 IT와 BIC, ISQ는 부수효과 [확인].

**기구 공학적 기반 (patent layer):** OD 버의 핵심 설계는 특허 문헌에 정의돼 있다. [[implants/osseodensification/huwais-2017-autografting-tool-enhanced-flute-profile]] (PCT WO 2017/124079, Versah/Densah)는 *연속적 음의 레이크각 (negative rake angle)* 과 날마다 절삭면+압밀면을 둔 구조로, 한 방향(CW)은 절삭·반대 방향(CCW)은 골 압축/유압식 자가이식을 구현 — 위 CW/CCW 메커니즘의 공학적 근거다. [[implants/osteotomy-thermal/kim-2019-double-spiral-condensing-screw-implant]] (KR 특허, HaeNaem)은 이중나선(압축 thread + 골분 유도 grooves + 하부 압축 dome)으로 측방·치근단 압밀을 한 번에 달성해 경치조골 상악동거상까지 노린 대체 OD 기구의 설계 기반이다. 즉 Versah(미국)·HaeNaem(한국) 두 계열 모두 "절삭 대신 압밀+자가이식"이라는 동일 원리를 서로 다른 기하로 구현한다.

**형상 vs 방향 — 특허 산문 아래 처음 깔린 계측 (2026-07-17 추가):** 위 patent layer의 핵심 주장("날의 face 기하가 절삭이냐 압밀이냐를 정한다")은 지금까지 **발명자 주장일 뿐 데이터가 없었다**. [[implants/osteotomy-thermal/batz-2019-influence-broach-design-bone-friction|Bätz et al. 2019 (Clin Biomech, 소 해면골 육면체, 준정적 벤치)]] [확인, 단 정형외과·초록 전용]가 그 아래 처음으로 계측을 깔았다: 인공 고관절 치환술 (Total Hip Arthroplasty, THA) 브로치 3종을 비교하되 **작업 방향을 추출(extraction)로 고정한 채 예리함만 바꾸자, 무딘 추출형이 예리한 추출형 대비 골밀도화 +117% (P=.005)** — 압착형(+121%)과 통계적으로 나란히 — 를 만들었다. 즉 *"절삭해야 할" 방향으로 움직이는 기구도 형상이 무디면 밀도화한다.* 이는 [[implants/osseodensification/rittipakorn-2025-clockwise-osseodensification-primary-stability-cadaveric|Rittipakorn 2025]]의 CW-OD 결과(시계방향으로 돌려도 압축됨)를 "방향이 인과"가 아니라 **"회전은 어느 face가 골을 물지를 고를 뿐"**으로 읽는 쪽을 지지한다 — §1 첫머리의 CW/CCW 컨벤션을 흔드는 두 번째 축. 또한 밀도화를 **깊이**(압착형이 더 깊음, P=.001)와 **최대 밀도화 크기**(무딘 추출형이 더 높음, P=.008)로 분리한 유일한 보유 논문으로, [[implants/osteotomy-thermal/kim-2019-double-spiral-condensing-screw-implant|HaeNaem 특허]]가 제기한 측방-vs-치근단 분포 질문의 가장 가까운 대용이다. **전이 한계가 심각하다**: 브로치는 축방향 타격이지 800–1500 rpm 회전이 아니고, 하중이 준정적이며, 소 해면골은 턱뼈가 아니다 — 치과 기구를 하나도 시험하지 않았다. 기전은 시사적일 뿐 **임상 수치로 전이 불가** [미검증: 전이 자체가 미검증].

**과잉의 천장 — densification이 destruction으로 넘어가는 지점 (2026-07-17 추가):** 위 메커니즘은 전부 *"얼마나 이득인가"*를 말하고 **"어디부터 해악인가"를 말하지 않는다** — 보유 OD 논문 대다수가 **치유가 없는** 벤치·ex vivo 계측이기 때문이다. [[implants/coyac-2019-preclinical-model-links-osseo-densification-misfit|Coyac et al. 2019 (Clin Oral Implants Res, 쥐 상악 발치와, 전임상 in vivo)]] [확인, 단 초록 전용]가 그 천장을 처음 제시한다: 임플란트–골삭제 간 **고미스핏(high misfit)을 실험적으로 배정**하자 주위골이 골밀도화된 뒤 미세골절 → **광범위한 골세포 (Osteocyte) 사멸 구역** → 흡수 우세 환경 (주석산 저항성 산성 인산분해효소 (Tartrate-Resistant Acid Phosphatase, TRAP) 활성·카텝신 K (Cathepsin K)) → **신생골 형성 부재** (알칼리성 인산분해효소 (Alkaline Phosphatase, ALP)·제1형 교원질 (Collagen I) 음성) → 섬유성 염증성 육아조직으로 채워진 분화구 모양 조기 실패로 이어졌다. 저자들의 정식화가 곧 명제다 — **"excessive osseo-densification → osseo-destruction"**.
...
**발열·버 재사용 안전** [[implants/osseodensification/soldatos-2024-temperature-changes-osseodensification-cadaver-tibiae-cw-ccw|Soldatos et al. 2024 (cadaver tibiae, 360 osteotomy)]] [확인]: CCW(densification) 모드에서 **3.0/4.0 버를 23회 이상 재사용 + 800/1200 RPM 조합 시 ΔT가 골괴사 임계 47°C 초과**. **1000 RPM이 두 모드 모두 최저 발열**. → 임상 규칙: ① 버는 ~23회에서 교체, ② 저밀도골이라도 RPM을 무작정 높이지 말 것(1000 rpm 부근 권장), ③ 관수 보조. 무관수 고RPM + 마모 버 조합이 가장 위험.

---

## 2. Outcome Matrix — Fontes Pereira 2023 spine

[[implants/osseodensification/fontes-pereira-2023-osseodensification-osteotomy-alternative-sr|SR (JCM 2023, search 2016–2023)]] 결론을 기준점으로:

| Outcome | OD vs Conventional | Consistency | Confidence | 비고 |
|---------|--------------------|-------------|------------|------|
| Insertion Torque (IT) | OD ↑ 유의 (단 직경 의존) | High | [확인] | 모든 included studies에서 일관; bergamo 2021 multicenter CCT도 재확인; **사체에서도 재현 — Mercier 2022 (하악 사체) 34.9 vs 23.6 Ncm p=0.036; Rittipakorn 2025 CW-OD (경골 사체) 34.0 vs 29.5 Ncm p=0.052 trend**; **인체 임상에서도 — Moghaddas 2025 (상악 구치부) 50.3 vs 36.1 Ncm p<0.001 (~37%↑)**; **bench — Tao 2025 (CNC Type IV) IT 11.73 vs 7.77 N·m·RT 9.28 vs 6.65 N·m p<0.001; Barberá-Millán 2021 (돼지경골 D4) OD 21.72 vs under-drilling 8.87 Ncm p=0.000으로 under-drilling 대조군조차 능가**; **de Lima 2026 (소 늑골 ex vivo Type IV, n=16) Versah IT 77.62, WF IT 95.25 Ncm — 두 OD 키트 모두 conventional(61.25 Ncm) 대비 유의↑(p=0.007), RT도 동일 패턴(p=0.008)**. **단 short 임플란트는 직경 의존 — Koutouzis 2025 (돼지경골 6mm) OD IT 이득이 광폭(5.4mm)에서만 유의(50.0 vs 28.0 Ncm p=0.005), 세폭(4.2mm) NS**. **또 하나의 바닥 단서 — de Agostinho Neto 2026 (소 늑골, 극저밀도) 3군 전부 NS (SIN 35±21.5 · VERSAH 43.2±27.1 · MAXIMUS 59.6±28.5 Ncm), 단 n=5–8로 검정력 부족 유력 → "차이 없음"이 아니라 "못 찾음"**; **신규: marzorati-2026 인체 SR+MA(CCW-only, 555명/685개) IT 45.75 vs 38.00 N·cm(P<0.001) 재확인** |
| ISQ (식립 시점, 1차) | OD ↑ 일부 / **인체 SR+MA·임상에서는 NS** | **Low–Moderate ↓ (하향)** | [확인, 논쟁적] | althobaiti 2023 SR·bergamo 2021은 ↑; **mohammadi 2025 SR+MA (7편) 1차 MD=4.13 p=0.13 NS + shilpi 2025 SR+MA (인체 6편) ISQ 즉시 SMD=2.13 p=0.06·추적 SMD=1.81 p=0.11 둘 다 NS — 2025년 두 독립 SR+MA가 같은 결론**; al-ahmari 2022 split-mouth NS; **Moghaddas 2025 인체 전향연구도 ISQ 식립·3개월 NS (양 군 ISQ 68↑) — IT↑/ISQ NS 해리를 임상에서 재현**; **Tao 2025 bench도 ISQ NS (47.1 vs 46.7, p=0.86)**; Rittipakorn 2025 CW-OD도 ISQ 67.5 vs 62.9 p=0.077 NS trend; **de Lima 2026 ex vivo Type IV — ISQ 79–82 across all groups (Versah 82.40·WF 80.68·conventional 79.42), p=0.157 NS — torque↑/ISQ NS 해리를 두 번째 ex vivo 키트 비교에서 재현**. 단 Barberá-Millán 2021은 OD ISQ 69.75 vs UD 65.16 p=0.001로 ↑ (대조군이 under-drilling); **신규: marzorati-2026 SR+MA(CCW-only, 555명/685개) ISQ MD 3.24(95% CI 0.72–5.95, P=0.024) — 오스테오톰 제외 시 인체 SR+MA 최초 유의; 단 CI 하한 0.72로 임상적 효과 작음; 이전 NS(mohammadi·shilpi)는 기법 혼입 때문일 수 있음** |
| ISQ (2차/치유 후) | OD ↑ (동물 RCT·CCT + 저밀도 SR+MA) | Moderate | [확인] | arpudaswamy 2025 (rabbit, 3mo ISQ↑), bergamo 2021 (전 기간 ISQ≥68) — **이득은 1차보다 2차 안정성에 있을 가능성**; **신규: kalra-2025 SR+MA(5편/198개, 저밀도골) ISQ 기저치·추적관찰 모두 OD 유의 우위(P<.05) 확인** |
| BIC / peri-implant 골밀도 | OD ↑ (인비트로 ×3, 인비보 초기에 국한) | Low–Moderate | [확인, in-vitro] / [확인, in vivo] | 인비보 휴먼 데이터 부족; 척추 모델 lopez 2017·torroni 2021이 OD BIC·pullout 우위 보강(외삽 주의); **Mercier 2022 CBCT 사체 골밀도 유의↑(p=0.026); shilpi 2025 SR+MA 식립 직후 골밀도 SMD=2.14 p=0.004 유의↑이나 3–7개월엔 NS — 압축 효과는 초기에 국한, remodeling으로 정상화**; Koutouzis 2025 조직계측은 NS(초기 효과는 기계적 압축, 조직학적 구별 불가) |
| Survival rate | OD = Conventional | High | [확인] | 단기 follow-up |
| 술기 시간 | OD ↓ (특히 sub-antral) | Moderate | [확인] | Starch-Jensen 2025 |
| MBL / CBL (변연골 소실) | 차이 없음 (단기 SR+MA 확인) | Low | [확인, 단 n 소규모] | **신규: kalra-2025 SR+MA(5편/109명/198개, 저밀도골 특이)**: CBL 변화량 어느 시점도 유의차 없음(P>.05) — **OD의 IT·ISQ 이득이 변연골 보호로 전이되지 않음을 CBL-pooling 최초 SR+MA로 확인**; n=198으로 진짜 null vs 검정력 부족 미결. 장기 RCT 필요 |
...
```mermaid
graph LR
    M["OD 메커니즘<br/>CCW 800–1500 rpm<br/>점탄성 + 자가골 압축"]
    M --> S1["1. 상악동저 보강<br/>(sub-antral)"]
    M --> S2["2. 좁은 치조골릉<br/>(narrow ridge)"]
    M --> S3["3. 저밀도골<br/>(D3–D4)"]
    M --> S4["4. 즉시식립<br/>(post-extraction)"]
    S1 --> O["Outcome<br/>IT ↑↑ / ISQ ↑ / BIC ↑<br/>Survival ="]
    S2 --> O
    S3 --> O
    S4 --> O
...
| 저밀도골 D3–D4 | SR + RCT + 사체/임상 (**SR+MA 반례 2편**) | 지지: [[implants/isq/althobaiti-2023-osseodensification-conventional-drilling-isq-sr]] + [[implants/osseodensification/bergamo-2021-osseodensification-effect-implants-primary-secondary]] + [[implants/osseodensification/mercier-2022-osseodensification-primary-stability-cadavers]] + [[implants/osseodensification/moghaddas-2025-osseodensification-standard-drilling-isq-itv]] + [[implants/osseodensification/koutouzis-2025-osteotomy-preparation-short-implants-stability]] (직경 의존) + [[implants/osseodensification/rittipakorn-2025-clockwise-osseodensification-primary-stability-cadaveric]] (CW-OD) + [[implants/osseodensification/de-lima-2026-osseodensification-vs-conventional-drilling-exvivo]] (IT↑/ISQ NS, WF 키트) + [[implants/osseodensification/nabih-2025-evaluation-of-the-stability-of]] (OD vs 확장기 RCT, 6mo ISQ↑, 술전 폭경 혼입) ↔ 반례: [[implants/osseodensification/mohammadi-2025-osseodensification-conventional-low-density-bone-sr-ma]] + [[implants/osseodensification/shilpi-2025-osseodensification-conventional-low-bone-sr-ma]] + [[implants/isq/al-ahmari-2022-osseodensification-conventional-low-density-jaw]] + [[interactives/2026-05-18_d4-bone-densah-protocol]] |
...
| **과잉 OD의 천장** | 전임상 in vivo (쥐, 초록 전용 — 크기 미상) | [[implants/coyac-2019-preclinical-model-links-osseo-densification-misfit]] + [[overviews/high-insertion-torque-primary-stability-crestal-bone-overview]] |
...
- **좁은 치조정 spoke 개통 + 천장·형상 축 신설 (2026-07-17 갱신)**: ① [[lopez-valverde-2025-bone-expansion-compaction-densification-narrow-crests-sr-ma]]가 이 overview가 2026-05-25 개설 이래 "pending"으로 비워 둔 **narrow-ridge spoke를 처음 채움** (§3-2) — 단 채운 내용이 낙관적이지 않다: BD만 견고(I²=0%)하고 CE·ISQ는 출판편향 고위험이며, 저자들은 GBR·블록·crestal split 뒤에 이 기법들을 놓는다. **P1 ingest 우선순위에서 narrow ridge 해제** (즉시식립은 여전히 pending). ② [[coyac-2019-preclinical-model-links-osseo-densification-misfit]]가 OD 문헌 최초로 **천장**(excessive OD → osseo-destruction)을 제시 — 보유 OD 근거가 대부분 *치유 없는* 벤치 계측이라 이 축이 통째로 비어 있었다. 크기 미상(초록 전용)이라 수치 인용 불가하나, §3-2의 Rizk 2024 과잉 밀도화 실패 3건이 독립적으로 같은 방향. ③ [[batz-2019-influence-broach-design-bone-friction]]가 **형상 vs 방향**을 분리 계측(무딘 추출형 +117%, P=.005) — Versah 특허의 face-geometry 주장 아래 처음 깔린 데이터이자 Rittipakorn CW-OD의 기전적 지지. 정형외과·준정적·소뼈로 전이 한계 심각. ④ [[de-agostinho-neto-2026-in-vitro-evaluation-different-implant-systems]]가 **극저밀도 바닥**에서 3군 전부 NS — HaeNaem 특허의 부위별 밀도화 전제(d2 ≪ d1)를 처음 계측했고 지지하지 않았으나, n=5–8로 검정력 부족이 유력해 특허 전제는 미검증인 채로 남는다. **향후 갱신 트리거**: (a) 좁은 능선 OD의 *인체* RCT — 특히 CE를 사전등록 주 결과로 둔 것, (b) 미스핏/토크 크기를 배정해 골세포 사멸 역치를 재는 연구(Coyac의 "어디부터"를 채울 유일한 설계), (c) 부위별(경부/체부/근단부) 밀도화를 충분한 검정력으로 계측한 연구.
- **OD vs 확장기 최초 RCT 통합 (2026-09-19 갱신)**: [[nabih-2025-evaluation-of-the-stability-of]](이중맹검 RCT, n=22, 상악 D3/D4) — 1차·3개월 ISQ NS, **6개월 ISQ OD 우위(79.60 vs 72.10, P=0.0268)**: 이차 안정성 이득 패턴이 확장기 비교에서도 재현; 6개월 폭경 3수준 OD 유의↑(P<0.01); 확장기 폭경 이득은 3–6개월에 회귀; 확장기군 협측 피질골 골절 2건(제외)·실패 2건. 단 **술전 2mm 폭경 이미 차이(P=0.0193)** — 교란변수 존재. OD vs 확장기 직접 비교 최초 RCT; HaeNaem 확장기 첫 유효 임상 비교데이터. **향후 갱신 트리거**: 술전 폭경을 층화한 OD vs 확장기 대규모 RCT; 12개월 이상 폭경·MBL 추적.
- **CCW-only SR+MA 통합 + CBL null 축 신설 + 전방 심미 구역 RCT 추가 (2026-09-13 갱신)**: ① [[marzorati-2026-osseodensification-standard-osteotomy-torque-isq-sr-ma]](SR+MA, CCW-only 인체, 555명/685개) — OD 전용 포함 기준으로 처음 IT(P<0.001)·ISQ(MD 3.24, P=0.024) 모두 유의 → 이전 SR+MA NS의 기법 혼입 가설 부상; 단 ISQ CI 하한 0.72(작음), 이전 오스테오톰 혼입 SR보다 ISQ 효과 크기 작아 진짜 OD-only 효과는 더 작다는 신호. ② [[kalra-2025-implant-stability-crestal-bone-osseodensification-sr-ma]](SR+MA, 5편/198개, 저밀도골) — ISQ 유의↑ 확인(P<.05); **CBL null(최초 pooling)** — IT 이득이 변연골 보호로 전이 안 됨; n=198로 검정력 미결. ③ [[ali-2026-osseodensification-techniques-implant-stability-maxilla]](split-mouth RCT, 7명, 전방 상악) — DB ISQ 70.1 vs MM 49.0(p<0.001); MM 골절 실패 → 얇은 치조제 MM 위험. **향후 갱신 트리거**: (a) 생존율·MBL 포함 장기 RCT, (b) CBL 추적을 충분한 검정력(n≥500)으로 계측하는 OD RCT, (c) CCW-only 포함 기준 SR+MA의 ISQ CI 개선.
- **Included studies 이질성**: protocol·bur 사이즈·rpm·골질 정의가 일관되지 않음 — RCT가 들어올 때마다 outcome matrix의 confidence 재평가.
- **Conventional drilling 정의 모호**: 일부 included studies가 "standard"를 명확히 정의하지 않음 — 본 overview는 OD vs. CW + irrigation으로 가정 [미검증].
...
- **과잉 밀도화에 천장이 있다** (§1 Coyac 2019 + §3-2 Rizk 2024 실패 3건) — 다만 "몇 Ncm/몇 mm 미스핏부터"는 **보유 근거가 답하지 않는다.** 토크 상한 판단은 [[overviews/high-insertion-torque-primary-stability-crestal-bone-overview]]의 부위별 규칙을 따를 것 (숫자가 아니라 "무엇이 토크에 저항했는가")
...
- [[implants/osseodensification/huwais-2017-autografting-tool-enhanced-flute-profile]] — Versah/Densah 버 특허 (음의 레이크각·절삭/압밀 양면 날) — 기구 공학적 기반
- [[implants/osteotomy-thermal/kim-2019-double-spiral-condensing-screw-implant]] — HaeNaem 이중나선 condensing screw 특허 — 한국형 OD 기구 설계 기반
...
- [[implants/osseodensification/mohammadi-2025-osseodensification-conventional-low-density-bone-sr-ma]] — 저밀도골 SR+MA (ISQ NS 반례)
- [[implants/osseodensification/bergamo-2021-osseodensification-effect-implants-primary-secondary]] — multicenter CCT (IT·ISQ 우위, ISQ≥68 유지)
- [[implants/isq/al-ahmari-2022-osseodensification-conventional-low-density-jaw]] — split-mouth 반례 (안정성 NS)
- [[implants/osseodensification/shilpi-2025-osseodensification-conventional-low-bone-sr-ma]] — 저밀도골 인체 SR+MA (6편): ISQ 즉시 p=0.06·추적 p=0.11 NS, 식립 직후 골밀도만 p=0.004↑(3–7mo 소실) — mohammadi 2025와 독립적으로 ISQ NS 재확인 (반례 보강)
- [[implants/osseodensification/moghaddas-2025-osseodensification-standard-drilling-isq-itv]] — 상악 구치부 인체 전향 임상 (39 임플란트): IT ~37%↑(p<0.001)·ISQ NS — IT↑/ISQ NS 해리를 임상에서 재현
- [[implants/osseodensification/koutouzis-2025-osteotomy-preparation-short-implants-stability]] — 돼지경골 short 6mm (90개): OD IT 이득이 광폭(5.4mm)에서만 유의(p=0.005)·세폭 NS — 직경 의존, Bergamo short 예외 정밀화
- [[implants/osseodensification/mercier-2022-osseodensification-primary-stability-cadavers]] — 사람 하악 사체 (58 osteotomy): OD IT 34.9 vs 23.6 Ncm(p=0.036)·CBCT 골밀도↑(p=0.026) — 사체 IT 근거, Rittipakorn CW-OD와 IT 일치
- [[implants/osseodensification/rittipakorn-2025-clockwise-osseodensification-primary-stability-cadaveric]] — 사람 경골 사체 D3/D4 (40 임플란트): **CW-OD(시계방향·800 rpm)** 첫 검증, ISQ·IT trend(NS)·더 일관·IT–ISQ 상관 OD만 유의 — CCW 컨벤션에 대한 대안
- [[implants/isq/arpudaswamy-2025-osseodensification-conventional-implant-stability-rabbit]] — 토끼 D4 RCT (2차 안정성↑)
- [[implants/osseodensification/neiva-2018-effects-osseodensification-astra-tx-ev]] — sheep (IT/RFA·BIC 우위)
- [[implants/osseodensification/barbera-millan-2021-primary-stability-low-density-osseodensification]] — in-vitro 돼지경골 D4: OD가 conventional **under-drilling** 대조군조차 IT(21.72 vs 8.87 Ncm)·ISQ(69.75 vs 65.16) 모두 능가 — D4 1차 안정성 이득 보강
- [[implants/osseodensification/tao-2025-optimizing-osseodensification-drilling-implant]] — in-vitro CNC Type IV: OD torque↑(IT 11.73 vs 7.77 N·m)·ISQ NS(47.1 vs 46.7) divergence 재현 + 드릴링 파라미터 권고(1500 rpm·0.04 mm·z⁻¹·관수)
- [[implants/osseodensification/de-lima-2026-osseodensification-vs-conventional-drilling-exvivo]] — 소 늑골 ex vivo Type IV 쌍대 연구 (n=16): Versah IT 77.62·WF IT 95.25 Ncm vs conventional 61.25 Ncm (p=0.007); ISQ NS (p=0.157) — IT/RT↑·ISQ NS 해리의 세 번째 독립 bench 재현; WF 키트가 Versah 토크 초과
- [[implants/osseodensification/soldatos-2024-temperature-changes-osseodensification-cadaver-tibiae-cw-ccw]] — 발열·버 재사용 안전 (47°C 임계)
- [[implants/osseodensification/torroni-2021-osseodensification-lumbar-fixation-ovine-pedicle-screw]] — 척추 pedicle screw pullout (외삽 주의)
- [[implants/osseodensification/lopez-2017-osseodensification-spinal-surgical-hardware-fixation]] — 척추 hardware pullout·BIC (외삽 주의)
...
- [[implants/osteotomy-thermal/el-kholey-2019-drilling-technique-low-density-bone-sr]] — SR (15편): undersized·osteotome·Piezo·OD 모두 일차안정성↑이나 장기 생존 우월 근거 약함 (OD claim 한정)
- [[implants/osteotomy-thermal/tabassum-2021-undersized-axial-compression-primary-stability]] — animal: 측방(undersized)+축방향 압축 결합 IT·%BIC↑ (OD 대안 압축술식)
- [[implants/osteotomy-thermal/gehrke-2021-healing-chambers-macrogeometry-low-density-drilling]] — in-vitro: undersized는 PCF-20에서만 효과, 최저밀도 한계 + macrogeometry 보완
...
### 신규 ingest cluster (2026-07-17) — narrow-ridge spoke · 천장 · 형상축

- [[bone-regeneration/lopez-valverde-2025-bone-expansion-compaction-densification-narrow-crests-sr-ma]] — **narrow-ridge spoke를 채운 첫 전용 SR+MA** (10편/241명, PROSPERO): BE·BC·OD 합산 실험군이 BD SMD −0.71(I²=0%, 견고)·CE −1.12(I²≥75%, 민감도 분석 전엔 NS)·ISQ −8.88(I²=96%) — **OD vs BE head-to-head가 아님**; 전임상은 BIC 이득 없음, Rizk 2024 과잉 밀도화 실패 3건, 저자들은 GBR·split 뒤에 배치
- [[implants/coyac-2019-preclinical-model-links-osseo-densification-misfit]] — **과잉 OD의 천장** (쥐 상악 발치와, 초록 전용): 고미스핏 배정 → 골밀도화 → 미세골절 → 골세포 사멸 → 흡수 우세(TRAP·cathepsin K) → 신생골 부재(ALP·collagen I 음성) → 조기 실패. "excessive osseo-densification → osseo-destruction". **수치 없음 = 천장이 있다고만 말하고 어디인지 말하지 않음**; 쥐·발치와·미스핏≠버 OD로 전이 제한
