...
> - PTTN의 의인성(iatrogenic) 원인 순위 (Van der Cruyssen 2020, n=1,331): 사랑니 발치 48% > 임플란트 13% ≈ 비-사랑니 발치 13% > 국소마취 12% > 근관치료 (Endodontics) 8%. 근관치료는 저평가돼 온 비-무시 원인 (Alkhutari 2023).
> - PTTN 인구학적 특징: 근관치료 후 3–48개월에 발생, 40대 중반 여성 호발(PDAP의 65–85%), 비전형 치통 (Atypical Odontalgia, AO)·지속성 치조통 (Persistent Dentoalveolar Pain, PDAP)으로 오진 (Alkhutari 2023).
...
6. **The endodontic PTTN mechanism most relevant to operative dentists**: over-instrumentation/perforation communicating with the external root surface, resorption defects, root fracture, and — for mandibular molars — apices lying close to the inferior dental (alveolar) canal and/or mental foramen (Alkhutari 2023). Management for the pain itself: amitriptyline 50–75 mg/day and/or carbamazepine 400–600 mg/day + vitamin B complex (Alkhutari 2023).

7. **Altered sensation after posterior-mandibular implant surgery** has a wide reported incidence (0–55%), driven by study design (prospective series ~0.08–8.5%; retrospective questionnaires 36–55%), mainly affecting the IAN and mental nerve (lingual nerve rarely); most events are transient and resolve within 6 months (Baek 2010, narrative-review). Prevention relies on a safety zone ≥2 mm above the mandibular canal on panoramic and ≥1 mm on CT, with attention to the mental-nerve anterior loop; microneuroanastomosis is indicated when anesthesia persists >3 months or dysesthesia >4 months without improvement (Baek 2010). This work also documents medicolegal stakes (Korean cases: lawsuits and compensations).

8. **There is a documented dentist-awareness gap that drives the misdiagnosis.** Among 634 Italian dentists, 28.7% did not know PTTN exists and >80% were never taught about it, yet 71.7% had encountered a suspected case (Viscuso 2025, cross-sectional). The default response after root-canal-triggered pain was irreversible — retreatment 48.6%, extraction 22.4%, apicectomy 8.6% — with referral to a pain specialist by only ~1 in 3; unawareness of PTTN was statistically associated with failing on differential-diagnosis awareness, recognition, and referral (p<0.05) (Viscuso 2025).
...
1. **Recognize neuropathic pain by its pattern, not by the tooth.** Two red-flag phenotypes should stop the drill: (a) **paroxysmal, electric-shock, trigger-evoked** pain from light touch/chewing/tooth-brushing with pain-free intervals → suspect trigeminal neuralgia (Khan 2023); (b) **continuous, aching/burning/throbbing** unilateral pain persisting >3–4 months, often with allodynia/altered sensation, especially following a recent dental procedure → suspect PTTN (Alkhutari 2023). In both, the hallmark is **no local dental source on exam/imaging** proportional to the pain.

2. **Confirm before treating — use a non-destructive work-up.** Diagnostic local-anesthetic testing (an equivocal/partial response to a somatic nerve block points away from odontogenic pain), CBCT, and neuropathic-pain screens (VAS, S-LANSS, OHIP-14, QST) per Graff-Radford & Solberg criteria (Alkhutari 2023). Do not proceed to irreversible endodontics/extraction of a tooth without a demonstrable dental cause.

3. **Referral triggers.** For suspected TN: trial carbamazepine/oxcarbazepine and refer to neurology; consider MVD (classical/vascular-compression TN) (Khan 2023). For suspected PTTN: **stop irreversible dental treatment** and refer to an orofacial-pain/pain specialist — only PTTN-aware dentists referred in the survey, and referral occurred in only ~1 in 3 root-canal-pain cases (Viscuso 2025). The awareness gap is the referral gap.

4. **Iatrogenic-injury prevention — endodontics.** Highest risk in **mandibular molars whose apices lie near the inferior dental canal/mental foramen**; avoid over-instrumentation/perforation and sealer/material extrusion beyond the apex (Alkhutari 2023). Post-RCT non-odontogenic persistent pain (3.1–3.4%) is the warning sign — investigate as neuropathic, do not automatically retreat.
...
발작성 유발통이면 삼차신경통(→약물+신경과 의뢰), 시술 후 지속통이면 외상후 삼차신경병증(→비가역 치료 중단·통증전문의 의뢰) — 신경병성 통증을 치통과 감별해 죄 없는 치아를 지키는 것이 이 페이지의 핵심 임상 명제다.

## Clinical Quiz
<!-- quiz_spec -->

**Q1.** 근관치료 완료 3개월 후에도 해당 치아 부위 통증이 지속됩니다. 재근관치료나 치근단절제를 결정하기 전에 이 오버뷰에 근거해 무엇을 먼저 해야 합니까? *(근거: PTTN 의인성 원인 + 비가역 치료 중단 원칙)*

> **모범답안**: **비가역 치료를 멈추고 외상후 삼차신경병증(PTTN) 감별을 먼저 해야 한다.** 이 오버뷰에서 근관치료는 PTTN 의인성 원인의 **8%**를 차지한다(Alkhutari 2023, Van der Cruyssen 2020, n=1,331). PTTN의 특징: 시술 후 3개월 이상 지속되는 **연속적** 통증(발작성이 아님) + 이질통(allodynia) 동반 + 치성 원인이 영상에서 확인 안 됨. 이 오버뷰의 경보 원칙: 치성 원인이 확인 안 되는 지속통이면 비가역 치료 전에 ① 진단적 국소마취 검사 ② CBCT ③ 신경병증 선별검사 후 통증 전문의 의뢰. 이를 무시하고 재근관·치근단절제를 반복하는 패턴이 PTTN 경험 치과의사의 71.7%에서 관찰됐다(Viscuso 2025).

**Q2.** 환자가 양치질할 때와 씹을 때 한쪽 뺨과 치아 부위에 순간적으로 강한 전기 충격성 통증이 옵니다. 치통처럼 느껴지는 이 통증을 이 오버뷰에 근거해 어떻게 접근합니까? *(근거: TN 발작성 특성 + 치통과의 감별)*

> **모범답안**: 삼차신경통(TN)을 의심하고 치과 처치를 보류한 채 **신경과 의뢰**를 고려해야 한다. 이 오버뷰에서 TN의 특성: 안면·구강 유발점(trigger zone)을 **가벼운 접촉·저작·양치질**이 자극하면 **순간적인 전기충격성 발작통** — 치통과 혼동되기 쉽다(Khan 2023). 감별 핵심: TN은 발작성(paroxysmal)·순간적·유발자극 필수이고, 치통은 지속적이거나 온도자극·압력자극에 지속 반응한다. 이 오버뷰의 임상 결론: "유발점·발작성이면 TN → 약물(카르바마제핀 0.4–1.2g/day 1차) + 신경과/통증전문의 의뢰." 치아에 처치를 먼저 하면 "죄 없는 치아"에 불필요한 시술이 가해질 위험이 있다.

**Q3.** 하악 구치부에 임플란트 식립 후 환자가 입술과 턱 부위 감각이 이상하다고 합니다. 이 증상이 언제까지 지속되면 비정상이고, 예방 원칙은 무엇입니까? *(근거: Baek 2010 안전대 + 0–55% 이환율)*

> **모범답안**: **대부분 6개월 내 자연회복**이 기대된다(Baek 2010, narrative-review). 이 오버뷰에서 하악 구치부 임플란트 후 하치조신경(IAN)·이신경 감각이상 이환율은 0–55%로 연구마다 차이가 크고(후향 설문이 과대추정), 6개월이 지나도 지속되면 신경 손상 가능성을 평가해야 한다. **예방 원칙**: 파노라마 기준 하악관 위 안전대 **≥2 mm**, CT 기준 **≥1 mm**를 확보한다(Baek 2010). 예방 가능한 위험 요인: ① 하악관 근접 식립 ② 근관 과충전(sealer extrusion) ③ 과계측(over-instrumentation). 6개월 이상 지속 감각이상은 통증 전문의·구강악안면외과 의뢰를 고려한다.
