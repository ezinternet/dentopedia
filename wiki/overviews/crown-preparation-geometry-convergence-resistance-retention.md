...
**권장 TOC의 역사적 이동 [확인]** — Tiu 2015 SR (J Prosthet Dent 2015;113(3):175, 1006→23편)에 따르면 권장 TOC는 1960년대 교과서의 2-5°에서 현재 10-22°까지 약 4-decade에 걸쳐 이동했다. 핵심 원인은 임상에서 2-5°가 도달 불가능하기 때문 — 자체 결과에서도 in-mouth가 out-of-mouth보다 일관되게 높았다.
...
**Synthesis [미검증]** — preclinical(통제 환경) ↔ clinical(실제 진료) gap이 1.5-2× 정도 존재한다. Abdulla의 Dubai 데이터는 all-ceramic bonded crown에 한정된 점을 감안해야 한다 — 접착 결합이 retention을 보완하므로 임상의가 TOC를 의식적으로 낮출 동기가 약해진다.

한국 임상 데이터는 본 9편에 직접 포함되지 않았으나, 학생→개원의 변화 trajectory를 따른다고 가정하면 한국 개원의 평균 TOC도 20-30° 범위일 가능성이 높다. [미검증]

## Cluster 2 — 치아별 TOC 민감도

**Vinnakota 2015 [확인 for in-vitro]** — 12° vs 20° TOC에서 retention force:
...
**Yang 2015 [확인 — Roudsari의 빈틈을 채움]** — 같은 조건(20° TOC, 2.5 mm 높이 짧은 대구치)에서 보조형 효과를 retention + marginal float 둘 다 측정:
...
- **핫애시드 etching 효과**: 유지력 유의 향상 (p=0.001) [확인]
...
**Synthesis [미검증] — 클러스터 1·3과의 정확한 정렬**
...
**Synthesis [미검증] — 디지털 시대 재구성 (핵심 발견)**
