...
> [!summary] 한국어 핵심요약
> - 핵심 명제: 콘빔CT(Cone-Beam Computed Tomography, CBCT)는 진단 이득과 방사선 부담의 균형 문제이며, 적응증별 촬영범위(Field of View, FOV)·복셀 크기 선택이 선량과 화질을 동시에 결정하는 핵심 레버다.
> - 외흡수(External Root Resorption, ERR) 진단(Baena 2022, SR+MA 17편): 민감도 78.1%·특이도 79.3% — 신뢰할 만하나 초기·소형 병소에서 약 22% 위음성.
> - 근관치료 계획(Tay 2022, SR 16편): CBCT가 치료계획을 24–56%에서 변경 — 주로 추가 처치 처방 방향. 재치료·수직치근파절·복잡 해부 같은 고난도에서 이득 최대 → 모든 증례 routine 아님.
> - 근관치료 결과 평가(Brochado-Martins 2025, SR+MA 19편): 치유율 loose 기준 87% vs strict 기준 36% — strict 기준이 실패를 과대계상. routine follow-up은 치근단 방사선으로 충분, CBCT 불필요.
> - 임플란트(Jacobs 2018): 술전 진단·계획·술중 가이드 이관에 정당, 유효선량은 같은 적응증에서도 파노라마의 약 2–200배(기기·프로토콜 의존).
> - Fontenele 2025(87 기기, 34 제조사, 11개국): 적응증별 FOV·복셀 권장 — 근관은 소FOV·0.076–0.2mm, 임플란트/보철은 대FOV·0.2–0.4mm. 기기·프로토콜이 해부적 적응증만큼 실제 선량을 좌우.
> - 안구 수정체 산란선량(Khafaji 2023): 단일 촬영 0.103–8.3 mSv로 혼탁 역치(약 0.5 Gy 누적) 미만이나 직업적·반복 노출은 주의.
> - 신흥 대안: 0.55T 저자장 MRI(Willershausen 2025, 소아 16명)가 치아축·치근형태·외흡수·낭종에서 초저선량 CT와 동등(피질골·석회화는 미달) — 방사선 우려 큰 소아에 잠재적.
