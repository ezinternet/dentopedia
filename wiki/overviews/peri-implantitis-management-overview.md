...
Peri-implant diagnosis
    ↓
BoP only, no bone loss → Mucositis
    → PMPR (gold standard)
    → Adjunctives: optional, minimal added benefit
    → SPT maintenance ← primary prevention message
    ↓
BoP + bone loss → Peri-implantitis
    ↓
Non-surgical phase first (PMPR + adjunctive antiseptics)
