---
title: "Overview: Patient Complaint Management — Classification → Expectation → Response → Education"
type: synthesis
category: overviews
date: 2026-06-12
...
| Paper | Stage | Design | n | Key finding | Confidence |
|---|---|---|---|---|---|
| Reader 2014 | Classify | Systematic review | 59 studies / 88,069 complaints | 3 domains — clinical 33.7%, management 35.1%, relationship 29.1% | sr |
| Gillespie 2016 (HCAT) | Classify | Instrument development | UK samples to n=839 | 7 categories × 4 severity; 1.94 problems/letter | cross-sectional |
| Bogh 2019 | Classify | Reliability | 140 claims | HCAT transfers to Denmark; high inter-rater; skewed coverage | cross-sectional |
| Van Dael 2022 (JHSRP) | Classify | Retrospective linkage | 446 overlaps / 5 yr | complaints show greater harm in 60%; 582 events staff missed | retrospective |
| Friele 2006 | Expect | Survey | 424 | recurrence-prevention first; explanation(65%)>apology(41%); money 7% | cross-sectional |
| Friele 2015 | Expect | Paired survey | 3,366 + 1,422 | large public–physician expectation gap | cross-sectional |
| Skar 2018 | Expect | Qualitative | complaint corpus | poor info, not listened to, disrespect dominate | cross-sectional |
| McCreaddie 2021 | Respond | Discourse analysis | 59 responses | "fauxpology"; subjectivising; exceptionality | cross-sectional |
| Gillespie 2025 | Respond | Mixed methods | online responses | 6 defensive tactics from contradictory demands | cross-sectional |
| Washington 2020 | Respond | Mixed methods | frontline mgrs | recovery needs measurement+feedback+training | cross-sectional |
| Li 2024 | Respond | Observational pre/post | grassroots hospitals | system → ↑satisfaction, ↓complaints | retrospective |
| Zheng 2025 | Respond | Case study + NLP | 1 tertiary centre | emotional-language model targets improvement | cross-sectional |
| Van Dael 2022 (JRSM) | Respond | Case study | 20 staff | national policy undermines learning (4 failure modes) | cross-sectional |
| Elias 2025 (CODE) | Educate | Program description | 1 program | dual-track: operational + interpersonal | narrative-review |
| Thomas 2018 | Dental | Retrospective cohort | 6 yr national AU | dentists highest rate 42.7/1000/yr; 4% → 49% of complaints | retrospective |
| Vadde 2024 | Dental | Retrospective | 56 court cases | negligent injuries dominate; document + indemnify | retrospective |
| Alrahabi 2019 | Dental | Narrative review | — | endodontics = most malpractice claims; error catalogue | narrative-review |
| Kwon 2017 | Litigation | Retrospective (KR courts) | 287 cases | only 26.5% of covenant-not-to-sue settlements held; content > signing; free reop not credited | retrospective |
| Park 2016 | Litigation | Retrospective (KR courts) | 40 cases | 85% plaintiff-won SSI claims; liability = no culture/referral/control + missing preop consent | retrospective |
| Taniguchi 2023 | Litigation | Descriptive (JP, national) | 13,340 claims | 52.9% settled; 35.3% judged, 75.8% physician-favored; declining trend | cross-sectional |

## Clinical Decision Points

For a dental practice translating this evidence into operating procedure:

1. **Log, don't just resolve.** Adopt a lightweight HCAT-style classification (problem category × severity × stage of care) so complaint patterns become visible. A handful of recurring categories will dominate, and a small number of clinicians may drive most complaints (Thomas 2018) — both only show up if complaints are coded, not filed as free text.

2. **Lead the response with explanation + recurrence prevention, not apology theatre.** Friele 2006 is explicit: complainants rank an impartial process, a real explanation, and a change that prevents recurrence above an apology, and very few want money. Open with what happened and what will change.

3. **Pre-empt the expectation gap.** Friele 2015 shows the public expects to be handled badly. Name this directly early ("I want this to be useful, not defensive") to disconfirm the negative prior before it becomes self-fulfilling.

4. **Audit your own wording against the defensive catalogue.** McCreaddie 2021 and Gillespie 2025 give a concrete blocklist: the "fauxpology" ("I'm sorry you feel…"), recasting the complaint as the patient's subjective impression, "one-off exception" mitigation, redirecting/closing the episode. Treat these as red-flag phrases in any written reply.

5. **Fix the system, not just the sentence.** Defensiveness is structural (Gillespie 2025; Van Dael 2022 JRSM). Give whoever handles complaints clear authority, time, and a non-punitive route — otherwise they will default to self-protection regardless of training.

6. **Train both tracks (CODE).** Elias 2025: pair operational/procedural training (what resources/remedies exist) with interpersonal/de-escalation training. One without the other reproduces either bureaucratic or relational failure.

7. **Know the litigation tail.** Treatment/procedure complaints dominate in dentistry (Thomas 2018), endodontics carries the highest malpractice exposure (Alrahabi 2019), and unresolved cases escalate to courts where documentation and indemnity decide outcomes (Vadde 2024). Rubber dam, accurate records, and standard-of-care adherence are simultaneously clinical safety and medico-legal defence.
