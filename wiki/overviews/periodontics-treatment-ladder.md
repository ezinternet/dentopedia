...
tags: [periodontics, classification, non-surgical, regeneration, spt, peri-implantitis, decision-ladder, overview]
---

## 한줄요약

치주치료 4축 — 2017 새 분류 (Staging I-IV × Grading A-C) · 비외과 치료 (SRP ± 보조) · 외과·재생 (GTR/EMD) · SPT (유지치료). EFP S3 guideline + Cochrane SR + KDA 합의안 spine.

## Summary

본 페이지는 wiki/periodontics/ 20 paper의 4-axis spine. 2017 World Workshop classification → step-wise treatment → SPT 의 표준 흐름을 따른다.
...
### 축 4 — SPT (Supportive Periodontal Therapy)
...
### 축 5 — Peri-implantitis (Korean Academy Consensus)
...
- [ ] `wiki/overviews/periodontal-regeneration-techniques.md` — GTR · EMD · 골이식재 head-to-head NMA 분석.
...
- 축 4 SPT cadence = [합의수준] (Cochrane RCT 부족, 코호트 위주).
- 축 5 peri-implantitis = [근거강함] epidemiology, [합의수준] 치료.
