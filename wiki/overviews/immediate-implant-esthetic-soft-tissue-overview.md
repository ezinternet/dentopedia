...
> - **CTG는 두께가 얇을 때 우선**: 네트워크 메타분석에서 STT(연조직두께)를 유의하게 늘린 것은 CTG뿐이나 대부분 재료간 차이는 비유의; 단층 이종 콜라겐 매트릭스가 PES 순위 1위 — 얇은 케이스만 CTG, 그 외엔 대체재로 충분 (Azadi 2025).
