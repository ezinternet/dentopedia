...
핵심 명제 6개:
1. **상악 심미부 단일 즉시식립+즉시부하 (T1A IIPP)는 5y 생존 97.1%, 1y MBL −0.32 mm, PES 7.2 — 적절한 환자 선택 시 안전** — Hamilton 2023 ITI consensus SR+MA (68편), Wittneben 2023 SR. [근거강함]
2. **협측골 결손 ≥5 mm 있는 전치부 발치와도 IIP + GBR + 지연 provisionalization으로 ARP 후 지연식립과 10y outcome 동등** — Meijer 2024 RCT 10y. [근거강함] (단 술자 숙련도 + GBR 정밀 + 환자 협조 prerequisite)
3. **Jumping gap ≥ 2 mm는 grafting 권고 — 협측 골 흡수 유의 감소** — Seyssens 2022 SR+MA (15 RCT n=577), Sanz 2017 RCT, Paknejad 2017 RCT. [근거강함]
4. **협측에서 ≥2 mm palatal positioning이 buccal crest 두께·높이 보존의 결정인자** — Staas 2026 prospective CBCT 3y. [합의수준]
5. **CTG (Connective Tissue Graft) 추가 시 midfacial recession 유의 감소. CTG가 단층 collagen matrix 대비 우월** — Seyssens 2021 SR+MA, Azadi 2025 Bayesian NMA (21 RCT). [근거강함]
6. **구치부 IIP 생존율 ≥97%, 지연식립과 동등. inter-radicular septum 활용 + primary stability가 결정 변수** — Ragucci 2020 SR+MA, Botros 2025 RCT (6w vs 3mo 부하 동등). [근거강함]
...
**오판 패턴**: "협측 plate 얇으면 Type 1 절대 금기" — Qian 2023 prospective + Meijer 2024 10y RCT가 risk-managed Type 1 가능성 보여줌. 단 술자 숙련·정밀 GBR·환자 협조 모두 충족 시. [근거강함]
...
**1차 권고**: 심미부 IIP에는 CTG 추가가 표준. Immediate provisional은 papilla 보존에 유리. Socket shield (SST) 는 합병증 9.5% — 숙련자에게 한정. [근거강함]
...
5. **Socket Shield 적응** — 숙련자에게만. 협측 plate 보존이 critical + 다른 옵션 적용 어려운 case. 합병증 9-17% 사전 동의. [근거강함]

**오판 패턴**: "Immediate provisional이 핑크 심미에 더 좋다" — Pitman 2022는 생존율 동등, 연조직 안정성 우위 정도. 모든 환자에 강제 적응 아님. 1차 안정성 + 환자 협조 prerequisite. [근거강함]

### 축 5 — Loading Protocol (Immediate vs Early vs Conventional)

**1차 권고**: 상악 심미부 single-tooth IIP — 1차 안정성 ≥35 Ncm 충족 시 immediate provisional 가능. 구치부 IIP는 6주 조기부하 가능. Esposito 2015 RCT가 conventional loading과 동등 보임. [근거강함]
...
**오판 패턴**: "Immediate loading은 위험" — Esposito 2015·Hamilton 2023이 적절한 환자 선택 시 동등 outcome 입증. 1차 안정성이 결정인자, timing 자체가 아님. [근거강함]
...
확신도 등급 글로벌:
- 축 1 timing classification = [근거강함] (Hamilton 2023 ITI + Chen 2014 + Qian 2024 NMA).
- 축 2 site selection = [근거강함] (Meijer 2024 10y RCT 중심).
- 축 3 surgical execution = [근거강함] (다수 SR+MA).
- 축 4 soft tissue augmentation = [근거강함] CTG · provisional, [합의수준]+합병증 인지 SST.
- 축 5 loading = [근거강함] (Esposito 2015 · Hamilton 2023).
