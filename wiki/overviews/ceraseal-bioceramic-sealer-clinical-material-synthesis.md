...
2. **Irrigation** — The dentin–sealer interface and antimicrobial seal are partly earned at the irrigation step: **HEDP continuous chelation** preserves dentin and the mineralizing interface better than sequential NaOCl→EDTA (Surana-Bhandari 2026), and all sealers lose antimicrobial potency after contacting irrigated dentin — so disinfection must be achieved *before* obturation, not relied upon from the sealer.
