...
- [[endodontics/fahmy-2026-polydopamine-gutta-percha-bioceramic-sealer]] — in-vitro (n=14): polydopamine (PDA) coating on gutta-percha reduces apical dye penetration (3.04 vs 4.30mm), eliminates ESEM interfacial gaps in SBF, and nearly triples wettability vs uncoated — a gutta-percha-side interface fix complementary to irrigation-side (HEDP) and activation-side (UA) optimizations.
