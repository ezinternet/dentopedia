---
title: "Implants (general) — Risk·Survival·Peri-implantitis Decision Ladder"
...
## 축 1 — 환자 위험 stratification

### 1-A. Smoking·Periodontitis·DM 3대 위험
...
| Spine paper | Evidence | Key finding |
|---|---|---|
| [[implants/raghavan-2025-bone-density-implant-dentistry-review]] | narrative-review | 골밀도 측정·HU·임플란트 success 통합 |
| [[implants/cicciu-2023-buccal-palatal-bone-thickness-marginal]] | retrospective | 협측·구개측 BBT가 MBL의 강한 predictor |
...
환자 평가
   │
   ▼
1. 흡연 status — 흡연 중 → 중단 권고 + 6주 wash-out 권장 (필수 아니나 risk 명시)
2. 치주염력 — 안정화 stage 확인 ([[periodontics-treatment-ladder]])
3. DM — HbA1c <7.0% 시 정상 동등; 7–9% 강화 SPT; >9% 연기
4. 항흡수제·MRONJ 위험 — [[drug-mronj-antiresorptive-overview]]
5. 골밀도 — CBCT HU·CBCT 협측 두께(BBT) ≥1mm
   │
   ▼
Risk Tier 결정
   • Low: 비흡연, HbA1c<7, BBT≥1mm, Type I–III → 표준 protocol
   • Moderate: ≥1개 위험 → 표준 + 강화 SPT + 술전 amox 2g (적응 case)
   • High: 흡연+치주염+불량 위생 → 연기 권고, 동의 시 책임 명시
   • Type IV 상악 구치부 → OD + bicortical 또는 short implant
```

---

## 축 2 — 임플란트 디자인 (Length · Connection · Position)

### 2-A. Short implants — 단·중·장기 outcomes
...
잔존골 평가 + 부위
   │
   ▼
잔존골 ≥10mm + Type I–III → 표준 길이 + PS + Morse taper/internal hex
잔존골 5–8mm 후방 위축 → Short ≤8mm (5y·8y RCT confirm)
                       → augmentation 회피 우선
상악 후방 SFE 동반 → Short 4–8mm + transcrestal SFE 대안 ([[overviews/sinus-lift-technique-selection]])
저밀도 Type IV → OD + bicortical + tapered ([[overviews/osseodensification-clinical-applications]])
심미부위 thin biotype → PS 필수 + CTG ([[overviews/peri-implant-soft-tissue-dehiscence-prevention]])
다중 임플란트 (All-on-X·trefoil) → FEA·교합 분석 (Baki 2025, Stilwell 2024)
```
...
```
□ Drill 누적 사용횟수 추적 (Sorgato 2025) — 제조사 권고 회수 초과 시 교체
□ Guided drilling 시 sleeve가 irrigation 방해 — 추가 external irrigation (Saxena 2024)
□ Hard cortical bone (Type I·II 전방 하악) — drill speed 800–1200 rpm + abundant irrigation
□ Type IV bone (상악 후방) — OD or under-preparation으로 thermal stress 우회
□ Sequential drill skip 금지 — 한 단계 건너 뛰면 thermal spike (Rugova 2024)
□ Piezo는 통증·heat 저감 옵션 — 시간 증가 trade-off (Jain 2024)
```

---

## 축 4 — 연조직 (Peri-implant Soft Tissue)
...
### 임상 ladder (soft tissue)

```
KT ≥2mm 유지 → 표준
KT <2mm → FGG 또는 CTG 추가 — plaque·BoP·MBL 보존
심미부위 + thin biotype → CTG 표준
peri-implant STD 발생 → Tavelli 2025 prevalence·apical shift 추적, 외과 회복·보철 변경
```

---

## 축 5 — Peri-implantitis 예방·진단·치료

### 5-A. Epidemiology·예방 — spine
...
```
1. Primordial 예방 (식립 전) — 흡연 중단, 치주염 안정화, HbA1c 조절, 위생 교육
2. Primary 예방 (식립 후) — SPT 3mo, KT≥2mm, 위생, 흡연 중단 유지
3. Mucositis (BoP+, bone loss 없음)
   → 비외과 (mechanical debridement + CHX 0.12% rinse 2w) → 4–6w 재평가
4. Peri-implantitis (BoP+, bone loss ≥2mm)
   → 비외과 1st (Grusovin 2022 — adjunct 항생제 PPD 0.6–1.15mm 추가) → 4–6w 재평가
   → 미해소 시 외과
5. 외과 — Resective (debridement + implantoplasty) 또는 Regenerative
   → Vrazic 2026 Mg membrane 신규 옵션 (단일 clinical, [미검증])
   → defect type 의존, [[bone-regeneration-protocol-ladder]] 참조
6. Refractory 또는 광범위 골소실 → 발거 + Shenoy 2025 retrieval 기법, 재식립 case-by-case
```
...
자세한 보철 재료·screw vs cement는 [[overviews/prosthetic-materials-decision-ladder]]. 본 페이지는 implant survival·biology만.

ISQ 기반 loading 결정은 [[overviews/isq-loading-threshold]] · [[overviews/implants-isq-stability-ladder]].

---

## Phase 2 확장 후보 (Stub)

- [ ] `wiki/overviews/peri-implantitis-treatment-protocol.md` — 비외과·외과·재생 처치 깊이 (현 5-C 확장)
- [ ] `wiki/overviews/implant-bone-type-protocol.md` — Type I–IV별 drilling·디자인 (1-B + 3 확장)
- [ ] `wiki/overviews/smoking-implant-protocol.md` — 흡연 환자 case management + 동의서 + SPT
- [ ] `wiki/overviews/drill-thermal-protocol.md` — 3축 단독 페이지 후보
- [ ] `wiki/overviews/short-implant-long-term-outcomes.md` — 5–8y RCT·real-world
...
- [[implants/james-2025-future-dental-implants-trends-technologies]]
- [[implants/padhye-2020-quantitative-edentulous-posterior-maxilla]]

### Surface treatment (sub-category implants/surface)
- [[implants/surface/abraham-2014-historical-perspective-dental-implant-surfaces-treatments]]
...
- [[implants/surface/ko-2024-hydroxyapatite-nano-coated-sla-immediate-implants]]
...
- [[implants/surface/witek-2019-osseodensification-trabecular-tantalum-implants-sheep]]
...
- [[implants/isq/kastel-2019-smartpeg-torque-isq-rfa]]
- [[implants/isq/bhandarkar-2023-rfa-mathematical-modeling-implant-stability]]

### Related overviews

- [[overviews/immediate-implant-decision-ladder]] — IIP 결정
- [[overviews/osseodensification-clinical-applications]] — OD 술식 적용
- [[overviews/implants-isq-stability-ladder]] — ISQ 깊이
- [[overviews/implant-surface-comparison]] — 표면처리 깊이
- [[overviews/peri-implant-soft-tissue-dehiscence-prevention]] — STD 깊이
- [[overviews/bone-regeneration-protocol-ladder]] — GBR + ARP
- [[overviews/sinus-lift-technique-selection]] — sinus elevation
- [[overviews/periodontics-treatment-ladder]] — peri-implantitis 인접
- [[overviews/drug-clinical-decision-ladder]] — 항생제·MRONJ·DM 인접
