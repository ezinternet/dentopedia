...
본 페이지는 wiki/oral-microbiology/ 15편을 caries·periodontitis 두 질환을 관통하는 단일 framework로 통합한다. 두 질환 모두 commensal community → dysbiotic community 전이로 설명되며, caries는 대사(산 생성·EPS), periodontitis는 면역교란(complement·inflammation)이 feedforward 축이다.
