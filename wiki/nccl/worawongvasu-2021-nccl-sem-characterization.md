...
## Key Contributions
- Provides rare direct ultrastructural (SEM) evidence compatible with abfraction microfractures (4/10).
- Documents coexisting abrasion and erosion signatures in the same lesion set.
- Reinforces multifactorial NCCL etiology at the ultrastructural level.

## Methodology
Ten extracted premolars fixed in 10% formalin, mesiodistally sectioned, immersed in 5.25% NaOCl, graded-ethanol dehydrated, gold sputter-coated, imaged on a JEOL JSM-6480 LV SEM at x40-x20,000. Descriptive analysis; no quantitative fracture metrics; single operator.

## Results
4/10 teeth with fracture lines/surfaces (abfraction-compatible). 6/10 with linear scratches plus dentinal tubule openings or exposed collagen fibers. Fractured enamel showed hydroxyapatite crystallites at rod ends; lesion floors covered by poorly fixed collagen network.
...
- [[nccl/stanusi-2023-nccl-stereomicroscopic-aspects]] — reinforces (independent microscopy linking wedge morphology to occlusal/brushing factors)
- [[nccl/grippo-2012-abfraction-abrasion-biocorrosion-nccl-20year]] — applies-to (provides empirical instance of the multifactorial schema)
