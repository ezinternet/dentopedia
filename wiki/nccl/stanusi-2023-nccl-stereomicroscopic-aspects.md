...
## Key Contributions
- First documented stereomicroscopic protocol for NCCL morphology and early-lesion diagnosis.
- Morphology-etiology correlation: wedge → occlusal stress + brushing; saucer → smooth biocorrosive/abrasive wear.
- Depth-distribution data reinforcing the value of early detection.

## Methodology
Ex vivo descriptive study; 27 NCCL teeth fixed in silicone and imaged on a NIKON SMZ 745T stereomicroscope at 10.05x-75x; depths measured digitally (NIS-A-AMEAS). Continuation of an earlier OCT study; ethics-approved.

## Results
Shape: 16 wedge (59%), 10 saucer (37%), 1 mixed (4%). Depth: 67% <500 µm, 11% 500-1000 µm, 7% 1000-1500 µm, 15% >1500 µm. Arch distribution: 40.7% maxillary, 59.3% mandibular. Cited global prevalence ~46.7%, rising with age.

## Related Papers
- [[nccl/goodacre-2022-nccl-morphology-etiology-restoration-guidelines]] — reinforces (imaging support for saucer/wedge morphology framework)
- [[nccl/worawongvasu-2021-nccl-sem-characterization]] — reinforces (parallel microscopy linking morphology to multifactorial etiology)
