---
title: "Abfraction Theory: Controversy Analysis, Scoping Review"
...
tags: [nccl, abfraction, occlusal-load, scoping-review, prisma-scr, controversy]
relations:
  - type: refines
...
## Key Contributions
- Registered, PRISMA-ScR scoping review with formal ROBINS-I bias appraisal.
- Demonstrates how little direct evidence (6 studies) actually addresses occlusal-load causation of abfraction.
- Reframes the Duangthip 2017 "81% association" as methodologically inflated.
- Specifies the study design (prospective longitudinal, lesion-subgroup-isolated) needed to resolve the question.

## Methodology
PRISMA-ScR scoping review; PubMed + Scopus; keywords "abfraction" AND "NCCL"; 1449 identified → 6 included; ROBINS-I risk of bias; protocol registered on INPLASY.

## Results
6 included studies; insufficient evidence to confirm or refute occlusal-load aetiology of abfraction. NCCL prevalence framed at ~10-40% of adults over 30, premolars predominant. Calls for prospective longitudinal designs.
...
- [[nccl/dioguardi-2023-nccl-etiopathological-mechanisms-review]] — extends (same group's prior theory review)
- [[nccl/nascimento-2016-abfraction-etiology-diagnosis-treatment]] — reinforces ("abfraction unproven")
- [[nccl/senna-2012-nccl-occlusion-systematic-review]] — reinforces (clinical evidence inconclusive)
