...
## Key Contributions
- Consensus case definitions for occlusal trauma terms (2017 World Workshop).
- Synthesizes periodontal effects: periodontitis, abfraction, recession.
- Distinguishes primary vs secondary occlusal trauma and diagnostic signs.

## Methodology
Narrative review commissioned for the 2017 World Workshop, synthesizing human and animal evidence into consensus case definitions and diagnostic considerations.

## Results
Role of occlusal trauma in periodontitis initiation/progression: controversial. Primary occlusal trauma does not cause irreversible attachment loss. No conclusive evidence it causes recession or abfraction. Diagnosis relies on a constellation of signs (mobility, PDL widening, fremitus), not one test.

## Clinical Application
- "Occlusal trauma causes periodontitis" is not supported — do not justify aggressive occlusal adjustment on that basis in a healthy periodontium.
- In a periodontitis-reduced periodontium (secondary occlusal trauma), occlusal force interacts with disease; manage as an adjunct, not a cure.

## Related Papers
- [[occlusion/dommisch-2022-efficacy-of-tooth-splinting-occlusal]] — extends: tests whether splinting/occlusal adjustment actually changes outcomes.
- [[occlusion/leone-2026-occlusal-overload-and-periodontitis-integrating]] — extends: mechanistic/biomarker update on the same controversy.
- [[radiology/mortazavi-2016-lesions-associated-with-periodontal-ligament]] — applies-to: PDL widening as a radiographic sign in the differential.
