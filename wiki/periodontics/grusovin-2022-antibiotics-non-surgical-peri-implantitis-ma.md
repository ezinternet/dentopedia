...
## Key Contributions
Quantifies that local antibiotics yield broader success-rate gains than systemic, but neither route achieves high disease resolution alone — informs case selection and step-up logic.

## Methodology
SR of RCTs comparing antibiotic adjunct (local or systemic) vs non-surgical debridement alone in peri-implantitis. Outcomes: success rate, MBL, PPD, PAL, BOP, peri-implantitis resolution.

## Results
Local antibiotics: PPD -0.6 mm (CI 0.42–0.78), BOP -0.15 (CI 0.10–0.19), success RR 9.89 (CI 2.39–40.84). Systemic antibiotics: PPD -1.15 mm (CI 0.31–1.99), PAL -1.10 mm (CI 0.13–2.08); no significant bone-level or success change. Resolution ~20–30% with local adjunct.
