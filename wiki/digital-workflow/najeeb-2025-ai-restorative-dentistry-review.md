...
## Key Contributions
- **Restorative-domain focus**: caries detection, endodontics, dental restorations, tooth surface loss, shade determination, regenerative dentistry
- **Concrete accuracy benchmark**: up to 95% in caries detection
- **Integration roadmap**: AI + 3D printing for personalized restorations as priority research direction

## Methodology
- PRISMA flow (identification, screening, eligibility, inclusion) documented
- English-language; 2020 – January 2025
- 63 peer-reviewed studies
- Focus: accuracy metrics and clinical relevance
- Not formally a meta-analysis (no pooled effect estimates)

## Results
**Domain-by-domain findings**:
- **Caries detection**: up to 95% accuracy reported
- **Treatment planning**: efficiency gains, reduced chair time
- **Predictive analytics**: personalized treatment promise demonstrated
...
- Korean PIPA 추론 정보 처리 조항 적용 시 AI 진단 결과를 진료기록부에 포함할 의무 — pending KDA 가이드

## Related Papers
- [[digital-workflow/gao-2025-ai-dentistry-narrative-review]] — multi-specialty 2025 overview
- [[digital-workflow/lee-2025-ai-dentistry-emerging-applications-narrative]] — broader 3-pillar framework
- [[digital-workflow/mallineni-2024-ai-dentistry-descriptive-review]] — multi-discipline descriptive review
