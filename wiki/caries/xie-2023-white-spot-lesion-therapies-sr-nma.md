...
## Key Contributions
- NMA 방법으로 multiple treatments 직접·간접 증거 통합
- Resin infiltration > bleaching > CPP-ACP > fluoride varnish (optical improvement SUCRA 순)
- 재광화제(fluoride, CPP-ACP)는 광학적 개선보다 우식 진행 억제에 강점

## Methodology
NMA; SUCRA ranking; RCT only; visual/DIAGNOdent optical improvement outcome

## Results
- Resin infiltration: SUCRA 최고위 (optical improvement)
- 불소/CPP-ACP: 우식 진행 억제에는 효과, 외관 개선은 RI 대비 열위
- 이질성 존재 (재료·평가도구 차이)

## Related Papers
- [[caries/bourouni-2021-resin-infiltration-white-spot-sr-ma]] — RI SR+MA
- [[caries/malcangi-2023-enamel-remineralization-techniques-sr]] — 재광화 기술 SR
