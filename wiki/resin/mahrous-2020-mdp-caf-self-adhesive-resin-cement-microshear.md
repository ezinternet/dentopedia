---
title: "Micro-Shear Bond Strength of Novel MDP Calcium-Fluoride–Releasing Self-Adhesive Resin Cement After Thermocycling"
authors: "Aliaa Mahrous, Mohamed M. Radwan, Samah Mohamed Kamel"
year: 2020
date: 2020-04-09
...
tags: [self-adhesive-resin-cement, 10-mdp, calcium-fluoride, theracem, zirconia, thermocycling, in-vitro]
relations:
  - type: applies-to
...
## Key Contributions
- Quantifies the bond-strength benefit of 10-MDP in a self-adhesive cement across three substrates after aging.
- Underpins TheraCem's zirconia-bonding reputation.

## Methodology
In-vitro micro-shear bond strength to enamel, dentin, and zirconia; 5,000 thermocycles; TheraCem vs RelyX Unicem.

## Results
TheraCem > RelyX Unicem on all substrates: enamel 6.46 vs 3.04 MPa (p=.002); dentin 10.67 vs 6.46 (p=.014); zirconia 39.76 vs 27.04 (p<.001).

## Related Papers
- [[resin/theracem-bisco-product-reference]] — TheraCem product page (this is a key source)
- [[resin/muller-2022-resin-cements-zirconia-bulk-ageing]] — zirconia bonding of resin cements
