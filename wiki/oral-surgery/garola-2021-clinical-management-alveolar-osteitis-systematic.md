...
tags: [dry-socket, alveolar-osteitis, treatment, pain-control, alveogyl, prf, low-level-laser, neocones]
relations:
  - type: extends
    target: daly-2022-local-interventions-management-alveolar-osteitis
  - type: reinforces
    target: rosa-2024-laser-therapy-dry-socket-sr
  - type: reinforces
...
- 건성 발치와 **치료(통증조절)** 전용 SR — 예방 중심 리뷰를 보완.
- 임상적으로 해석 가능한 명시적 성공 기준(2일째 VAS ≤4 / 7일째 ≥85% 무통) 제안.
- "기본(세척) vs 특정(약제·레이저·PRF)" 2층 분류로 chairside 선택틀 제공.

## Methodology

- PubMed·Scopus·Cochrane·OpenGrey·Google Scholar 구조화 검색(2010.1–2020.7), PRISMA.
- 포함: VAS(0–10) 통증조절 또는 무통 환자% 보고한 영어/스페인어 원저 임상시험.
- 17편 포함, 39개 치료 분석(RCT+비RCT); 대상 다수가 하악 구치/사랑니.

## Results

- **39개 치료 중 53.8%**가 통증조절 기준 충족.
- 성공군: **기본** = 발치와 내 세척; **특정** = Alveogyl®·Neocones®·SaliCept Patch®·저출력 레이저·PRF.
- 대표 신호(이질적, 미통합):
  - PRF: 세척 단독 대비 술후 통증 감소(Kamal 2020, Yüce 2019); 단 King 2018은 Alveogyl과 차이 없음.
  - Alveogyl vs ZOE: 혼재 — Supe 2018 Alveogyl 우세, Chaurasia 2017 ZOE 우세.
  - 저출력 레이저(diode/Er,Cr:YSGG): Rani 2015 레이저>Alveogyl(diode 최상); Eshghpour 2015 Alvogyl 초기 우세·적색 레이저 후기 우세.
  - 히알루론산+아미노카프로산(소파술 후) > Alveogyl(Dubovina 2016); Neocones > Alveogyl/ZOE 시간경과 통증(Faizel 2014).
