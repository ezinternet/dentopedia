...
A single entry-point runs all 24 audits and writes their logs to `logs/`:
...
## The 24 audits — 4 hard guards + 1 rationale (errors block) + 19 signals
