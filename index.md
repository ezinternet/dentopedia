...
- [[overviews/treatment-planning-decision-variability-overview]] — **NEW Overview** (6편+SDM 2편, 2026-07-18): 치료계획 편차 종합 — **이 위키의 182개 결정 사다리가 전부 전제하는 것("술자는 근거대로 결정한다")을 되묻는 메타 페이지**. 테제: 치아의 운명은 치아보다 **술자**로 더 잘 예측된다 — 근관치료 후 근단주위염 표준 방사선사진에서 일반의 발치 17.03% vs 근관전문의 5.3%(OR 4.37, p<0.001), 인용된 별도 데이터셋도 5.63 vs 14.69%로 **약 3배 격차 독립 재현**. 중등도 병소 **OR 7.26**·간접수복물 2.12·부적절 근충 1.81이 일반의만 밀고 전문의는 병소크기에 무반응. **핵심 발견 — "전문의가 옳다"는 이 위키의 근거로 지탱 안 됨**: 그 논문이 보존 정당화로 인용한 의도적 재식 "88–98%"가 현행 SR+MA 실측(성공 **0.78**, 39편 중 **31편 high RoB·low 0편**, 8년 생존 **0.63**)과 어긋남 — 즉 양쪽 다 불확실. 보존 대안 실수치: IR 0.78/0.89, 자가이식 생존 95%·성공 92%·흡수 16%(**둘 다 임플란트 비교 없음**). **AI는 구조적으로 중재 불가** — 발치 결정 민감도 70%(I²≈96.7%)에 기준표준이 "임상의의 관행적 판단"이라 불안정한 인간 판단 재현 훈련(순환); 'AI 치료계획' 27편 중 실제 계획 근거 **3편뿐**; 탐지(0.85)≫결정(0.70). 유일한 건설적 경로는 AI를 **합의 조율자**로(술자 민감도 60.7→85.9%, κ +0.12~0.19, 4편·GRADE Low–Mod). 공백: **계획 편차를 환자 결과와 연결한 연구 0편**·보존vs대체 head-to-head 0편·IR 문헌에 low RoB 0편·6편 어디에도 **환자 선호 없음**(→SDM 연결).
## 교합 (Occlusion)
