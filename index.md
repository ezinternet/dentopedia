...
- [[veneers/coachman-2014-tooth-color-veneer-preparation-design]] — Coachman/Gürel 2014 case report: "Do the Math" technique — additive diagnostic wax-up transferred via APT + per-region formula EV − LT = P (extra volume − laminate thickness = preparation) computes exact reduction amount/location for target color; middle/incisal thirds prepped 0 mm (enamel untouched) in A2→A1 case, final e.max ~0.3 mm; quantifies Gürel's APT enamel-preservation philosophy. DOI 10.11607/prd.1900
