...
- [[overviews/dentin-hypersensitivity-mechanism-diagnosis-treatment-synthesis]] — **Overview** (Synthesis 2026-06-19, 19편): 상아질 과민증 종합 — 유체역학설 기전(세관폐쇄 vs 신경차단 2표적) → 배제진단(우식·균열·치수염 제외, Schiff/VAS) → 치료 결정트리(자가 탈감작치약 SnF₂·NovaMin·CPP-ACP → in-office Gluma·LLLT). 장기근거 1위 Gluma·LLLT(Corrêa 2025)나 Gluma 농도의존 치수독성(Scheffel 2015), 접착·칼슘인산염계는 장기효과 부족; 지속성공은 순응·유발인자 관리
