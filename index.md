...
- [[overviews/unopposed-tooth-overeruption-overview]] — **Overview** 2026-06-25 (2편): 대합치 없는 치아 정출 종합 — ~83% 정출(평균 0.43mm/9개월, 72%<1mm, 초기최대, 수직+경사+회전)하나 18%는 무이동; 정출은 PDL 매개라 **endo치 vs 생활치 차이 근거 없음**(기전적 추론); 고정 retention도 부분접촉 대비 무효 → 저위험치 모니터링·고위험(젊음·상악·완전무대합·치주염·발치직후) 보철
