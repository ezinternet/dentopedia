...
- [[overviews/immediate-implant-infected-sites-decision]] — **NEW Overview** (10편, 2026-07-05): 감염 발치와 즉시식립(IIP) 임상결정 프레임워크 — 핵심 변수는 감염 '유무'가 아닌 '유형'. ①만성 치근단 병변(비화농성): 철저한 소파+항생제 시 생존율 비감염 동등(RR=0.99, Saijeva 2020 SR+MA; Pranckeviciene 2024 SR+MA 앵커); ②급성 화농성 농양: 조기식립(Early, 8–12주)이 24개월 변연골소실(MBL) 최선(0.48 mm, Prati 2017); ③수술 후 감염: 70.6% 실패(Tabrizi 2020) — 항생제 임계일(비흡연 9일/흡연 6일). 절대 금기: 활동성 화농성 삼출·봉와직염·상악동 천공. 각화치은폭(KGW) 감소 모니터링 필수.
