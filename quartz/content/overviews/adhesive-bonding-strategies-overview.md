---
title: "접착·결합 전략 — Universal·SE·E&R·오염 대처·간접수복 본딩 종합"
...
Synthesis of 6 bonding-strategy axes (adhesive fatigue/aging, silane timing & contamination, saliva-contamination handling with MDP & decontamination, indirect-restoration bonding including 3D-printed crowns, direct-composite stamp technique, and hybridization quality vs bond strength); core thesis: bond durability is governed by isolation/contamination control, adhesive-system choice, and surface pretreatment — not by procedure length.
...
6개 축(접착제 피로·노화, 실란 타이밍·오염, 타액 오염 MDP·decontamination, 간접수복 본딩 포함 3D 프린팅 크라운, 직접 레진 stamp 술기, 혼성층 품질 vs 결합강도) 종합: 결합 내구성의 결정 인자는 격리·오염 차단, 접착 시스템 선택, 표면 전처리 — 절차 길이가 아님.

러버댐 격리 1순위; 2-step 자가부식(SE, Clearfil SE Bond)은 타액 오염 내성 + 최소 나노누출·최고 µTBS; 1-step universal은 타액 오염 후 decontamination 필요; 3D 프린팅 크라운은 알루미나 분사 전처리로 밀링 동등 결합력.

모든 정량적 축은 in-vitro에 한정돼 임상 적용 시 주의; stamp 술기는 증례보고 수준만; HEMA/BPA-free 및 2-step HEMA-free universal은 50k 열순환에서 2-step SE 수준 내구성 도달 가능.

## Summary

본 페이지는 wiki/resin-bonding/ 4편 + wiki/resin/kim-2026-stamp 1편을 4축으로 묶음. 결합력 in-vitro 데이터 위주이나 임상 함의 명확.
...
| Spine paper | Evidence | Key finding |
|---|---|---|
| [[resin-bonding/etiennot-2025-mdp-saliva-contaminated-dentin]] | in-vitro µTBS | 2-step SE Clearfil SE Bond 2 — 오염 dentin 강도 유지; 1-step Universal Bond Quick — Katana Cleaner 등 decontamination 필수 |
...
| Spine paper | Evidence | Key finding |
|---|---|---|
| [[resin/kim-2026-stamp-technique-posterior-composite-resin]] | case-report (2 cases) | 인택트 교합면 flowable index → 와동 형성 → index로 contour 복제 |
...
- [ ] `wiki/overviews/silane-treatment-protocol-comparison.md` — 실란 protocol·열처리.
- [ ] `wiki/overviews/3d-printed-prosthetic-bonding-protocol.md` — 3D 프린팅 prosthetic 표준.
...
- [[resin-bonding/delgado-2025-functional-monomers-dental-adhesive-technology]] — narrative review (2005–2025): physico-chemical ranking of acidic functional monomers — 10-MDP (~50% of marketed adhesives) > 4-META/4-MET/GPDM on bonding, hydrolytic stability and collagen interaction; canonical 4-META/Super-Bond composition reference (chemistry-level "why" for the MDP preferences on this page) (narrative-review, 2025)
- [[resin-bonding/oliveira-2025-best-adhesive-primary-enamel-nma]] — Bayesian network meta-analysis (14 in-vitro, deciduous enamel): 3-step E&R top SUCRA, two-bottle universal + phosphoric etch equivalent, self-etch ≈ E&R within step-count → step-count reducible on primary enamel (substrate exception to the permanent-tooth preferences here; immediate 24 h only) (sr+ma, 2025)
