...
- **Basal cortical implants sit outside this ladder, not on it.** A separate anchorage strategy — basal/cortical implants (e.g., ARi® system) that engage dense basal cortical bone rather than compromised cancellous alveolar bone — is sometimes proposed for severely resorbed sites. Park 2025 (case report, n=2, anterior maxilla, MegaGen-affiliated authors) achieved 40 N/cm² primary stability and stable 2-year outcomes, but **still required BCP grafting and collagen membrane in both cases** — i.e., basal-cortical anchorage improved primary stability without eliminating the augmentation burden that defines the graftless ladder's entire premise. It therefore does not belong as a fifth rung here; it is a stability-enhancing adjunct usable *alongside* grafting, evidenced only at case-report level with a manufacturer conflict of interest. See [[implants/park-2025-ari-implant-severely-resorbed-ridges]].
...
- [[implants/park-2025-ari-implant-severely-resorbed-ridges]] — outside the ladder; basal cortical implant case report (n=2), still required grafting, illustrates that anchorage-strategy alone doesn't eliminate the augmentation question this page's four rungs answer.
