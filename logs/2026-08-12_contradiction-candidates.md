...
- (억제됨) 이미 typed 엣지가 있어 제외: **253** · 부정문 제외: **101** · 검토·불필요 대장: **393** · 동일 줄 비최근접으로 Tier 2 강등: **5**
...
- `implant-surface-comparison`  —[contradict · 반박·충돌]→  **`yamada-2012-nanopolymorphic-hydroxyapatite-titanium-implant`**
  - **근거 문장**: | **animal** | [[implants/surface/yamada-2012-nanopolymorphic-hydroxyapatite-titanium-implant]] | 나노 HA 코팅 | BIC·강도 조기·후기 모두 향상; 효과 표면 50 µm 이내 (**단일 쥐 연구 — 아래 damerau-2021 대형동물 메타분석과 contradicts, §2.4 참조**) | 쥐 |
  ...
  - ▸ 대상(`yamada-2012-nanopolymorphic-hydroxyapatite-titanium-implant`) 세줄: 쥐 대퇴골 동물실험 — 나노다형성 결정질 수산화인회석 (Hydroxyapatite, HA) 코팅 (Ca/P=1.66, 55% 결정화도, 침상 나노구조)과 비코팅 미세거칠기 티타늄을 2주·4주에 비교. HA 코팅이 양 치유 시점에서 골-임플란트 접촉률 (BIC)과 압입력 (push-in force)을 높이고 계면 연조직 침투를 줄였으나, 골용적 효과는 임플란트 표면 50 µm 이내로만 한정되고 그 너머는 오히려 감소. 대량생산 가능한 화염분사+저온 소성 방법으로 제작; ≤50 µm 공간적 한계는 전

- `implant-surface-comparison`  —[대비되는 · 대비]→  **`matys-2025-osseointegration-zirconia-implants-calcium-phosphate`**
  - **근거 문장**: - [[implants/surface/matys-2025-osseointegration-zirconia-implants-calcium-phosphate]] — 27편 SR — 지르코니아 임플란트 CaP 코팅, bonfante-2012(티타늄)과 대비되는 기질-의존적 코팅 효과 패턴; `extends → bonfante-2012` (sr, 2025)
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수
  - ▸ 대상(`matys-2025-osseointegration-zirconia-implants-calcium-phosphate`) 세줄: _(세줄요약 없음 — 페이지 확인 필요)_


### post-and-core

- `post-and-core-fiber-post-decision-overview`  —[contradict · 반박·충돌]→  **`carvalho-2020-endodontically-treated-teeth-restoration-adhesive-approach`**
  - **근거 문장**: - [[post-and-core/carvalho-2020-endodontically-treated-teeth-restoration-adhesive-approach]] — adhesive approach review: post necessity depends on crown material; partial coverage viable; contradictory evidence on postless bonded ceramics
  - ▸ 출발(`post-and-core-fiber-post-decision-overview`) 세줄: 근관치료치(Endodontically Treated Tooth, ETT) 수복 22편 종합 — 치아를 실제로 약화시키는 것은 근관치료 자체(강성 손실 ~5%)가 아니라 수복을 위한 MOD cavity 삭제(~63%)이며(Reeh 1989), 이 때문에 포스트 여부·ferrule 보존·수복 범위(크라운 vs 온레이 vs 직접레진) 결정이 모두 포스트 재료 선택보다 우선한다. 포스트는 무포스트 대비 생존 향상(Alenezi 2024, P<0.001)이나 치질소실 조건부이며, ferrule이 보존되면 
  - ▸ 대상(`carvalho-2020-endodontically-treated-teeth-restoration-adhesive-approach`) 세줄: 본 종설은 근관치료된 치아 (Endodontically Treated Teeth, ETT)의 접착 수복에 관한 현재 지식을 조사하였으며, 부분 피개 대 완전 피개, 페룰 효과, 포스트 종류가 치명적 파절에 미치는 영향, 엔도크라운 및 포스트 없는 코어 축성 (postless build-up)과 같은 무포스트 대안을 검토하였다. 잔존 치아 구조의 보존이 가장 중요하며, 1.5-2 mm 페룰의 존재는 파절 저항성을 향상시키고, 부분 수복물은 완전관과 유사한 생존율을 보였으며 (94-100% 대 91.


## Tier 2 — 대상 식별 필요 / soft signal (review only)

- `sarilaksmi-2026-intact-mta-sealer-gutta-percha-surface-modification` [endodontics] (SOFT→ceraseal-bioceramic-sealer-clinical-material-synthesis, 'whereas' · 반면(대조))
  - **근거 문장**: - [[overviews/ceraseal-bioceramic-sealer-clinical-material-synthesis]] — contrasts; the existing bioceramic/calcium-silicate premixed-sealer synthesis solves the sealer-GP affinity problem by reformulating the sealer, whereas this paper solves it by modifying the GP core material's surface instead, keeping MTA intact.
  - ▸ 출발(`sarilaksmi-2026-intact-mta-sealer-gutta-percha-surface-modification`) 세줄: 줄1: In-vitro 재료학 연구(GP 판상 시편 접촉각 n=9/군, XPS·XRD n=4/군; 단근치 근관 시편 n=3/군)로 대기압 플라즈마·100mM 세틸피리디늄 클로라이드(Cetylpyridinium Chloride, CPC) 침지·플라즈마+CPC 병용 표면처리를 통해 첨가제 없는 intact 무기질삼산화물응집체(Mineral Trioxide Aggregate, MTA)를 근관 실러로 사용 가능한지 평가했다. 줄2: 플라즈마+CPC 병용처리는 GP 접촉각을 113.27°±5.64(미처리,
  - ▸ 대상(`ceraseal-bioceramic-sealer-clinical-material-synthesis`) 세줄: 세라실(Ceraseal, 프리믹스 칼슘실리케이트 생체세라믹 실러) 임상 4편(전향 코호트 2 + RCT 2) + 벤치 12편 종합: 24–36개월 치유 ~91–92%·생존 ~93–98%이 AH Plus gold standard와 동등; Elmsmari 2025 SR+MA(RCT 3편, n=259)에서 6/12/18개월 모두 통계적 유의차 없음(OR 1.12–2.09, p>0.05) — 단 GRADE 근거 낮음. AH Plus 대비 이점: 술후통증 ↓(Abada 2025 RCT, p<0.001; D
...
- `naumann-2017-ferrule-first-post-second-systematic-review` [post-and-core] (SOFT→post-and-core, 'challenges the' · 도전)
  - **근거 문장**: This is the landmark clinical SR that directly challenges the post-first assumption — it establishes that ferrule >> post in clinical evidence, redirecting clinical priorities. This is one of the most-cited conceptual papers in post-and-core dentistry. Directly extends [[wiki/post-and-core/]] category and provides the clinical evidence base for ferrule-effect discussions.
  - ▸ 출발(`naumann-2017-ferrule-first-post-second-systematic-review`) 세줄: 전향적 임상연구 8편 (RCT 7 + 전향적 임상시험 1, 추적 ≥5년, Cochrane 비뚤림 평가) 체계적 고찰: 근관치료치에서 포스트 유무를 직접 비교한 장기 전향적 근거만을 대상으로 한 첫 번째 SR. 페룰 효과 및 치벽 보존이 주된 생존 결정인자(해당 3편 중 2편 지지), 8편 중 7편에서 포스트 식립의 독립적 양성 효과 없음; ≥5년 전향적 임상근거로는 일상적 포스트 식립을 지지할 수 없다. 8편 중 5편이 Cochrane 비뚤림 위험 높음으로 평가되어, 결론은 "포스트가 해롭다"가 
  - ▸ 대상(`post-and-core`) 세줄: **분야**: 포스트앤코어 **수록 논문**: 24편 **하위 카테고리**: 없음

- `drukala-2005-comparison-of-proliferation-and-motile` [periodontics] (SOFT→huynh-2016-saline-rinsing-gingival-fibroblast-wound-healing, 'unlike' · 다름)
  - **근거 문장**: - [[periodontics/huynh-2016-saline-rinsing-gingival-fibroblast-wound-healing]] — complementary in-vitro oral keratinocyte/fibroblast wound-healing biology; that paper found oral keratinocytes (hNOKs) do not respond to saline/chloride-driven migration cues (unlike gingival fibroblasts), consistent with distinct motility-regulation pathways between oral keratinocytes and fibroblasts documented here 
  - ▸ 출발(`drukala-2005-comparison-of-proliferation-and-motile`) 세줄: Folia Biologica(Kraków, 2005)의 체외(in vitro) 연구로, 건강한 공여자 12명의 피부(표피)와 구강(협측) 점막 생검에서 분리한 1차 배양 각질세포(케라티노사이트, Keratinocyte)를 동일 조건에서 형태·이동성·증식능으로 비교했다. 구강점막 각질세포는 피부 각질세포보다 이동속도가 약 12% 빨랐고(1.73 vs 1.55 μm/min), 이동경로가 더 직선적이었으며(전위효율계수, CDE 0.55 vs 0.36), 24시간째 세포밀도가 20% 더 높았다. 세포 크
  - ▸ 대상(`huynh-2016-saline-rinsing-gingival-fibroblast-wound-healing`) 세줄: In vitro 연구 (PLOS ONE 2016, 출라롱콘대): 1차 인체 치은 섬유아세포(hGF)·구강 각화세포(hNOK)에 0–7.2% NaCl 1일 3회 2분 세척 노출; 이동·증식·세포외기질(ECM) 유전자 발현·세포골격 재구성 평가. 0.9–1.8% NaCl은 hGF 이동을 유의하게 촉진(p<0.05/0.01)하고 1.8%에서 COL1 >3배·피브로넥틴·FAK mRNA 상향 조절; 7.2%는 이동 억제; hNOK 무반응; 이온 대체 실험에서 Cl⁻ 이온이 핵심 매개체로 확인. 0.9–1.
...
- `drug-analgesics-postop-pain-overview` [overviews] (HIGH-no-target, '상충' · 상충)
  - **근거 문장**: - **Preemptive IV Ibuprofen이 24h opioid 사용 45% 감소** (위약 대비, p<0.001) — 본 overview §4의 "Third molar preemptive NSAID 무효"(Costa 2015, 경구)와 상충하는 것처럼 보이나, 전신마취 하 대수술(비-치과 general surgery) 데이터가 대부분이라 third molar에 직접 외삽 불가 — **투여 경로(IV vs 경구) 자체의 약동학 차이**(빠른 혈중농도 도달)가 두 결과의 방향 차이를 설명할 가능성.
...
- `plasma-surface-treatment-dental-implants` [overviews] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: **2026-08 addition — how long does a "vacuum plasma" cycle actually take?** A user question about a specific chairside device (MegaGen Plasma X Motion) prompted a full device-parameter audit of every paper in this cluster that reports one. The result resolves an apparent contradiction: **"vacuum plasma" spans two unrelated device categories with a ~15× duration gap between them**, and duration tra
  - ▸ 출발(`plasma-surface-treatment-dental-implants`) 세줄: 위키 27편(리뷰·SR/MA 4 + 동물 8 + 사람 임상 3 + in vitro 11 + 안전성 1) 종합: 저온/비열 대기압 플라즈마(Cold Atmospheric Plasma, CAP)는 티타늄 표면 생물학적 노화를 역전(탄소↓·친수성/표면에너지↑·형태/조성 불변)하여 ① 골유착 촉진 ② 제염 두 역할을 수행. 사람 근거(RCT 2 + 코호트 1)는 작고 부분적으로 유의한 *초기* 안정성 이득(Stacchi RCT: 임플란트 안정성 지수(ISQ) 60/90일에만 유의; Kwon RCT: 안정
...
- `implant-surface-comparison` [overviews] (HIGH-no-target, '뒤집' · 뒤집음)
  - **근거 문장**: > - **근거 갱신(2026-08) — 중요 정정**: TCP/HA 코팅이 골전도(Osteoconduction)를 개선한다는 이 오버뷰의 기존 우호적 서술은 **대형동물 15편 메타분석(Damerau 2021)으로 뒤집힘** — 이미 거친(rough) 비코팅 티타늄 대비 TCP/HA 코팅은 BIC 유의 우위 없음, HA는 오히려 14일차에 유의하게 낮음(−6.94%p, p=.001). 기존에 인용한 yamada-2012(단일 쥐 연구)와 정면 상충(contradicts) — **작은 표본 단일 연구가 큰 표본 메타분석에 뒤집힌 사례**.
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수

- `implant-surface-comparison` [overviews] (HIGH-no-target, '뒤집' · 뒤집음)
  - **근거 문장**: - **CaP/HA 코팅 = 2026-08 근거 하향** [확인]: 이 overview는 2026-06까지 bonfante-2012(동등성)·yamada-2012(HA 우위)를 근거로 CaP/HA 코팅에 우호적이었으나, **Damerau 2021(15편 pooled MA)이 이를 뒤집음** — 이미 거친 티타늄 대비 TCP·HA 코팅은 견고한 BIC 우위가 없고, HA는 14일차에 오히려 유의하게 낮다. 저자 해석: 기준 표면 자체의 조도가 CaP 코팅 화학의 골전도 이점을 가릴 가능성 — **"코팅"보다 "거칠기"가 더 지배적인 변수**라는 이 overview 전체의 핵심 thesis(§1 탄화수소·§4 거칠기)와 오히려 정합적. 상세는 §2.4.
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수

- `implant-surface-comparison` [overviews] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: | **TCP/HA 코팅 효능 (2026-08 정정)** | — | **비유의, HA는 14일 유의 열세 (Damerau 2021 SR+MA 15편)** — yamada-2012와 contradicts | 코팅 vs 거칠기 상대 기여도 분리 RCT |
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수

- `implant-surface-comparison` [overviews] (HIGH-no-target, '반박' · 반박)
  - **근거 문장**: **본 overview thesis에 대한 함의** [미검증]: §1–§4는 "거칠기·탄화수소제거·계층형 나노구조가 골유착에 유리하다"는 것을 확립했다. Dipalma 2026은 이를 **반박하지 않는다** — 초기 골유착과 장기 peri-implantitis 위험은 다른 시간축·다른 outcome이기 때문이다. 다만 임상 알고리듬(§7)에서 거친/친수성 표면을 선택할 때, 특히 흡연·치주염력이 있는 환자에서는 **유지관리 강화**가 표면 선택 자체보다 중요하다는 균형추를 더한다.
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수

- `implant-surface-comparison` [overviews] (HIGH-no-target, '상충' · 상충)
  - **근거 문장**: - **신규 갭 (2026-08)**: TCP/HA·Mg·Ag 코팅 전부 동물/전임상뿐 — **인체 RCT 전무**. 특히 Damerau 2021(TCP/HA 비유의~열세)과 yamada-2012(HA 우위)의 정면 상충을 해소할 **인체 데이터**가 가장 시급한 갭.
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수

- `implant-surface-comparison` [overviews] (HIGH-no-target, '상충' · 상충)
  - **근거 문장**: - **신규 갭 (2026-08)**: 생체분자(BMP·콜라겐) 코팅의 두 SR+MA(Alshayeb 2024 유의 vs López-Valverde 2022 비유의) 상충 해소 — 더 큰 표본·표준화된 후속 메타분석 필요.
  - ▸ 출발(`implant-surface-comparison`) 세줄: 임플란트 표면처리 15편 + 5편 횡단인용 종합 매트릭스: SLA/SA = 임상 표준(8년 생존 94.8%, Kim 2020 n=96); 친수성(CA/SLActive) = D3/D4 골에서 stability dip 제거, 절대 ISQ 상승은 아님(CA 5.2년 97.3%, MBL 0.074 mm, Kim 2022 n=258); UV 광기능화(UV-PF) = 위축골·복잡증례 1순위(ISQ +21.9, 7년 100% 성공, Hirota 2020 전향적). 표면처리의 핵심 기전은 친수성이 아니라 탄화수
...
- `veneers-category-synthesis-overview` [overviews] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: ### The apparent contradiction
  - ▸ 출발(`veneers-category-synthesis-overview`) 세줄: 비니어 28편은 ① 재료 선택·생존율·프로토콜, ② 삭제 디자인·최소침습, ③ 교합면 비니어(마모·침식) 3개 주제군; 3군 통합 원칙 = 법랑질 한정 변연(상아질 노출 시 실패 ~10배, El-Mowafy 2018) — 최소침습의 목적은 삭제량이 아니라 법랑질 보존. 재료 생존율 유사(장석 96.13%·LDS 96.81%·LRGC 93.70%; Klein 2025 SR+MA, 29편·7,753개), 차이는 합병증(LDS 10년 6.1% vs 장석 41.48%) — 생존이 아닌 합병증이 LDS 선

- `veneers-category-synthesis-overview` [overviews] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: Beier's veneers were placed between 1987 and 2009 on silicate glass-ceramic, using adhesive protocols that predate immediate dentin sealing (IDS) and modern dentin management. Both dissenting studies are modern-era and, crucially, **agree with each other across independent axes** — different centres, different materials (feldspathic vs LDS), different designs (prospective vs retrospective) — yet l
  - ▸ 출발(`veneers-category-synthesis-overview`) 세줄: 비니어 28편은 ① 재료 선택·생존율·프로토콜, ② 삭제 디자인·최소침습, ③ 교합면 비니어(마모·침식) 3개 주제군; 3군 통합 원칙 = 법랑질 한정 변연(상아질 노출 시 실패 ~10배, El-Mowafy 2018) — 최소침습의 목적은 삭제량이 아니라 법랑질 보존. 재료 생존율 유사(장석 96.13%·LDS 96.81%·LRGC 93.70%; Klein 2025 SR+MA, 29편·7,753개), 차이는 합병증(LDS 10년 6.1% vs 장석 41.48%) — 생존이 아닌 합병증이 LDS 선
...
- `oral-mucosal-vs-dermal-wound-healing-mechanism-synthesis` [overviews] (SOFT→huynh-2016-saline-rinsing-gingival-fibroblast-wound-healing, 'unlike' · 다름)
  ...
  - ▸ 출발(`oral-mucosal-vs-dermal-wound-healing-mechanism-synthesis`) 세줄: 임상적으로 잘 알려진 "구강 상처가 피부보다 빨리·흉터 없이 낫는다"는 관찰을 조직 수준(Glim 2013, narrative review)과 세포 수준(Drukala 2005, in-vitro) 2편으로 설명하는 종합. Glim 2013은 조직 수준 차이(구강: 면역매개체·혈관·섬유화매개체↓, 골수유래세포↑, 재상피화·섬유아세포증식↑, ECM 조성 차이)를 카탈로그화하고, Drukala 2005는 재상피화 주장 바로 아래의 세포 기전을 제공 — 건강 공여자 12명의 구강점막 각질세포가 동일 배양
  - ▸ 대상(`huynh-2016-saline-rinsing-gingival-fibroblast-wound-healing`) 세줄: In vitro 연구 (PLOS ONE 2016, 출라롱콘대): 1차 인체 치은 섬유아세포(hGF)·구강 각화세포(hNOK)에 0–7.2% NaCl 1일 3회 2분 세척 노출; 이동·증식·세포외기질(ECM) 유전자 발현·세포골격 재구성 평가. 0.9–1.8% NaCl은 hGF 이동을 유의하게 촉진(p<0.05/0.01)하고 1.8%에서 COL1 >3배·피브로넥틴·FAK mRNA 상향 조절; 7.2%는 이동 억제; hNOK 무반응; 이온 대체 실험에서 Cl⁻ 이온이 핵심 매개체로 확인. 0.9–1.

- `jeevitha-2025-tissue-adhesives-vs-sutures-periodontal-flap-sr-ma` [suture-wound-closure] (HIGH-no-target, 'overturn' · 결론 뒤집음)
  - **근거 문장**: Publication bias: Egger's regression intercept −14.10 (p=0.003, indicating small-study effects); Begg-Mazumdar Kendall's tau −0.29 (p=0.069, non-significant); Rosenthal fail-safe N=848 (Fisher's method 3,169, i.e. a large number of unpublished null studies would be needed to overturn the pooled effect); trim-and-fill adjustment minimal.
  - ▸ 출발(`jeevitha-2025-tissue-adhesives-vs-sutures-periodontal-flap-sr-ma`) 세줄: 체계적 문헌고찰 + 메타분석(SR+MA, PROSPERO CRD42023444615, PRISMA 2020) — 치주판막수술(periodontal flap surgery) 창상폐쇄에서 조직접착제(주로 시아노아크릴레이트(Cyanoacrylate), 2편은 피브린 실란트/글루(Fibrin Sealant/Glue)) vs 봉합(주로 3-0 실크)을 비교한 스플릿마우스/평행군 RCT 10편(환자 255명, 2013–2023), 표준화된 창상치유지수(Wachtel EWHI·Huang WHI·Landry H

- `canellas-2022-corticosteroids-third-molar-nma` [drug/analgesics] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: Dexamethasone 8mg submucosal injection and pterygomandibular injection significantly reduced edema vs placebo (−3.58 [−6.98; −0.17] and −3.56 [−6.30; −0.82] respectively); dexamethasone 8mg submucosal also significantly reduced pain on days 1 and 2 (−30.95 and −15.25 VAS units) — contradicting earlier binary CS-vs-no-CS syntheses that found no pain benefit; no serious adverse effects across all ag
  - ▸ 출발(`canellas-2022-corticosteroids-third-molar-nma`) 세줄: 빈도주의 네트워크 메타분석 (Network Meta-Analysis, NMA) (61 RCT, 3561명; Embase·PubMed·Cochrane) — 하악 제3대구치 (Mandibular Third Molar) 발치 후 부종·통증·개구제한 감소를 위한 5종 코르티코스테로이드 (Corticosteroid, CS): 덱사메타손 (Dexamethasone)·베타메타손 (Betamethasone)·메틸프레드니솔론 (Methylprednisolone)·프레드니솔론 (Prednisolone)·트리암시놀론

- `canellas-2022-corticosteroids-third-molar-nma` [drug/analgesics] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: This 2022 frequentist network meta-analysis (Canellas, Ritto, Tiwana; Br J Oral Maxillofac Surg) is the largest head-to-head comparison of corticosteroids for mandibular third molar surgery, including 61 RCTs and 3561 subjects. Unlike earlier binary meta-analyses (such as markiewicz-2008) that pooled any corticosteroid vs placebo without comparing specific agents, this NMA separately ranks dexamet
  - ▸ 출발(`canellas-2022-corticosteroids-third-molar-nma`) 세줄: 빈도주의 네트워크 메타분석 (Network Meta-Analysis, NMA) (61 RCT, 3561명; Embase·PubMed·Cochrane) — 하악 제3대구치 (Mandibular Third Molar) 발치 후 부종·통증·개구제한 감소를 위한 5종 코르티코스테로이드 (Corticosteroid, CS): 덱사메타손 (Dexamethasone)·베타메타손 (Betamethasone)·메틸프레드니솔론 (Methylprednisolone)·프레드니솔론 (Prednisolone)·트리암시놀론

- `canellas-2022-corticosteroids-third-molar-nma` [drug/analgesics] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: - Demonstrates significant pain reduction for dexamethasone 8mg submucosal on days 1 and 2 — contradicts markiewicz-2008's no-pain-benefit finding for CS pooled
  - ▸ 출발(`canellas-2022-corticosteroids-third-molar-nma`) 세줄: 빈도주의 네트워크 메타분석 (Network Meta-Analysis, NMA) (61 RCT, 3561명; Embase·PubMed·Cochrane) — 하악 제3대구치 (Mandibular Third Molar) 발치 후 부종·통증·개구제한 감소를 위한 5종 코르티코스테로이드 (Corticosteroid, CS): 덱사메타손 (Dexamethasone)·베타메타손 (Betamethasone)·메틸프레드니솔론 (Methylprednisolone)·프레드니솔론 (Prednisolone)·트리암시놀론
...
- `markiewicz-2008-corticosteroids-reduce-postoperative-morbidity-after-third-molar-surgery` [drug/analgesics] (HIGH-no-target, '뒤집' · 뒤집음)
  - **근거 문장**: > Canellas 2022 NMA (Br J Oral Maxillofac Surg, 61 RCT, 3561명)가 5종 코르티코스테로이드 (Corticosteroid, CS)를 약제·용량·투여경로별로 직접 비교 — 덱사메타손 (Dexamethasone) 8mg 점막하주사·경구가 부종 최강 효과이며, 술 후 1·2일차 통증도 유의하게 감소함을 보여 이 페이지의 "CS 통증 무효과" 결론을 뒤집음. 더 큰 표본(61 vs 12 RCT), 약제 간 직접 비교, 통증 결론 번복 — 세 가지 축 모두에서 대체됨. 제3대구치 발치 후 CS 선택 근거는 canellas-2022를 우선할 것. (set 2026-08-11)
  - ▸ 출발(`markiewicz-2008-corticosteroids-reduce-postoperative-morbidity-after-third-molar-surgery`) 세줄: 12개 RCT를 풀링한 체계적 문헌고찰+메타분석(Systematic Review and Meta-Analysis, SR+MA) — 사랑니(Third Molar, M3) 발치 후 코르티코스테로이드(Corticosteroid, CS) 주위수술기 투여가 부종·개구제한(Trismus)·통증에 미치는 영향을 조기(1–3일)·후기(>3일)로 나눠 평가. CS 투여군에서 부종은 조기(표준화평균차, Standardized Mean Difference, SMD 1.4, 95% 신뢰구간 0.6–2.2, P<.001

- `huraib-2023-micro-threaded-laser-textured-implant-neck-peri-implant` [implants/surface] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: - Surfaces an internal contradiction worth flagging clinically: while MBL trends favor rough/micro-threaded necks, one included study found smooth-neck implants had a significantly *lower* peri-implantitis frequency (2.92% vs 14.41%, p<0.001) — MBL and infection risk did not move in the same direction in every study.
  - ▸ 출발(`huraib-2023-micro-threaded-laser-textured-implant-neck-peri-implant`) 세줄: PRISMA 체계적 문헌고찰(SR) — 15편의 대조 임상연구(RCT 6편, 전향적 5편, 후향적 4편; 2013–2022년), 거친 미세나사산(micro-threaded) 또는 레이저 미세조직화 표면(Laser Micro-textured Surface, LMS) 임플란트 넥 디자인을 매끄러운 기계가공(machined) 넥과 비교해 변연골소실(Marginal Bone Loss, MBL) 및 임플란트주위 연조직 결과를 평가; 연구 간 이질성으로 메타분석은 시행하지 못함. 거친 미세나사산 넥은 부하 

- `huraib-2023-micro-threaded-laser-textured-implant-neck-peri-implant` [implants/surface] (HIGH-far→zhang-2021-tissue-level-bone-level-fresh-extraction-sockets-dogs, 'counterpoint' · 반대 논점)
  - **근거 문장**: - [[implants/zhang-2021-tissue-level-bone-level-fresh-extraction-sockets-dogs]] — dog histomorphometric study comparing tissue-level (smooth machined collar) vs bone-level (micro-threaded, platform-switched) neck designs; found no significant vertical bone resorption difference between neck types, an animal-model counterpoint to this SR's human-data MBL advantage for micro-threaded necks — a diffe
  - ▸ 출발(`huraib-2023-micro-threaded-laser-textured-implant-neck-peri-implant`) 세줄: PRISMA 체계적 문헌고찰(SR) — 15편의 대조 임상연구(RCT 6편, 전향적 5편, 후향적 4편; 2013–2022년), 거친 미세나사산(micro-threaded) 또는 레이저 미세조직화 표면(Laser Micro-textured Surface, LMS) 임플란트 넥 디자인을 매끄러운 기계가공(machined) 넥과 비교해 변연골소실(Marginal Bone Loss, MBL) 및 임플란트주위 연조직 결과를 평가; 연구 간 이질성으로 메타분석은 시행하지 못함. 거친 미세나사산 넥은 부하 
...
- `mehta-2021-tilted-axial-implants-edentulous-maxilla-sr-ma` [implants/full-arch] (HIGH-no-target, '반박' · 반박)
  - **근거 문장**: > Del Fabbro 2022 SR+MA (JOMI, 24편, 5,594 경사 (Tilted)+5,611 수직 (Axial) 임플란트, 3~18년 추적)는 동일한 임상 질문(경사 vs 수직 임플란트 전악 수복 변연골소실 (Marginal Bone Loss, MBL)·생존율)에서 훨씬 큰 표본으로 **수직 임플란트 주위 MBL이 경사 대비 유의하게 낮음(P<.0001)**을 확인함 — 이 페이지(7편, MBL 유의차 없음 P=0.69)의 MBL 결론을 직접 반박. 악궁(상악 vs 하악) 차이가 MBL에 영향 없음(P=.17)으로 상악 제한 결과에도 동일 결론 적용됨. 즉시 로딩 (Immediate Loading) 특이성은 부분 잔류 — 변연골소실 근거는 del-fabbro-2022를 우선 인용할 것. (se
  - ▸ 출발(`mehta-2021-tilted-axial-implants-edentulous-maxilla-sr-ma`) 세줄: SR+MA (생존 11편·변연골소실 7편) — 즉시 로딩 위축 무치악 상악에서 경사 vs 축방향 임플란트 비교. 3년 시점 생존율 RR 1.00 (P=0.59), 변연골소실 (Marginal Bone Loss, MBL) MD −0.02 mm (P=0.69) — 두 지표 모두 유의차 없음. All-on-4형 경사식립은 생존율·골소실 면에서 축방향과 동등 — 위축 상악 전악 수복 시 경사식립 생물역학적 타당성 확인.
...
- `cho-2025-rhbmp2-vacuum-plasma-titanium-implants-osseointegration` [implants/surface/plasma] (HIGH-far→stacchi-2025-vacuum-plasma-early-implant-stability-rct, 'counterpoint' · 반대 논점)
  - **근거 문장**: - [[implants/surface/plasma/stacchi-2025-vacuum-plasma-early-implant-stability-rct]] — human split-mouth RCT, ~50s vacuum plasma, early ISQ advantage at 60/90 days; this paper's ISQ null result (despite large histometric BIC gains) is a useful animal counterpoint on the RFA-vs-histometric dissociation.
  - ▸ 출발(`cho-2025-rhbmp2-vacuum-plasma-titanium-implants-osseointegration`) 세줄: 비글 하악 결손 모델(SLA 임플란트 24개, 비글 4마리, 8주 치유) — 무처리·rhBMP-2 단독·진공 플라즈마(Vacuum Plasma) 단독·플라즈마+rhBMP-2 병용 4군을 골-임플란트 접촉률(Bone-to-Implant Contact, BIC)·나사산간 골밀도(ITBD)·신생골면적·micro-CT 골량·임플란트 안정성 지수(ISQ)로 비교. 병용군에서 BIC(83.91% vs 68.81%/70.98%)·ITBD(81.32%, 전 군 대비 유의)·micro-CT 신생골량(75.00% 
...
- `gupta-2023-prevalence-distribution-oral-mucosal-nepal` [oral-medicine/normal-variants] (HIGH-far→normal-variants, '대비되는' · 대비)
...
- `lee-2024-single-tuft-plaque-removal-sr` [periodontics/oral-hygiene-instruction] (HIGH-no-target, 'contradict' · 반박·충돌)
  - **근거 문장**: STBs demonstrated significantly superior plaque removal on maxillary buccal and mandibular lingual interproximal surfaces of molars compared to conventional brushes alone (Lee & Moon, 2011: p<0.05). In orthodontic patients, combined STB + conventional brush use significantly reduced plaque on both anterior and posterior teeth versus conventional brush monotherapy (Cunha et al., 2018: p<0.05). Howe
  - ▸ 출발(`lee-2024-single-tuft-plaque-removal-sr`) 세줄: 이 주제범위 문헌고찰은 첨단칫솔 (Single-Tuft Toothbrush, STB)의 접근이 어려운 구강 부위 치면세균막 제거 효과를 평가했다. 7개 데이터베이스에서 403개 문헌을 검색하여 9개 연구(무작위대조시험 8개, 체외실험 1개)를 선정했으며, 대구치 인접면, 설측면, 교정장치 주변 부위에서 STB의 효과를 분석했다. 첨단칫솔은 대구치 협·설측 인접면과 교정 브라켓 주변에서 일반칫솔 단독 사용보다 우수한 치면세균막 제거 효과를 보였으며, 일반칫솔과 병행使用时 통계적으로 유의한 개선이 있
...
- `avila-ortiz-2019-alveolar-ridge-preservation-interventions` [bone-regeneration/ridge-preservation] (HIGH-no-target, '뒤집' · 뒤집음)
  - **근거 문장**: > Canullo 2021 NMA (Clin Oral Investig, 88 RCT, 2805명)가 이종골 (Xenograft, XG)·동종골 (Allograft, AG)을 치수 보존 최상위 재료로 명시 — 이 페이지의 "단일 우월 재료 없음" 결론을 뒤집음. 88 RCT 네트워크 메타분석 (NMA)이 22 RCT 이진 메타분석보다 재료 비교에서 높은 증거 강도. **ARP 모달리티 분류 체계(EFP/AO 합의 프레임워크)와 환자 보고 결과(PROM) 분석은 이 페이지에만 있으므로 함께 참고할 것**; 재료 선택 근거 인용은 canullo-2021을 우선할 것. (set 2026-08-11)
  - ▸ 출발(`avila-ortiz-2019-alveolar-ridge-preservation-interventions`) 세줄: 체계적 문헌고찰 및 메타분석 (Systematic Review with Meta-Analysis, SR+MA, EFP/AO consensus reference, J Clin Periodontol 2019): 22개 무작위 대조 시험 (RCT)을 9개 치조제 보존술 (Alveolar Ridge Preservation, ARP) 술식 분류체계로 정리. 대부분 술식이 자연치유 대비 수평·수직 차원적 손실을 유의하게 감소; 이종골+밀봉 및 동종골+밀봉이 가장 많은 근거 보유; 단일 우월 술식 없음. 환자

- `canullo-2021-arp-biomaterials-dimensional-nma` [bone-regeneration/ridge-preservation] (HIGH-no-target, 'overturn' · 결론 뒤집음)
  - **근거 문장**: This 2021 NMA (Canullo et al., Clin Oral Investig) is the largest ARP materials comparison to date, synthesizing 88 RCTs (2805 patients, 3073 sockets) using both pairwise and network meta-analysis. All tested grafting materials significantly reduced horizontal and vertical ridge shrinkage compared to spontaneous healing. The NMA multidimensional ranking showed xenograft and allograft (with or with
  - ▸ 출발(`canullo-2021-arp-biomaterials-dimensional-nma`) 세줄: SR+NMA (88 RCT, 2805명, 3073 발치와; MEDLINE·Scopus·CENTRAL·EMBASE, 2021-03까지; 이진 메타분석 + 다차원 척도 NMA) — 치조제 보존술 (Alveolar Ridge Preservation, ARP) 생체재료의 치수·조직형태계측 결과 평가; 현재까지 최대 규모 ARP 재료 네트워크 메타분석 (Network Meta-Analysis, NMA). 모든 재료가 자연치유 대비 수평·수직 위축 유의 감소 (이진 메타분석); NMA 다차원 순위: 이종골 

- `canullo-2021-arp-biomaterials-dimensional-nma` [bone-regeneration/ridge-preservation] (HIGH-no-target, 'overturn' · 결론 뒤집음)
  - **근거 문장**: - Identifies XG and AG as most predictable for dimensional preservation — overturns "no clear winner" conclusion
  - ▸ 출발(`canullo-2021-arp-biomaterials-dimensional-nma`) 세줄: SR+NMA (88 RCT, 2805명, 3073 발치와; MEDLINE·Scopus·CENTRAL·EMBASE, 2021-03까지; 이진 메타분석 + 다차원 척도 NMA) — 치조제 보존술 (Alveolar Ridge Preservation, ARP) 생체재료의 치수·조직형태계측 결과 평가; 현재까지 최대 규모 ARP 재료 네트워크 메타분석 (Network Meta-Analysis, NMA). 모든 재료가 자연치유 대비 수평·수직 위축 유의 감소 (이진 메타분석); NMA 다차원 순위: 이종골 
