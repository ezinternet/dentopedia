...
- Tier 2 (대상 불명/soft, review): **68**
- (억제됨) 이미 typed 엣지·supersession 포인터가 있어 제외: **300** · 부정문 제외: **118** · 검토·불필요 대장: **449** · 동일 줄 비최근접으로 Tier 2 강등: **0**

## Tier 1 — 판단 후 엣지 달 후보 (page → 지목된 target)

### overviews

- `low-absent-primary-stability-implant-success-overview`  —[counterpoint · 반대 논점]→  **`barbera-millan-2021-primary-stability-low-density-osseodensification`**
  - **근거 문장**: - [[implants/osseodensification/barbera-millan-2021-primary-stability-low-density-osseodensification]] — the in-vitro counterpoint where OD wins on IT (2.4×) and ISQ
  - ▸ 출발(`low-absent-primary-stability-implant-success-overview`) 세줄: 낮거나 없는 초기고정력(삽입토크 <10 N·cm, 초기 ISQ <55, 수술 중 회전)은 절대 금기가 아닌 관리 가능한 상태다: 후향 코호트에서 성공률 95.9~100%, 엄격한 저안정성 즉시식립 코호트([[immediate-implant/primary-stability/jang-2025-flapless-immediate-implant-low-primary-stability]], n=16, IT<10 N·cm AND ISQ<55, 평균 65.2개월)에서도 생존율 100%. 임상 지렛대는 셋: ① 
  - ▸ 대상(`barbera-millan-2021-primary-stability-low-density-osseodensification`) 세줄: 저밀도 돼지 경골 (Lekholm-Zarb type IV / D4 유사, 군당 55개) in vitro 연구: 골밀도화 (Osseodensification, OD, Densah bur) vs 기존 언더드릴링 (Under-Drilling, UD) 1차 안정성 비교. OD가 식립 토크 (Insertion Torque, IT) 21.7 vs 8.9 Ncm (p<0.001)과 임플란트 안정성 지수 (Implant Stability Quotient, ISQ) 69.8 vs 65.2 (p=0.001) 모두 


### radiology/mri

- `geibel-2019-artifact-properties-ceramic-titanium-mri`  —[counterpoint · 반대 논점]→  **`wamasing-2018-imaging-bifid-mandibular-canal`**
  - **근거 문장**: - [[radiology/wamasing-2018-imaging-bifid-mandibular-canal]] — diagnostic head/neck MRI imaging; this page supplies the implant-artifact counterpoint for MRI use around dental implants.
  - ▸ 출발(`geibel-2019-artifact-properties-ceramic-titanium-mri`) 세줄: - 체외 실험: 아가로오스에 매립한 임플란트 21개(세라믹/지르코니아 7, 티타늄 14)를 3T 등방성 3D 시퀀스 3종(FFE·SE·UTE)으로 스캔, 분할 부피로 이론 부피 대비 상대오차를 측정했다. - 세라믹은 무아티팩트로 평균 부피 오차 FFE 6.5±4.3% ~ UTE 5.4±2.3%(시퀀스 간 유의차 없음)였지만, 티타늄은 FFE 1314±350%·UTE 1398±562%·SE 2157±810%로 전례에서 주변부 평가 불가였다. - MRI는 세라믹 임플란트의 방사선 없는 평가 수단이 될
  - ▸ 대상(`wamasing-2018-imaging-bifid-mandibular-canal`) 세줄: 후향적 영상연구(환자 154명 / 평가 가능한 반측하악골 249례)로 고해상도 3D-VIBE MRI로 신경혈관다발(NVB)을 관찰하여 이분 하악관(Bifid Mandibular Canal, BMC) 아형을 분류하고, 부수적으로 영양관(Nutrient Canal, NC) 발생률을 평가했다. BMC는 반측하악골의 6.4%에서 확인됐고(Type 1 4.4%, Type 2 2.0%), 후구치관 포함 NC의 MRI 발생률은 58.4–97.6%로 훨씬 높았으며, BMC는 파노라마 방사선사진(0례)이나 CT(
