...
- (억제됨) 이미 typed 엣지가 있어 제외: **248** · 부정문 제외: **97** · 검토·불필요 대장: **393** · 동일 줄 비최근접으로 Tier 2 강등: **5**
...
- `post-and-core-fiber-post-decision-overview`  —[contradict · 반박·충돌]→  **`carvalho-2020-endodontically-treated-teeth-restoration-adhesive-approach`**
  ...
  - ▸ 출발(`post-and-core-fiber-post-decision-overview`) 세줄: 근관치료치(Endodontically Treated Tooth, ETT) 수복 14편 종합 — 포스트는 무포스트 대비 생존 향상(P<0.001)이나 치질소실 조건부; 원주형 ferrule이 재료보다 강한 가변 예후인자(RR 1.28); 5년 이상 전향연구 8편 중 7편이 포스트 독립효과 없음 — "ferrule 먼저, 포스트는 보조"(Naumann 2017). 글라스파이버와 금속 포스트는 전체 ETT 스펙트럼에서 통계적으로 동등(Tsintsadze 2022 SR+MA: 92.8% vs 78.1%,
