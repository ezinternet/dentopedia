---
title: "Effect of Vacuum Plasma Activation on Early Implant Stability: a Single-Blind Split-Mouth Randomized Clinical Trial"
authors: Stacchi C, Rapani A, Montanari M, Martini R, Lombardi T
year: 2025
...
- Journal: Journal of Oral & Maxillofacial Research 2025;16(2):e5
- DOI: 10.5037/jomr.2025.16205
- Study type: single-blind, split-mouth randomized controlled trial (human)
- Device: Plasma X Motion (MegaGen)

## 2. Key Contributions

- One of the few human RCTs of pre-insertion plasma activation — fills the clinical-evidence gap.
- Tracks the full early stability curve (placement, 7/14/21/28/42/60/90 d) by RFA/ISQ.
...
- All 48 implants osseointegrated at 90 days; no adverse events.
- Mean insertion torque: no significant between-group difference (P=0.86).
- Both groups showed typical early stability dip, lowest ISQ at 21 days.
- Plasma group: significantly higher ISQ than control at 60 days (P=0.04) and 90 days (P=0.03).
- Absolute ISQ difference between groups remained limited.

## 5. Limitations and Future Work

- Small (24 patients); significance only at later timepoints; absolute effect small.
- Larger cohorts and longer follow-up needed to assess clinical significance.

## 6. Related Work

- [[wiki/implants/surface/plasma/kahm-2024-vacuum-plasma-surface-treatment-osseointegration]] — animal vacuum plasma (non-significant).
- [[wiki/implants/surface/plasma/kwon-2024-actlink-plasma-rct-osseointegration-bone-regeneration]] — other human plasma RCT.
- [[wiki/implants/surface/plasma/kim-2025-plasma-surface-treatment-implant-stability-retrospective]] — human retrospective cohort.
