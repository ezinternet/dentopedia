...
## 2. Key Contributions
- OLP-to-SCC 전환 의심 사례의 진단 오류 가능성(dysplastic lichenoid lesion 포함 문제) 지적
- 진정한 OLP 악성전환 근거의 강도 재평가

## 3. Methodology and Architecture
편집자 서한(letter) 형식 비판적 고찰.

## 4. Key Results and Benchmarks
진단적 엄격성이 낮은 연구 포함 시 전환율 과대추정; WHO 기준 준수 연구만 분석 시 전환율 현저히 낮아짐.
