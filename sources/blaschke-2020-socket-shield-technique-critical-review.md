...
저자: Christian Blaschke (UNSW Australia), Donald R. Schwass (Univ Otago New Zealand). International Journal of Implant Dentistry (Springer) open access.

## 2. Key Contributions
- SST literature의 critical 평가 (단순 긍정 결과 collation 아님)
- 분야 controversies 정리
- 임상 도입 시 cautious framework

## 3. Methodology
- PubMed 검색 — 229 hits
- 13편 download → 12편 inclusion
- Critical evaluation (quality·outcome·gap)

## 4. Key Results
- SST는 협측 골보존·미용 효과 잠재적 우월
- Invasive bone graft 회피 가능성
- 단 long-term outcome 부족·합병증 패턴 불명확
- Routine clinical use는 시기상조 결론

## 5. Limitations
- Review — primary data 없음
- 2020 시점 — 이후 SR (Lin·Ogawa 2022) 추가 데이터 있음
...
- **Bundle bone**: 협측 골판 표층 (extraction 후 흡수)
