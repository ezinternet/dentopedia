---
title: "Evaluation of Bleeding Time after Dental Extractions during Uninterrupted Single or Dual Antiplatelet Treatment - A Comparative Study"
authors: Krishnan NA, Kumar SV, Nair AH, Remya M, Thomas RB, Deepak KS, Indu PS
year: 2024
doi: ""
...
- Type: Comparative study (Original article)
- Journal: Ann Maxillofac Surg 2024; 14(2): 137

## 2. Key Contributions
1. Indian-population data on uninterrupted SAPT vs DAPT through dental extractions.
2. Quantifies bleeding time differences and clinical bleeding outcome.
3. Supports umbrella-review recommendation (cited in paper) that DAPT need not be discontinued.
...
- Small sample (typical of single-institution OMFS studies)
- No DOAC arm

## 6. Related Work
- [[drug/lu-2018-warfarin-antiplatelet-dental-extraction-management]] — Taiwan large cohort.
- [[drug/guardieiro-2023-chitosan-cellulose-hemostasis-dapt-rct]] — local hemostatic methods in DAPT.
- [[drug/inchingolo-2024-anticoagulation-therapy-dental-practice-sr]] — modern SR.

## 7. Glossary
- SAPT: Single antiplatelet therapy (e.g., aspirin alone)
- DAPT: Dual antiplatelet therapy (e.g., aspirin + clopidogrel/ticagrelor)
