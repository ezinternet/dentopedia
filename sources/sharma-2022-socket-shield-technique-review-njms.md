...
## 2. Key Contributions
- SST vs conventional immediate implant 직접 비교 review
- 19 eligible studies — case series 2개 exclude
- Treatment outcome focus

## 3. Methodology
- Electronic search: PubMed, Google Scholar, Cochrane
- 606 initial hits → 19 eligible (full-text)
- Exclusion: in-vitro, case reports, reviews, SR, unrelated

## 4. Key Results
- 본문 outcome 표 (생존율·합병증·미용)
- SST가 conventional 대비 미용·골보존 우월 신호
- 합병증 패턴은 SST 특유 issue (shield 관련)

## 5. Limitations
- Narrative review (not meta-analysis)
- Single institution 평가
- 2022 시점

## 6. Related Work
- gharpure-2022 — SR+MA SST vs conventional
- lin-2022 — SR+MA
- ogawa-2022 — SR

## 7. Glossary
- **SST**: Socket-Shield Technique
- **NJMS**: National Journal of Maxillofacial Surgery
