---
title: "Cracked tooth syndrome: a diagnostic dilemma - a mini review"
...
Mini review (DAPMRV Dental College + Manipal

CDS, FROH 2025): CTS = longitudinal fracture의

한 type, 진단 어려움 (diagnostic dilemma) 종합 mini review.
...
## 2. Key Contributions
- CTS의 longitudinal fracture 5-type classification 맥락
- 진단 어려움 (dilemma) 명확화
- 영상 한계·임상 검사 한계 정리
...
## 4. Key Points
- Longitudinal fracture 5 type: craze line, fractured cusp, cracked tooth, split tooth, vertical root fracture
- CTS는 이 중 incomplete fracture
- 진단의 다중 challenge — single tool 불가
- Multi-modal evaluation 필요

## 5. Limitations
- Mini review — depth 제한
- No new primary data

## 6. Related Work
- Kaur 2026 umbrella
- Li 2021 종합 review
- [[cracked-tooth/jkda-2024-62-1-003]] — 한국 진단 review

## 7. Glossary
- **Longitudinal fracture**: 종축 균열 (5 type)
- **Diagnostic dilemma**: 진단 함정·어려움
