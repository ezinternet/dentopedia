---
title: "Attitudes of Oral Surgeons and Periodontists towards Immediate Dental Implant Placement"
...
- Journal: Journal of Oral & Maxillofacial Research 2024;15(2):e3.
- Lithuanian University of Health Sciences, Kaunas. Anonymous online survey Jan 6–Feb 29, 2024.
- Chi-square analysis; n = 186 specialists.

## 2. Key Contributions

- Maps real-world clinician decision criteria for immediate implant placement.
- Exposes a gap between available socket-classification evidence and its clinical uptake.

## 3. Methodology and Architecture

- Cross-sectional anonymous online questionnaire to oral surgeons and periodontists performing implants.
- Chi-square test for variable associations.

## 4. Key Results and Benchmarks

- Main contraindication: periapical lesion >5 mm — 91.7% (oral surgeons), 96.9% (periodontists).
- Advantage cited: good esthetics & preservation of anatomy — 99.2% (OS), 92.3% (perio).
...
- Familiar with/use extraction-socket morphology classifications: periodontists 43.1%, oral surgeons 33.9%.

## 5. Limitations and Future Work

- Single-country, self-reported attitudes; modest sample; potential response bias.
- Recommends curriculum and continuing-education reinforcement.

## 6. Related Work

- Extraction-socket / interradicular-septum morphology classifications; periapical-pathology immediate-implant evidence.

## 7. Glossary

- **IDIP**: immediate dental implant placement.
- **Periapical lesion**: apical inflammatory/infective bone lesion at the socket.
