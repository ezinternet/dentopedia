...
## 2. Key Contributions
- 실제 술식 sequence (낭종 처리 단계별) 사진·CBCT로 시각화
- 1년 추적으로 기본적 안정성 확인
- 의사결정 트리 narrative anchor — 통계가 아닌 실제 case

## 3. Methodology
- Single case, 1-year follow-up
- Lateral window approach
- MRC 처치 (자세히는 본문 — 흡인/제거/통과)
- 즉시 implant placement
...
## 5. Limitations
- n=1 case report — 일반화 불가
- 1년 단기 추적
- 본인 경험·institutional protocol 반영

## 6. Related Work
- Yu 2023, Fu 2022·2025 — cohort 비교
- Grün 2023 — 15년 추적 case
- Silva 2025 — 6년 추적 case
- Testori 2024 — aspiration cohort

## 7. Glossary
- **MRC**: Mucous Retention Cyst
- **Lateral window**: 측방창 접근법
