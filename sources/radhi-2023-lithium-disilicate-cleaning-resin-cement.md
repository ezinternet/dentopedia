...
- Group 1: Ivoclean (15% ZrO2); Group 2: 30% sodium silicate
- Result: sodium silicate > Ivoclean for LDS (p<0.05)
- This is counterintuitive vs zirconia literature (Ivoclean typically better for Zr)
- Key clinical distinction: Ivoclean optimized for zirconia; LDS may benefit from different cleaners
