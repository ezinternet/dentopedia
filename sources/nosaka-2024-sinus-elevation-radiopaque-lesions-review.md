...
## 2. Key Contributions
- "Faintly radiopaque" 모호한 lesion의 임상 결정 framework
- AP·MRC·odontogenic cyst·이물질 등 감별진단
- Sinus elevation 가능성·금기·주의사항 정리

## 3. Methodology
- Comprehensive clinical review
- Pathology + 영상 + 술식 결정의 통합

## 4. Key Results
- Faint radiopacity는 광범위한 pathology 의미 가능 — 단순 AP 가정 위험
- CBCT, MRI, ENT consultation 필요 시점 명확화
- Sinus elevation 시 차등 접근 가이드

## 5. Limitations
- Review — primary data 부재
- Faint radiopacity 정량적 기준 모호
- 일본 임상 표준 반영 — 한국 임상에 직접 적용 시 주의

## 6. Related Work
- Yeung 2022 — CBCT pathology review (광범위)
- Anitua 2021 SR — cyst risk
- Jadach 2024 — 큰 MRC 술식

## 7. Glossary
- **Faintly radiopaque lesion**: 영상에서 흐릿하게 보이는 방사선 불투과성 병변
- **Antrum**: 상악동
