---
title: "The hidden X suture: a technical note on a novel suture technique for alveolar ridge preservation"
...
- Type: prospective randomized controlled clinical trial
- DOI: 10.5051/jpis.2016.46.6.415

## 2. Key Contributions
- Introduces the hidden X suture for open-healing ARP
- Shows suture choice affects mucogingival junction (MGJ) position and KT preservation
- Clinical + radiographic verification

## 3. Methodology and Architecture
- Design: prospective RCT; 14 patients, posterior maxillary/mandibular extractions.
- Groups: conventional X suture (control) vs hidden X suture (test); open-healing approach.

## 4. Key Results and Benchmarks
- All sites healed without complications.
- MGJ shift: control X suture pulled MGJ lingually by 1.56 ± 0.90 mm; hidden X suture pushed MGJ slightly buccally by 0.25 ± 0.66 mm.
- Buccal KT preserved significantly greater in hidden X suture group at 4 months (P<0.05).
- Conclusion: hidden X suture preserves KT width and alveolar ridge dimensions after ARP.

## 5. Limitations and Future Work
- Small sample (n=14); single group/operator.
...
## 7. Glossary
- ARP: alveolar ridge preservation; KT: keratinized tissue; MGJ: mucogingival junction (점막치은경계)
- Hidden X suture: 노출형 치유 ARP를 위한 변형 X 봉합법
