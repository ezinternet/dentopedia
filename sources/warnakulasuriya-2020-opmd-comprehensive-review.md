...
## 2. Key Contributions
- WHO OPMD 용어 체계 및 분류(oral leukoplakia, erythroplakia, OLP, OSF, OSMF 등) 정리
- 각 병소별 악성전환율(malignant transformation rate) 범위 비교
- 임상 관리 원칙: 생검 적응증, 추적 프로토콜, 개입 전략 요약

## 3. Methodology and Architecture
PubMed 및 Cochrane 기반 서술적 고찰; 연구 선정 기준 및 체계적 검색 전략 명시 없음(narrative review).

## 4. Key Results and Benchmarks
OLP 0.4–12.5%, 백색반 1–17.5%, 적색반(erythroplakia) 최대 50%의 악성전환율 보고. 흡연·음주·HPV 등 주요 위험인자. 광역 절제는 재발 방지 근거 불충분; 추적관찰 + 위험인자 제거 권고.
