...
## 2. Key Contributions
- 최신 IOS 4–6종을 동일 기준(산업용 CT reference) 대비 평가
- 구치부 연장 시 누적 오차(error propagation) 정량화
- 기기별 전악 스캔 권장 전략(scan path) 도출

## 3. Methodology and Architecture
In vitro; 표준 모형; 산업용 CT를 기준값으로 사용.

## 4. Key Results and Benchmarks
기기 간 정확도 유의한 차이; 전악 스캔 시 모든 기기에서 오차 증가. Trueness: 50–200μm 범위.

## 5. Limitations and Future Work
In vitro(구강 내 타액·움직임 반영 안 됨).

## 6. Related Work
- [[digital-workflow/vitai-2023-intraoral-scanner-complete-arch-sr-network-ma]] — related

## 7. Glossary
full-arch impression: 전악 인상; error propagation: 오차 전파; reference scan: 기준 스캔
