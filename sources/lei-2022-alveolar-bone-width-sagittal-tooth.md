...
Retrospective CBCT study of 120 patients comparing alveolar 골 (Bone) width and sagittal tooth angulation

of maxillary central incisors stratified by Class I vs Class III canine relationship. Class

III had 유의미한 (Significant)ly thinner labial 골 (Bone) and greater labial root inclination, complicating immediate 임플란트 (Implant) placement planning.
...
## 2. Key Contributions
Demonstrates that malocclusion class (anterior canine relationship) is an under-appreciated covariate of esthetic-zone bone morphology and should be screened pre-operatively for immediate implant cases.

## 3. Methodology and Architecture
Retrospective CBCT analysis of 120 patients. Measurements at multiple levels of labial/palatal bone, root inclination, and overall alveolar width on central incisors. Stratified by Angle Class I vs Class III canine relationship.

## 4. Key Results and Benchmarks
Class III patients showed thinner labial bone plates (often <1 mm in apical thirds), more labial root inclination, and reduced bone available palatal to the root apex, all of which adversely affect immediate implant indications.
