...
## 2. Key Contributions
- REP 적응증: 미성숙 영구치(열린 치근단) + 치수 괴사/감염
- 술식: 세정(NaOCl 1.5%) → 항생제 혼합재(TAP/DAP) 유치 → 혈전(blood clot) 유도 → 차폐(MTA/collagen)
- 예후 지표: 치근 성숙, 치근단 치유, 생활력 회복

## 3. Methodology and Architecture
전문가 패널 Delphi 합의 + 문헌 검토.

## 4. Key Results and Benchmarks
REP 성공률(치근단 치유): 85–90%. 생활력 회복: 30–60%. 치근 성숙(apical closure/root lengthening) 60–80%.
...
## 7. Glossary
REP: Regenerative Endodontic Procedure 재생 근관치료; TAP: Triple Antibiotic Paste 항생제 혼합재; DAP: Double Antibiotic Paste; MTA: Mineral Trioxide Aggregate
