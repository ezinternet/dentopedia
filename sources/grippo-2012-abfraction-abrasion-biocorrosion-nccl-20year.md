...
ingest_note: "Webpage capture: abstract, clinical significance, and full reference list only. Full body text not available."
---
...
- Accompanied by commentary by W. Stephan Eakle (DOI 10.1111/j.1708-8240.2011.00488.x).

## 2. Key Contributions
- Terminology shift: biocorrosion = chemical + biochemical + electrochemical degradation (endogenous/exogenous acids, proteolytic agents, piezoelectric effect on dentin), broader than "erosion."
- Revised Schema of Pathodynamic Mechanisms: stress (abfraction), friction (wear), biocorrosion, and their combined/multifactorial overlaps.
- Argues "abfraction" must not be used as a blanket label for all NCCLs — designation depends on the case-specific combination of mechanisms.
...
## 7. Glossary
- Biocorrosion: chemical/biochemical/electrochemical degradation of tooth substance.
- Abfraction: microstructural loss of tooth substance in areas of stress concentration.
- Pathodynamic mechanisms: stress, friction, biocorrosion triad.
