...
Cross-sectional CBCT study of 420

maxillary anterior teeth in 70

Brazilian patients reporting Kan-class SRP distribution.
...
## 2. Key Contributions
Brazilian-population SRP distribution data complementing Kan 2011 — notably higher Class IV prevalence, indicating need for individualized planning.

## 3. Methodology and Architecture
Retrospective CBCT review of 70 patients. Kan I–IV classification for each maxillary anterior tooth.

## 4. Key Results and Benchmarks
Class I 65.2%, II 9.3%, III 0.7%, IV 24.8%. Sex not associated (p=0.307); age distribution differed across classes (p=0.004).

## 5. Limitations and Future Work
Cross-sectional; single-center; younger-skewed cohort.
