...
- Volume loss order (most→least): rough Zr (4.6mm³) > glazed rough (3.8mm³) > glazed sintered (3.5mm³) > 46μm finish (1.7mm³) ≈ control (1.6mm³) > glazed polished (1.4mm³) > polished alone (0.4mm³)
- Key finding: glazing over rough surface does NOT reduce wear to same level as polishing
- Only polishing (sole treatment) achieves minimal antagonist wear
- Surface condition UNDER the glaze determines enamel wear
