...
## 2. Key Contributions
- 국소 clonazepam 구강세척(rinse-and-spit) 1차 치료 근거 정리
- Cognitive Behavioral Therapy(CBT)의 심리적 고통 완화 효과
- 저용량 삼환계항우울제(TCA), gabapentinoids 적응증 및 부작용

## 3. Methodology and Architecture
PubMed 체계적 검색 기반 서술적 고찰.

## 4. Key Results and Benchmarks
단일 치료법으로 완치 불가; 복합 접근이 증상 경감에 효과적. Clonazepam 국소 적용이 가장 근거 수준 높음(RCT 다수).
