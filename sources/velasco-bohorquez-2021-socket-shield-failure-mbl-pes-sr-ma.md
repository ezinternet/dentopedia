...
## 2. Key Contributions
- 3 outcome (failure·MBL·PES) 동시 정량
- Esthetic zone 한정
- 분야 baseline data
...
## 4. Key Results
- Failure rate (본문 forest plot)
- MBL (mean, 95% CI)
- PES (mean, 95% CI)
- SST가 conventional 대비 미용·골보존 우월 신호

## 5. Limitations
- 2021 SR — 이후 더 큰 MA (Lin·Gharpure 2022) 가능
- Esthetic zone 한정 — 후방 적용 불가
- Heterogeneity 평가 필요
...
- **BBPR**: Buccal Bone Plate Resorption
