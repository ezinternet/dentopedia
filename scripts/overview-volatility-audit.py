...
HTML_TMPL = """<!--
---
title: "Overview Volatility Index — 오버뷰 변동성 순위"
type: interactive
date: AUTO
status: done
category: meta
source_wiki:
  - wiki/overviews/
note: "AUTO-GENERATED by scripts/overview-volatility-audit.py --html — 손편집 금지. frontmatter가 없으면 interactives 색인에서 '기타·미분류'로 떨어진다."
---
-->
<!DOCTYPE html>
