...
- **폴더 자체가 없는 도메인**: 소아치과, 구강병리·구강암 (**2026-08-26 교정**: 고정성 보철 76편, 소아치과 47편, 구강병리 10편은 실측 결과 이미 존재하는 폴더에 분산돼 있었음; RPD는 실제로 결손이었으나 2026-08-26 카테고리 신설+12편 인제스트로 해소됨 — 결손 도메인은 4개 아니라 1개였다)
- **얇은 도메인**: 방사선 58, 교합 65, 우식 49, 총의치 51

최종목적이 "교합상태·치아상태·파노라마 → 치료계획"이라면, 파노라마 판독 근거가 58편이고 **"발치 후 무엇으로 수복하나" 분기에서 RPD 근거가 0편이었다** (크라운·브릿지는 76편이라 실제로 0이 아니었음). 임플란트로 가는 가지만 두껍고 나머지 가지가 비어 있어, 지금 치료계획을 뽑으면 **구조적으로 임플란트 편향**이 나온다 — RPD 가지는 2026-08-26 인제스트로 해소됨.
