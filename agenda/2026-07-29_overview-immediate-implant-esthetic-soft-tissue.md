...
**날짜**: 2026-07-29  
**카테고리**: immediate-implant/esthetic-soft-tissue  
**미합성 stem 수**: 8개  

## 합성 목표

즉시 식립(Immediate Implant Placement) 후 심미 영역의 연조직(Soft Tissue) 변화 — 순측 골·점막 위축, 중간 유두 보존, 볼륨 변화 — 를 다룬 미합성 8개 논문을 하나의 overview로 종합한다. 기존 합성 페이지와의 중복을 피하고 임상 결정 지점(식립 시기, 피판 디자인, 즉시 프로비저널 여부)에 초점을 맞춘다.

## 미합성 stem 목록

1. block-2009-prospective-evaluation-immediate-delayed
2. chan-2019-randomized-controlled-trial-compare-aesthetic
3. francisco-2021-timing-implant-placement-loading-esthetic
4. girlanda-2019-deproteinized-bovine-bone-derived-collagen
5. jiang-2020-hard-soft-tissue-alterations-during
6. kinaia-2017-soft-tissue-changes-around
7. wang-2020-volumetric-facial-contour-changes-immediately
8. weigl-2016-impact-immediately-placed-restored

## 성공 기준

이 작업이 제대로 되었다면: `wiki/overviews/` 에 `immediate-implant-esthetic-soft-tissue-overview.md` 가 생성되고, 위 8개 stem이 모두 `[[wikilink]]`로 참조되며, `## 한국어 핵심요약` 블록이 frontmatter 바로 아래에 위치한다.

## 라우팅

- 읽기·추출: Haiku  
- 본문 작성: Sonnet  
- 논문 간 비교·supersession 판단: Opus
